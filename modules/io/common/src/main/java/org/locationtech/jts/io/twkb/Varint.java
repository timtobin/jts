 ...
 * found for example in <a href=
 * "http://code.google.com/apis/protocolbuffers/docs/encoding.html">Google's
 * Protocol Buffers</a>. It uses fewer bytes to encode smaller values, but will
 * use slightly more bytes to encode large values.
 *
 * <p>
...
final class Varint {
	...
	/**
	 * Encodes a value using the variable-length encoding from <a href=
	 * "http://code.google.com/apis/protocolbuffers/docs/encoding.html">Google
	 * Protocol Buffers</a>. It uses zig-zag encoding to efficiently encode signed
	 * values. If values are known to be nonnegative,
	 ...
	 * Encodes a value using the variable-length encoding from <a href=
	 * "http://code.google.com/apis/protocolbuffers/docs/encoding.html">Google
	 * Protocol Buffers</a>. Zig-zag is not used, so input must not be negative. If
	 * values can be negative, use {@link #writeSignedVarLong(long, DataOutput)}
