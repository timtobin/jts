...
public class OrientationTransformer {
  ...
  /**
   * Transforms a geometry using the Right Hand Rule specifications defined in the latest GeoJSON
   * specification. See <a href="https://tools.ietf.org/html/rfc7946#section-3.1.6">RFC-7946
  ...
  /**
   * Transforms a polygon using the Right Hand Rule specifications defined in the latest GeoJSON
   * specification. See <a href="https://tools.ietf.org/html/rfc7946#section-3.1.6">RFC-7946
   * Specification</a> for more context.
   *
  ...
  /**
   * Transforms a polygon using the Right Hand Rule specifications defined in the latest GeoJSON
   * specification. A linear ring MUST follow the right-hand rule with respect to the area it
   * bounds, i.e., exterior rings are counterclockwise, and holes are clockwise.
   *
   * <p>See <a href="https://tools.ietf.org/html/rfc7946#section-3.1.6">RFC 7946 Specification</a>
   * for more context.
   *
   * @param ring the LinearRing, a constraint specific to Polygons
   * @param isExteriorRing true if the LinearRing is the exterior polygon ring, the one that defines
   *     the boundary
