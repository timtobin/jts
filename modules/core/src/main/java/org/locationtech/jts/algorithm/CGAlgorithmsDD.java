...
/**
 * Implements basic computational geometry algorithms using {@link DD}
 * arithmetic.
 *
 * @author Martin Davis
 */
public class CGAlgorithmsDD {
	...
	/**
	 * Computes an intersection point between two lines using DD arithmetic. If the
	 * lines are parallel (either identical or separate) a null value is returned.
	 *
	 * @param p1
	 ...
	 * @param q2
	 *            an endpoint of line segment 2
	 * @return an intersection point if one exists, or null if the lines are
	 *         parallel
	 */
	 ...
	 * @return 1 if q is counter-clockwise (left) from p1-p2 -1 if q is clockwise
	 *         (right) from p1-p2 0 if q is collinear with p1-p2
	 */
	 ...
	 * entries.
	 *
	 * @return -1 if the determinant is negative, 1 if the determinant is positive,
