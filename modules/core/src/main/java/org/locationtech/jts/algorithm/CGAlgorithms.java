 ...
 *
 * @version 1.7
 * @deprecated See {@link Length}, {@link Area}, {@link Distance}, {@link Orientation}, {@link
 *     PointLocation}
 */
public class CGAlgorithms {
  ...
  /**
   * Returns the index of the direction of the point {@code q} relative to a vector specified by
   * {@code p1-p2}.
   *
   * @param p1 the origin point of the vector
   * @param p2 the final point of the vector
   * @param q the point to compute the direction to
   * @return {@code 1} if q is counter-clockwise (left) from p1-p2 {@code -1} if q is clockwise
   *     (right) from p1-p2 {@code 0} if q is collinear with p1-p2
   * @deprecated Use {@link Orientation#index(Coordinate, Coordinate, Coordinate)} instead.
   */
   ...
   * point lying exactly on the ring boundary is considered to be inside the ring.
   *
   * <p>This method does <i>not</i> first check the point against the envelope of the ring.
   *
   * @param p point to check for ring inclusion
   * @param ring an array of coordinates representing the ring (which must have first point
   *     identical to last point)
   * @return true if p is inside ring
   * @see #locatePointInRing(Coordinate, Coordinate[])
   * @deprecated Use {@link PointLocation#isInRing(Coordinate, Coordinate[])} instead.
   */
   ...
   * @deprecated Use {@link PointLocation#locateInRing(Coordinate, Coordinate[])} instead.
   */
   ...
   *     the linestring
   * @deprecated Use {@link PointLocation#isOnLine(Coordinate, Coordinate[])} instead.
   */
   ...
   * </ul>
   *
   * This algorithm is <b>only</b> guaranteed to work with valid rings. If the ring is invalid (e.g.
   ...
   * @return 1 if q is counter-clockwise from p1-p2, or -1 if q is clockwise from p1-p2, or 0 if q
   ...
   * @deprecated Use {@link Distance#pointToSegment(Coordinate, Coordinate, Coordinate)} instead.
   */
   ...
   * @deprecated Use {@link Distance#pointToLinePerpendicular(Coordinate, Coordinate, Coordinate)}
   *     instead.
   */
   ...
   * @deprecated Use {@link Distance#pointToSegmentString(Coordinate, Coordinate[])} instead.
   */
   ...
   * @deprecated Use {@link Distance#segmentToSegment(Coordinate, Coordinate, Coordinate,
   *     Coordinate)} instead.
   */
   ...
   * @deprecated Use {@link Area#ofRing(Coordinate[])} or {@link Area#ofRingSigned(Coordinate[])}
   *     instead.
   */
   ...
   * @param ring the coordinates forming the ring
   * @return the signed area of the ring
   * @deprecated Use {@link Area#ofRing(CoordinateSequence)} or {@link
   *     Area#ofRingSigned(CoordinateSequence)} instead.
   */
