 ...
 * connected to each of its incident Edges via an outgoing DirectedEdge. Some clients using a <code>
 * PlanarGraph</code> may want to subclass <code>Node</code> to add their own application-specific
 * data and methods.
 *
 * @version 1.7
 */
public class Node extends GraphComponent {
  ...
  /**
   * Removes a {@link DirectedEdge} incident on this node. Does not change the state of the directed
   * edge.
   */
