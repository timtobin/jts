 ...
 * <code>double</code> or <code>float</code>, and defaults to
 * <code>double</code>.
 */
public class PackedCoordinateSequenceFactory implements CoordinateSequenceFactory, Serializable {
	...
	public static final PackedCoordinateSequenceFactory DOUBLE_FACTORY = new PackedCoordinateSequenceFactory(DOUBLE);

	/** Type code for arrays of type <code>float</code>. */
	public static final int FLOAT = 1;

	/** A factory using array type {@link #FLOAT} */
	public static final PackedCoordinateSequenceFactory FLOAT_FACTORY = new PackedCoordinateSequenceFactory(FLOAT);
	...
	/**
	 * Creates a new PackedCoordinateSequenceFactory of the given type. Acceptable
	 * type values are {@linkplain PackedCoordinateSequenceFactory#FLOAT}or
	...
	/**
	 * Creates a packed coordinate sequence of type {@link #DOUBLE} from the
	 * provided array using the given coordinate dimension and a measure count of 0.
	 *
	...
	/**
	 * Creates a packed coordinate sequence of type {@link #DOUBLE} from the
	 * provided array using the given coordinate dimension and measure count.
	 *
	 * @param packedCoordinates
	 *            the array containing coordinate values
	 * @param dimension
	...
	/**
	 * Creates a packed coordinate sequence of type {@link #FLOAT} from the provided
	 * array.
	 *
	 * @param packedCoordinates
	 *            the array containing coordinate values
