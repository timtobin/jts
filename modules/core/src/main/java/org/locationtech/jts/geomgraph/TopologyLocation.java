...
public class TopologyLocation {
	 ...
	 * to the right of some GraphComponent relate to some Geometry. Possible values
	 * for the parameters are Location.NULL, Location.EXTERIOR, Location.BOUNDARY,
	...
	public void merge(TopologyLocation gl) {
		// if the src is an Area label & and the dest is not, increase the dest to be an
		// Area
