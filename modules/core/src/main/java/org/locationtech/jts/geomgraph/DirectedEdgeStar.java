 ...
 * a node. It supports labelling the edges as well as linking the edges to form
 * both MaximalEdgeRings and MinimalEdgeRings.
 *
 * @version 1.7
 */
public class DirectedEdgeStar extends EdgeEndStar {
	...
	public void findCoveredLineEdges() {
		 ...
		 * Exterior) for the result area. If L edges are found, mark them as covered if
	 ...
	 * link two dirEdges, the <code>next</code> pointer for an incoming dirEdge is
	 * set to the next outgoing edge.
	 *
	 * <p>
