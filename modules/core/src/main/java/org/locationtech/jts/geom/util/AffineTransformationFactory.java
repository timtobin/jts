...
public class AffineTransformationFactory {
	 ...
	 *
	 * <ul>
	 * <li>a translation from the start point of the source baseline to the start
	 * point of the destination baseline,
	 * <li>a rotation through the angle between the baselines about the destination
	 * start point,
	 * <li>and a scaling equal to the ratio of the baseline lengths.
	 * </ul>
	 *
	 * If the source baseline has zero length, an identity transformation is
	 * returned.
	 *
	 * @param src0
	 ...
	 */
	public static AffineTransformation createFromBaseLines(Coordinate src0, Coordinate src1, Coordinate dest0,
			Coordinate dest1) {
	...
	/**
	 * Creates an AffineTransformation defined by a single control vector. A control
	 * vector consists of a source point and a destination point, which is the image
	 * of the source point under the desired transformation. This produces a
	 * translation.
	 *
	 * @param src0
	 ...
	 * the image of the source point under the desired transformation. The computed
	 * transformation is a combination of one or more of a uniform scale, a
	 * rotation, and a translation (i.e. there is no shear component and no
	 * reflection)
	 *
	 * @param src0
	 * @param src1
	 * @param dest0
	 * @param dest1
	 * @return the computed transformation, or null if the control vectors do not
	 *         determine a well-defined transformation
	 */
	public static AffineTransformation createFromControlVectors(Coordinate src0, Coordinate src1, Coordinate dest0,
			Coordinate dest1) {
	 ...
	 * vector consists of a source point and a destination point, which is the image
	 * of the source point under the desired transformation. Three control vectors
	 * allows defining a fully general affine transformation.
	 *
	 * @param src0
	 * @param src1
	 * @param src2
	 ...
	 * @return the computed transformation
	 */
	public static AffineTransformation createFromControlVectors(Coordinate src0, Coordinate src1, Coordinate src2,
			Coordinate dest0, Coordinate dest1, Coordinate dest2) {
	...
	/**
	 * Creates an AffineTransformation defined by a set of control vectors. Between
	 * one and three vectors must be supplied.
	 *
	 * @param src
