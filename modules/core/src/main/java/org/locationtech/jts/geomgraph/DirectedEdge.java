...
public class DirectedEdge extends EdgeEnd {
   ...
   * crossing from the {@link Location#INTERIOR} to the{@link Location#EXTERIOR} the depth
   ...
   *
   * <p>You may also use {@link #setEdgeDepths(int, int)} to update depth and opposite depth
   * together.
   *
   ...
   *
   * <p>This is used for edges corresponding to lines, which will only appear oriented in a single
