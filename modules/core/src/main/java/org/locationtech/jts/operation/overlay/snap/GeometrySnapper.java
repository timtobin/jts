 ...
 * problems during noding and intersection calculation). It can also be used to
...
public class GeometrySnapper {
	...
	public static double computeOverlaySnapTolerance(Geometry g) {
		 ...
		 * precision model is of type FIXED, then the snap tolerance must reflect the
		 * precision grid size. Specifically, the snap tolerance should be at least the
		 * distance from a corner of a precision grid cell to the centre point of the
		 * cell.
		 */
	 ...
	 * it is topologically valid (which fixes issues such as topology collapses in
	 * polygonal inputs).
	 *
	 * <p>
