...
/**
 * Utility functions for working with angles. Unless otherwise noted, methods in
 * this class express angles in radians.
 */
...
public class Angle {
	...
	/**
	 * Returns the angle of the vector from (0,0) to p, relative to the positive
	 * X-axis. The angle is normalized to be in the range ( -Pi, Pi ].
	 *
	 * @param p
	 *            the terminal point of the vector
	 * @return the normalized angle (in radians) that p makes with the positive
	 *         x-axis.
	 */
	...
	/**
	 * Returns the unoriented smallest angle between two vectors. The computed angle
	...
	/**
	 * Computes the angle of the unoriented bisector of the smallest angle between
	 * two vectors. The computed angle will be in the range (-Pi, Pi]. Collinear
	 * inputs are handled.
	 *
	 * @param tip1
	 *            the tip of v1
	...
	/**
	 * Returns whether an angle must turn clockwise or counterclockwise to overlap
	 * another angle.
	 *
	 * @param ang1
	 *            an angle (in radians)
	 * @param ang2
	 *            an angle (in radians)
	 * @return whether a1 must turn CLOCKWISE, COUNTERCLOCKWISE or NONE to overlap
	 *         a2.
	 */
	...
	/**
	 * Tests whether the angle between p0-p1-p2 is acute. An angle is acute if it is
	...
	/**
	 * Tests whether the angle between p0-p1-p2 is obtuse. An angle is obtuse if it
	...
	/**
	 * Computes the normalized value of an angle, which is the equivalent angle in
	 * the range ( -Pi, Pi ].
	 *
	 * @param angle
	...
	/**
	 * Computes the normalized positive value of an angle, which is the equivalent
	 * angle in the range [ 0, 2*Pi ). E.g.:
	 *
	 * <ul>
