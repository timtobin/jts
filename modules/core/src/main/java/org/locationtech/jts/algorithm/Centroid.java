...
/**
 * Computes the centroid of a {@link Geometry} of any dimension. For collections
 * the centroid is computed for the collection of non-empty elements of highest
 * dimension. The centroid of an empty geometry is {@code null}.
 *
 * <h3>Algorithm</h3>
 *
 * <ul>
 * <li><b>Dimension 2</b> - the centroid is computed as the weighted sum of the
 * centroids of a decomposition of the area into (possibly overlapping)
 * triangles. Holes and multipolygons are handled correctly. See
 * http://www.faqs.org/faqs/graphics/algorithms-faq/ for further details of the
 * basic approach.
 * <li><b>Dimension 1</b> - Computes the average of the midpoints of all line
...
public class Centroid {
	/**
	 * Returns twice the signed area of the triangle p1-p2-p3. The area is positive
	 * if the triangle is oriented CCW, and negative if CW.
	 */
	...
	/**
	 * Computes three times the centroid of the triangle p1-p2-p3. The factor of 3
	 * is left in to permit division to be avoided until later.
	 */
	...
	/**
	 * Adds the line segments defined by an array of coordinates to the linear
	...
	public Coordinate getCentroid() {
		/*
		 * The centroid is computed from the highest dimension components present in the
		 * input. I.e. areas dominate lineal geometry, which dominates points.
		 * Degenerate geometry are computed using their effective dimension (e.g. areas
		 * may degenerate to lines or points)
		 */
