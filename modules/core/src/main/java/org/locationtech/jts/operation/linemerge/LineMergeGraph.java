 ...
 * and {@link org.locationtech.jts.planargraph.Node}s indicates whether they
 * have been logically deleted from the graph.
 *
 * @version 1.7
 */
public class LineMergeGraph extends PlanarGraph {
	 ...
	 * representation of an edge. Empty lines or lines with all coordinates equal
	 * are not added.
	 *
	 * @param lineString
	...
	public void addEdge(LineString lineString) {
		...
		DirectedEdge directedEdge1 = new LineMergeDirectedEdge(endNode, startNode, coordinates[coordinates.length - 2],
				false);
