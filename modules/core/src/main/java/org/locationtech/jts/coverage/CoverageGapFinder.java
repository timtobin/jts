...
/**
 * Finds gaps in a polygonal coverage. Gaps are holes in the coverage which are
 * narrower than a given width.
 *
 * <p>
 * The coverage should be valid according to {@link CoverageValidator}. If this
 * is not the case, some gaps may not be reported, or the invocation may fail.
 *
 * <p>
 * This is a more accurate way of identifying gaps than using
 * {@link CoverageValidator#setGapWidth(double)}. Gaps which separate the
 * coverage into two disjoint regions are not detected. Gores are not identified
 * as gaps.
 *
 * @author mdavis
 */
public class CoverageGapFinder {
	...
	/**
	 * Finds gaps in a polygonal coverage. Returns lines indicating the locations of
	 * the gaps.
	 *
	 * @param coverage
	 ...
	 * @return a MultiPolygon indicating the locations of gaps (empty if no gaps
	 *         were found), or null if the coverage was empty
	 */
	...
	/**
	 * Finds gaps in the coverage. Returns lines indicating the locations of the
	 * gaps.
	 *
	 * @param gapWidth
	 *            the maximum width of gap to detect
	 * @return a geometry indicating the locations of gaps (which is empty if no
	 *         gaps were found), or null if the coverage was empty
	 */
