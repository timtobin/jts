...
/**
 * A wrapper for {@link Noder}s which validates the output arrangement is
 * correctly noded. An arrangement of line segments is fully noded if there is
 * no line segment which has another segment intersecting its interior. If the
 * noding is not correct, a {@link org.locationtech.jts.geom.TopologyException}
 * is thrown with details of the first invalid location found.
 *
 * @author mdavis
...
public class ValidatingNoder implements Noder {
	...
	/**
	 * Checks whether the output of the wrapped noder is fully noded. Throws an
