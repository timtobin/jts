...
/**
 * Computes the Constrained Delaunay Triangulation of polygons. The Constrained
 * Delaunay Triangulation of a polygon is a set of triangles covering the
 * polygon, with the maximum total interior angle over all possible
 * triangulations. It provides the "best quality" triangulation of the polygon.
 *
 * <p>
 * Holes are supported.
 */
public class ConstrainedDelaunayTriangulator {
	...
	/**
	 * Computes the Constrained Delaunay Triangulation of each polygon element in a
	 * geometry.
	 *
	 * @param geom
	 *            the input geometry
	...
	/**
	 * Computes the triangulation of a single polygon and returns it as a list of
	 * {@link Tri}s.
	 *
	 * @param poly
	 *            the input polygon
	...
	List<Tri> triangulatePolygon(Polygon poly) {
		...
		// System.out.println("swap used: " + (System.currentTimeMillis() - start) + "
		// milliseconds");
