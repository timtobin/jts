...
public class Envelope implements Comparable, Serializable {
	...
	/**
	 * Tests if an envelope is properly contained in this one. The envelope is
	 * properly contained if it is contained by this one but not equal to it.
	 *
	 * @param other
	...
	/**
	 * Tests if the region defined by <code>other</code> is disjoint from the region
	 * of this <code>
	 * Envelope</code>.
	 *
	 * <p>
	 ...
	 *
	 * @param other
	 *            the <code>Envelope</code> being checked for disjointness
	...
	public boolean equals(Object other) {
		...
		return maxx == otherEnvelope.getMaxX() && maxy == otherEnvelope.getMaxY() && minx == otherEnvelope.getMinX()
	...
	/**
	 * Tests if the extent defined by two extremal points intersects the extent of
	 * this <code>Envelope
	 * </code>.
	 *
	 * @param a
	...
	/**
	 * Tests if the region defined by <code>other</code> intersects the region of
	 * this <code>Envelope
	 * </code>.
	 *
	 * <p>
	...
	/**
	 * @deprecated Use #intersects instead. In the future, #overlaps may be changed
	 *             to be a true overlap check; that is, whether the intersection is
	 *             two-dimensional.
	 */
