...
/**
 * Finds intersections between line segments which will be snap-rounded, and
 * adds them as nodes to the segments.
 *
 * <p>
...
public class SnapRoundingIntersectionAdder implements SegmentIntersector {
	...
	/**
	 * Creates an intersector which finds all snapped interior intersections, and
	 * adds them as nodes.
	 *
	 * @param nearnessTol
	...
	public void processIntersections(SegmentString e0, int segIndex0, SegmentString e1, int segIndex1) {
		...
		/**
		 * Segments did not actually intersect, within the limits of orientation index
		 * robustness.
		 *
		 * <p>
		 * To avoid certain robustness issues in snap-rounding, also treat very near
		 * vertex-segment situations as intersections.
		 */
