 ...
 *
 * <p>
 * This class allows the {@link Geometry} predicate methods to be switched
 * between the original {@link RelateOp} algorithm and the modern
 * {@link RelateNG} codebase via a system property <code>
 * jts.relate</code>.
 *
 * <ul>
