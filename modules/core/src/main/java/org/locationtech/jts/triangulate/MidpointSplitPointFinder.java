 ...
 * This is a default strategy only. Usually a more sophisticated strategy is
 * required to prevent repeated splitting. Other points which could be used are:
 *
 * <ul>
 * <li>The projection of the encroaching point on the segment
 * <li>A point on the segment which will produce two segments which will not be
 * further encroached
 * <li>The point on the segment which is the same distance from an endpoint as
