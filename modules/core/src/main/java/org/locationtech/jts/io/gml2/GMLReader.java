 ...
 * </pre>
 *
 * The reader ignores namespace prefixes, and disables both the validation and
 * namespace options on the <tt>SAXParser</tt>. This class requires the presence
 * of a SAX Parser available via the
 * {@link javax.xml.parsers.SAXParserFactory#newInstance()} method.
 *
 * <p>
 * A specification of the GML XML format can be found at the OGC web site:
 ...
 *
 * <p>
 * To parse and build geometry directly from a SAX stream, see
 * {@link GMLHandler}.
 *
...
public class GMLReader {
	 ...
	 *
	 * <p>
	 * If a collection of Geometries is found, a {@link GeometryCollection} is
	 * returned.
	 *
	 * @param reader
	 *            The input source
	 ...
	 * @throws IOException
	 */
	public Geometry read(Reader reader, GeometryFactory geometryFactory)
	 ...
	 */
	public Geometry read(String gml, GeometryFactory geometryFactory)
			throws SAXException, IOException, ParserConfigurationException {
