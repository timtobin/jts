  ...
  public void addIntersections(Edge e0, int segIndex0, Edge e1, int segIndex1) {
    ...
    if (li.hasIntersection()) {
      ...
      if (!isTrivialIntersection(e0, segIndex0, e1, segIndex1)) {
        ...
        /**
         * In certain cases two line segments test as having a proper intersection via the robust
         * orientation check, but due to roundoff the computed intersection point is equal to an
         * endpoint. If the endpoint is a boundary point the computed point must be included as a
         * node. If it is not a boundary point the intersection is recorded as properInterior by
         * logic below.
         */
