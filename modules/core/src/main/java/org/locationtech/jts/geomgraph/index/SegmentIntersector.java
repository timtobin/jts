...
public class SegmentIntersector {
	...
	public void addIntersections(Edge e0, int segIndex0, Edge e1, int segIndex1) {
		...
		/**
		 * Always record any non-proper intersections. If includeProper is true, record
		 * any proper intersections as well.
		 */
		if (li.hasIntersection()) {
			...
			if (!isTrivialIntersection(e0, segIndex0, e1, segIndex1)) {
				...
				/**
				 * In certain cases two line segments test as having a proper intersection via
				 * the robust orientation check, but due to roundoff the computed intersection
				 * point is equal to an endpoint. If the endpoint is a boundary point the
				 * computed point must be included as a node. If it is not a boundary point the
	 ...
	 *
	 * @return indicates a proper intersection with an interior to at least two line
	 *         segments
	 */
	 ...
	 * @param segIndex1
	 *            segment index 1
	 * @return indicates a trivial intersection, a point shared by adjacent line
	 *         segments
	 */
