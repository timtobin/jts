...
public class LinearIterator {
	...
	/**
	 * Invariant: currentLine <> null if the iterator is pointing at a valid
	 * coordinate
	 */
	...
	/**
	 * Creates an iterator starting at a {@link LinearLocation} on a linear
	 * {@link Geometry}
	 *
	 * @param linear
	 *            the linear geometry to iterate over
	...
	/**
	 * Gets the second {@link Coordinate} of the current segment. (the coordinate of
	 * the next vertex). If the iterator is at the end of a line, <code>null</code>
	 * is returned.
	 *
	...
	/**
	 * Gets the first {@link Coordinate} of the current segment. (the coordinate of
	 * the current vertex).
	 *
	...
	/**
	 * Tests whether there are any vertices left to iterator over. Specifically,
	 * hasNext() return <tt>true</tt> if the current state of the iterator
	 * represents a valid location on the linear geometry.
	 *
