...
/**
 * A base class for {@link PreparedGeometry} subclasses. Contains default implementations for
 * methods, which simply delegate to the equivalent {@link Geometry} methods. This class may be used
 * as a "no-op" class for Geometry types which do not have a corresponding {@link PreparedGeometry}
 * implementation.
 *
 * @author Martin Davis
 */
class BasicPreparedGeometry implements PreparedGeometry {
  ...
  /**
   * Gets the list of representative points for this geometry. One vertex is included for every
   * component of the geometry (i.e. including one for every ring of polygonal geometries).
   *
   * <p>Do not modify the returned list!
   *
  ...
  /**
   * Tests whether any representative of the target geometry intersects the test geometry. This is
   * useful in A/A, A/L, A/P, L/P, and P/P cases.
   *
  ...
  /** Standard implementation for all geometries. Supports {@link GeometryCollection}s as input. */
