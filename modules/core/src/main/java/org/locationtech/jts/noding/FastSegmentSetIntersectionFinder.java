...
/**
 * Finds if two sets of {@link SegmentString}s intersect. Uses indexing for fast performance and to
 * optimize repeated tests against a target set of lines. Short-circuited to return as soon an
...
public class FastSegmentSetIntersectionFinder {
  ...
  /**
   * Gets the segment set intersector used by this class. This allows other uses of the same
   * underlying indexed structure.
   *
  ...
  /**
   * Tests for intersections with a given set of target {@link SegmentString}s. using a given
