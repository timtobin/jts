...
public class Edge extends GraphComponent {
	 ...
	 *
	 * @param li
	 *            Determining number of intersections to add
	 * @param segmentIndex
	 *            Segment index to add
	 * @param geomIndex
	 ...
	 *
	 * <p>
	 * e1 equals e2 <b>iff</b> the coordinates of e1 are the same or the reverse of
	 * the coordinates in e2
	 */
	 ...
	 *
	 * @return zero-width V area edge, consisting of two segments which are equal
	 *         and of oppose orientation
	 */
