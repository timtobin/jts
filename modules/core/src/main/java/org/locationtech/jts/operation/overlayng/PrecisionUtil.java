 ...
 *
 * <p>WARNING: the <code>inherentScale</code> and <code>robustScale</code> functions can be very
 * slow, due to the method used to determine number of decimal places of a number. These are not
...
public class PrecisionUtil {
   ...
   *
   * <p>This value should be less than the maximum decimal precision of double-precision values
   * (16).
   */
   ...
   * is chosen to maximize output precision while avoiding round-off issues.
   *
   * <p>NOTE: this is a heuristic determination, so is not guaranteed to eliminate precision issues.
   *
   * <p>WARNING: this is very slow.
   *
   * @param a a geometry
   * @param b a geometry
   ...
   * number has no more than {@link #MAX_ROBUST_DP_DIGITS} digits of precision.
   *
   ...
   * ordinates have no more than {@link #MAX_ROBUST_DP_DIGITS} digits of precision.
   *
   ...
   * digits) when used to round the given number.
   *
   * <p>For example: to provide 5 decimal digits of precision for the number 123.456 the precision
   * scale factor is 100; for 3 digits of precision the scale factor is 1; for 2 digits of precision
   * the scale factor is 0.1.
   *
   * <p>Rounding to the scale factor can be performed with {@link PrecisionModel#round}
   *
   ...
   * ordinates.
   *
   * <p>This is the maximum inherent scale of all ordinate values in the geometry.
   *
   * <p>WARNING: this is very slow.
   *
   * @param geom geometry
   ...
   * geometry ordinates.
   *
   * <p>This is the maximum inherent scale of all ordinate values in the geometries.
   *
   * <p>WARNING: this is very slow.
   *
   * @param a a geometry
