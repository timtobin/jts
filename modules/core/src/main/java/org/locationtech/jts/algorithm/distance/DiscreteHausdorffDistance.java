 ...
 * given fraction. The class can also determine two points of the geometries which are separated by
 ...
 * </blockquote>
 *
 * The approximation can be made as close as needed by densifying the input geometries. In the
 * limit, this value will approach the true Hausdorff distance:
 *
 * <blockquote>
 *
 ...
 * </blockquote>
 *
 * The default approximation is exact or close enough for a large subset of useful cases. Examples
 * of these are:
 *
 * <ul>
 *   <li>computing distance between Linestrings that are roughly parallel to each other, and roughly
 *       equal in length. This occurs in matching linear networks.
 ...
 * </pre>
 *
 * The class can compute the oriented Hausdorff distance from A to B. This computes the distance to
 * the farthest point on A from B.
 *
 * <blockquote>
 *
 ...
 * </blockquote>
 *
 * A use case is to test whether a geometry A lies completely within a given distance of another one
 * B. This is more efficient than testing whether A is covered by a buffer of B.
 *
...
public class DiscreteHausdorffDistance {
  ...
  /**
   * Computes the Hausdorff distance between two geometries, with each segment densified by the
   * given fraction.
   *
   * @param g0 the first input
   * @param g1 the second input
  ...
  /**
   * Computes a line containing points indicating the Hausdorff distance between two geometries.
   *
   * @param g0 the first input
   * @param g1 the second input
  ...
  /**
   * Computes the oriented Hausdorff distance from one geometry to another, with each segment
  ...
  /**
   * Computes a line containing points indicating the computed oriented Hausdorff distance from one
   * geometry to another.
   *
   * @param g0 the first input
   * @param g1 the second input
  ...
  /**
   * Computes a line containing points indicating the computed oriented Hausdorff distance from one
   * geometry to another, with each segment densified by the given fraction.
   *
   * @param g0 the first input
   * @param g1 the second input
   * @param densifyFrac the densification fraction (in [0, 1])
  ...
  private void computeOrientedDistance(
