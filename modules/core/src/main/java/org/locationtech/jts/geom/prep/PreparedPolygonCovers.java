...
/**
 * Computes the <tt>covers</tt> spatial relationship predicate for a {@link PreparedPolygon}
...
class PreparedPolygonCovers extends AbstractPreparedPolygonContains {
  /**
   * Computes the </tt>covers</tt> predicate between a {@link PreparedPolygon} and a {@link
   * Geometry}.
   *
  ...
  /**
   * Computes the full topological <tt>covers</tt> predicate. Used when short-circuit tests are not
   * conclusive.
   *
   * @param geom the test geometry
