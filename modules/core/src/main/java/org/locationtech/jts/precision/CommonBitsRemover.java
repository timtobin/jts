...
public class CommonBitsRemover {
	 ...
	 * After this method has executed the common coordinate reflects the common bits
	 * of all added geometries.
	 *
	 * @param geom
	...
	/**
	 * Adds the common coordinate bits back into a Geometry. The coordinates of the
