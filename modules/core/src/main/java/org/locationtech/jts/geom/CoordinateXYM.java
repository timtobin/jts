 ...
 * <tt>dimension</tt> = 3 and <tt>measures</tt> = 1.
 *
 * <p>
...
public class CoordinateXYM extends Coordinate {
	 ...
	 *
	 * <p>
	 * This constant assumes XYM coordinate sequence definition. Check this
	...
	/**
	 * Constructs a CoordinateXYM instance with the x and y ordinates of the given
	 * Coordinate.
	 *
	 * @param coord
	...
	/**
	 * Constructs a CoordinateXY instance with the x and y ordinates of the given
	 * CoordinateXYM.
	 *
	 * @param coord
	 *            the coordinate providing the ordinates
