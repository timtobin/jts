 ...
 * </pre>
 *
 * and ulp(y) means "unit in the last place of y". The basic arithmetic operations are implemented
 * using convenient properties of IEEE-754 floating-point arithmetic.
 *
 ...
 * default. Some processors (notably the Intel Pentium architecture) perform floating point
 ...
 * values and one to hold the result of the addition.
 *
 * <pre>
 *     DD a = new DD(2.0);
 *     DD b = new DD(3.0);
 ...
 *
 * <ul>
 *   <li>Priest, D., <i>Algorithms for Arbitrary Precision Floating Point Arithmetic</i>, in P.
 *       Kornerup and D. Matula, Eds., Proc. 10th Symposium on Computer Arithmetic, IEEE Computer
 *       Society Press, Los Alamitos, Calif., 1991.
 *   <li>Yozo Hida, Xiaoye S. Li and David H. Bailey, <i>Quad-Double Arithmetic: Algorithms,
 *       Implementation, and Application</i>, manuscript, Oct 2000; Lawrence Berkeley National
 *       Laboratory Report BNL-46996.
  ...
  */
  ...
  private String extractSignificantDigits(boolean insertDecimalPoint, int[] magnitude) {
    ...
    for (int i = 0; i <= numDigits; i++) {
      ...
      int digit = (int) y.hi;
      //      System.out.println("printDump: [" + i + "] digit: " + digit + "  y: " + y.dump() + "
      // buf: " + buf);
