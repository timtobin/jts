...
/**
 * A 2-dimensional mathematical vector represented by double-precision X and Y
 * components.
 *
 * @author mbdavis
 */
public class Vector2D {
	...
	/**
	 * Creates a vector with the direction and magnitude of the difference between
	 * the <tt>to</tt> and <tt>from</tt> {@link Coordinate}s.
	 *
	 * @param from
	 ...
	 * @return true if <tt>other</tt> is a <tt>Vector2D</tt> with the same values
	 ...
	 * negative number rotates clockwise. Under this operation the magnitude of the
	 * vector and the absolute values of the ordinates do not change, only their
	 * sign and ordinate index.
	 *
	 * @param numQuarters
	...
	/**
	 * Computes the weighted sum of this vector with another vector, with this
	 * vector contributing a fraction of <tt>frac</tt> to the total.
	 *
	 * <p>
	 * In other words,
	 *
