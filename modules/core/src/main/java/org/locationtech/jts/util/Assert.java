...
public class Assert {
	...
	/**
	 * Throws an <code>AssertionFailedException</code> if the given objects are not
	 * equal, according to the <code>equals</code> method.
	 *
	 * @param expectedValue
	 *            the correct value
	 * @param actualValue
	...
	/**
	 * Throws an <code>AssertionFailedException</code> with the given message if the
	 * given objects are not equal, according to the <code>equals</code> method.
	 *
	 * @param expectedValue
	 *            the correct value
	 * @param actualValue
	...
	/**
	 * Throws an <code>AssertionFailedException</code> if the given assertion is not
	 * true.
	 *
	 * @param assertion
