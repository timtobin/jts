...
public class LineBuilder {
	 ...
	 * edges at nodes which also have A edges can be checked by checking their depth
	 * at that node. L edges at nodes which do not have A edges can be checked by
	 * doing a point-in-polygon test with the previously computed result areas.
	 */
	private void findCoveredLineEdges() {
		...
		/**
		 * For all L edges which weren't handled by the above, use a point-in-poly test
