...
/**
 * Computes the minimum-area rectangle enclosing a {@link Geometry}. Unlike the
 * {@link Envelope}, the rectangle may not be axis-parallel.
 *
 * <p>
 ...
 * {@link LineString} or a {@link Point}.
 *
 * <p>
 * The minimum-area enclosing rectangle does not necessarily have the minimum
 * possible width. Use {@link MinimumDiameter} to compute this.
 *
 * @see MinimumDiameter
 * @see ConvexHull
 */
public class MinimumAreaRectangle {
	...
	/**
	 * Gets the minimum-area rectangular {@link Polygon} which encloses the input
	 * geometry. If the convex hull of the input is degenerate (a line or point) a
	 * {@link LineString} or {@link Point} is returned.
	 *
	 * @param geom
	 *            the geometry
	...
	/**
	 * Compute a minimum rectangle for a {@link Geometry}, with a hint if the
	 ...
	 *
	 * <p>
	 * This algorithm uses the "dual rotating calipers" technique. Performance is
	 * linear in the number of segments.
	 *
	 * @param ring
	 *            the convex ring to scan
	 */
	private Polygon computeConvexRing(Coordinate[] ring) {
		...
		return Rectangle.createFromSidePts(ring[minRectangleBaseIndex], ring[minRectangleBaseIndex + 1],
