...
/**
 * Extracts a single point from each connected element in a Geometry (e.g. a
 * polygon, linestring or point) and returns them in a list
 *
 * @version 1.7
 */
public class ConnectedElementPointFilter implements GeometryFilter {
	...
	/**
	 * Returns a list containing a Coordinate from each Polygon, LineString, and
	 * Point found inside the specified geometry. Thus, if the specified geometry is
