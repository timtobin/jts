...
/**
 * Represents an undirected edge of a {@link PlanarGraph}. An undirected edge in
 * fact simply acts as a central point of reference for two opposite
 * {@link DirectedEdge}s.
 *
 * <p>
...
public class Edge extends GraphComponent {
	...
	/**
	 * Returns the {@link DirectedEdge} that starts from the given node, or null if
	 * the node is not one of the two nodes associated with this Edge.
	 */
