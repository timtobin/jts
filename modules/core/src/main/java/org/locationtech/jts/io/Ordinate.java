 ...
 *
 * <p>
 * Intended to be used as an {@code EnumSet<Ordinate>}, optimized create methods
 * have been provided for {@link #createXY()}, {@link #createXYM()},
 * {@link #createXYZ()} and {@link #createXYZM()}.
 */
public enum Ordinate {
	...
	/**
	 * EnumSet of X and Y ordinates, a copy is returned as EnumSets are not
	 * immutable.
	 *
