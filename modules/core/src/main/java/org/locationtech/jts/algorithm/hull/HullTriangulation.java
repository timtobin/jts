...
/**
 * Functions to operate on triangulations represented as lists of
 * {@link HullTri}s.
 *
 * @author mdavis
 */
class HullTriangulation {
	 ...
	 * by tracing CW around the border triangles. Assumption: there are at least 2
	 * tris, they are connected, and there are no holes. So each tri has at least
	 * one non-boundary edge, and there is only one boundary.
	 *
	 * @param triList
	 *            the triangulation
	...
	/**
	 * Creates a Polygon representing the area of a triangulation which is connected
	...
	/**
	 * Creates a polygonal geometry representing the area of a triangulation which
	 * may be disconnected or contain holes.
	 *
	 * @param triList
	 *            the triangulation
	 * @param geomFactory
