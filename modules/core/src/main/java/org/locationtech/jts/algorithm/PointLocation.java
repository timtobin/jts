...
/**
 * Functions for locating points within basic geometric structures such as line segments, lines and
 * rings.
 *
 * @author Martin Davis
 */
public class PointLocation {
  ...
  public static boolean isOnSegment(Coordinate p, Coordinate p0, Coordinate p1) {
    ...
    if (!Envelope.intersects(p0, p1, p)) return false;
    // -- handle zero-length segments
    if (p.equals2D(p0)) return true;
