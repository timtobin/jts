...
/**
 * Computes the <tt>intersects</tt> spatial relationship predicate for {@link PreparedPolygon}s
...
class PreparedPolygonIntersects extends PreparedPolygonPredicate {
  /**
   * Computes the intersects predicate between a {@link PreparedPolygon} and a {@link Geometry}.
   *
  ...
  public boolean intersects(Geometry geom) {
    ...
    /**
     * If input contains only points, then at this point it is known that none of them are contained
     * in the target
     */
