 ...
 *   <li>Limiting patterns via geometry dimension. A dimension limit specifies the allowable
 *       dimensions for both or individual geometries as [d] or [ab] or [ab;cd]
 * </ul>
 *
 * @author Martin Davis
 */
