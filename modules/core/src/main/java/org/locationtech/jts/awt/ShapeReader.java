...
/**
 * Converts a Java2D {@link Shape} or the more general {@link PathIterator} into
 * a {@link Geometry}.
 *
 * <p>
 * The coordinate system for Java2D is typically screen coordinates, which has
 * the Y axis inverted relative to the usual JTS coordinate system. This is
 * rectified during conversion.
 *
 * <p>
...
public class ShapeReader {
	...
	/**
	 * Extracts the points of the paths in a flat {@link PathIterator} into a list
