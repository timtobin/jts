...
public class Plane3D {
	 ...
	 *
	 * <p>
	 * Geometries lying in this plane undergo least distortion (and have maximum
	 * area) when projected to the closest axis plane. This provides optimal
	 * conditioning for computing a Point-in-Polygon test.
	 *
	 ...
	 *
	 * <ul>
	 * <li><b>positive</b> if the point lies above the plane (relative to the plane
	 * normal)
	 * <li><b>zero</b> if the point is on the plane
	 * <li><b>negative</b> if the point lies below the plane (relative to the plane
	 * normal)
	 * </ul>
	 *
	 * @param p
