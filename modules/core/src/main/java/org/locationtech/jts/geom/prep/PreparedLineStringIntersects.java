...
/**
 * Computes the <tt>intersects</tt> spatial relationship predicate for a target
 * {@link PreparedLineString} relative to other {@link Geometry} classes. Uses
...
class PreparedLineStringIntersects {
	/**
	 * Computes the intersects predicate between a {@link PreparedLineString} and a
	 * {@link Geometry}.
	 *
	 * @param prep
	 *            the prepared linestring
	 * @param geom
	 *            a test geometry
	...
	/**
	 * Tests whether any representative point of the test Geometry intersects the
	 * target geometry. Only handles test geometries which are Puntal (dimension 0)
	 *
	 * @param geom
