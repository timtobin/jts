...
/**
 * Computes the <tt>intersects</tt> spatial relationship predicate for a target {@link
 * PreparedLineString} relative to other {@link Geometry} classes. Uses short-circuit tests and
...
class PreparedLineStringIntersects {
  /**
   * Computes the intersects predicate between a {@link PreparedLineString} and a {@link Geometry}.
   *
