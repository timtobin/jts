...
/**
 * A framework to visit sets of edge-connected {@link QuadEdgeTriangle}s in
 * breadth-first order
 *
 * @author Martin Davis
 * @version 1.0
...
public class EdgeConnectedTriangleTraversal {
	...
	/**
	 * Subclasses can call this method to add a triangle to the end of the queue.
	 * This is useful for initializing the queue to a chosen set of triangles.
	 *
	 * @param tri
	 *            a triangle
	 */
