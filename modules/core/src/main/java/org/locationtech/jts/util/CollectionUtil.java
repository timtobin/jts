...
public class CollectionUtil {
  ...
  /**
   * Executes a function on each item in a {@link Collection} and returns the results in a new
   * {@link List}
   *
  ...
  /**
   * Executes a {@link Function} on each item in a Collection and collects all the entries for which
   * the result of the function is equal to {@link Boolean} <tt>true</tt>.
   *
