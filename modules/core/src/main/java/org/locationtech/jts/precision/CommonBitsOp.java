...
/**
 * Provides versions of Geometry spatial functions which use common bit removal
 * to reduce the likelihood of robustness problems.
 *
 * <p>
 * In the current implementation no rounding is performed on the reshifted
 * result geometry, which means that it is possible that the returned Geometry
 * is invalid. Client classes should check the validity of the returned result
 * themselves.
 *
 * @version 1.7
 */
public class CommonBitsOp {
	 ...
	 * {@link Geometry}s should be reshifted.
	 *
	 ...
	 *
	 * <p>
	 * In this current implementation, no rounding is performed on the reshifted
	 * result geometry, which means that it is possible that the returned Geometry
	 * is invalid.
	 *
	 * @param result
	...
	/**
	 * Computes the set-theoretic difference of two {@link Geometry}s, using
	 * enhanced precision.
	 *
	 * @param geom0
	 *            the first Geometry
	 ...
	 * @return the Geometry representing the set-theoretic difference of the input
	 *         Geometries.
	 */
	...
	/**
	 * Computes the set-theoretic intersection of two {@link Geometry}s, using
	 * enhanced precision.
	 *
	 * @param geom0
	 *            the first Geometry
	 * @param geom1
	 *            the second Geometry
	 * @return the Geometry representing the set-theoretic intersection of the input
	 *         Geometries.
	 */
	...
	/**
	 * Computes a copy of each input {@link Geometry}s with the calculated common
	 * bits removed from each coordinate.
	 *
	 * @param geom0
	 *            a Geometry to remove common bits from
	 * @param geom1
	 *            a Geometry to remove common bits from
	 * @return an array containing copies of the input Geometry's with common bits
	 *         removed
	 */
	...
	/**
	 * Computes the set-theoretic symmetric difference of two geometries, using
	 * enhanced precision.
	 *
	 * @param geom0
	 *            the first Geometry
	 * @param geom1
	 *            the second Geometry
	 * @return the Geometry representing the set-theoretic symmetric difference of
	...
	/**
	 * Computes the set-theoretic union of two {@link Geometry}s, using enhanced
	 * precision.
	 *
	 * @param geom0
	 *            the first Geometry
	 * @param geom1
	 *            the second Geometry
	 * @return the Geometry representing the set-theoretic union of the input
	 *         Geometries.
	 */
