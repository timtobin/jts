...
public class MultiPolygon extends GeometryCollection implements Polygonal {
	...
	/**
	 * @param polygons
	 *            the <code>Polygon</code>s for this <code>MultiPolygon</code>, or
	 *            <code>null
	 *     </code> or an empty array to create the empty geometry. Elements may be
	 *            empty <code>Polygon
	 *     </code>s, but not <code>null</code>s. The polygons must conform to the
	...
	/**
	 * Creates a {@link MultiPolygon} with every component reversed. The order of
