...
public class STRtree extends AbstractSTRtree implements SpatialIndex, Serializable {
	...
	private static final IntersectsOp intersectsOp = (aBounds, bBounds) -> ((Envelope) aBounds)
			.intersects((Envelope) bBounds);

	/** */
	@Serial
	private static final long serialVersionUID = 259274702368956900L;

	private static final Comparator xComparator = (o1, o2) -> compareDoubles(
			centreX((Envelope) ((Boundable) o1).getBounds()), centreX((Envelope) ((Boundable) o2).getBounds()));

	private static final Comparator yComparator = (o1, o2) -> compareDoubles(
			centreY((Envelope) ((Boundable) o1).getBounds()), centreY((Envelope) ((Boundable) o2).getBounds()));
	 ...
	 * @param itemDist
	 *            a distance metric applicable to the items in this tree and the
	 *            query item
	 ...
	 *
	 * <p>
	 * If the tree is empty, the return value is <code>null
	 * </code.
	 ...
	 *
	 * <p>&#64;param itemDist a distance metric applicable to the items in this tree
	 *
	 * @return the pair of the nearest items or <code>null</code> if the tree is
	 * empty
	 */
