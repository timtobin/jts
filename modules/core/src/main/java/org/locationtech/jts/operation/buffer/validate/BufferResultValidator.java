...
/**
 * Validates that the result of a buffer operation is geometrically correct,
 * within a computed tolerance.
 *
 * <p>
...
public class BufferResultValidator {
	...
	/**
	 * Checks whether the geometry buffer is valid, and returns an error message if
	 * not.
	 *
	 * @param g
	 * @param distance
	 ...
	 *
	 * <p>
	 * If the failure is due to the buffer curve being too far or too close to the
	 * input, the indicator is a line segment showing the location and size of the
	 * discrepancy.
	 *
