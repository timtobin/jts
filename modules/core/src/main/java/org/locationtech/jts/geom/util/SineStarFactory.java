...
/**
 * Creates geometries which are shaped like multi-armed stars with each arm
 * shaped like a sine wave. These kinds of geometries are useful as a more
 * complex geometry for testing algorithms.
 *
 * @author Martin Davis
 */
public class SineStarFactory extends GeometricShapeFactory {
	...
	/**
	 * Sets the ratio of the length of each arm to the radius of the star. A smaller
	 * number makes the arms shorter. Value should be between 0.0 and 1.0
	 *
	 * @param armLengthRatio
