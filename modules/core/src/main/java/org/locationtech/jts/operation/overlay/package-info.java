 ...
 * {@link org.locationtech.jts.geom.Geometry}s. The algorithm for computing the
 * overlay uses the intersection operations supported by topology graphs. To
 * compute an overlay it is necessary to explicitly compute the resultant graph
 * formed by the computed intersections.
 *
 * <p>
 ...
 * the input graphs.
 * <LI>Compute new edges between the compute intersection nodes. Label the edges
 * appropriately.
 ...
 * <LI>Compute the result of the boolean combination by selecting the node and
 * edges with the appropriate labels. Polygonize areas and sew linear geometries
 * together.
 * </UL>
 *
