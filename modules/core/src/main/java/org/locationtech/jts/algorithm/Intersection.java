 ...
 * are nearly parallel. These routines uses numerical conditioning on the input
...
public class Intersection {
	...
	/**
	 * Computes the intersection point of two lines. If the lines are parallel or
	 * collinear this case is detected and <code>null</code> is returned.
	 *
	 * @param p1
	 ...
	 * @param q2
	 *            an endpoint of line 2
	 * @return the intersection point between the lines, if there is one, or null if
	 *         the lines are parallel or collinear
	 * @see CGAlgorithmsDD#intersection(Coordinate, Coordinate, Coordinate,
	 *      Coordinate)
	 */
	...
	/**
	 * Compute intersection of two lines, using a floating-point algorithm. This is
	 * less accurate than
	 * {@link CGAlgorithmsDD#intersection(Coordinate, Coordinate, Coordinate, Coordinate)}.
	 * It has caused spatial predicate failures in some cases. This is kept for
	 * testing purposes.
	 *
	 * @param p1
	 *            an endpoint of line 1
	...
	/**
	 * Computes the intersection point of a line and a line segment (if any). There
	 * will be no intersection point if:
	 *
	 * <ul>
	 ...
	 * @param seg2
	 *            an endpoint of the line segment
	 * @return the intersection point, or null if it is not possible to find an
	 *         intersection
	 */
	public static Coordinate lineSegment(Coordinate line1, Coordinate line2, Coordinate seg1, Coordinate seg2) {
		...
		/**
		 * The segment intersects the line. The full line-line intersection is used to
		 ...
		 * return null. In this case choose the closest point
		 */
