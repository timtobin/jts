...
public class HCoordinate {
	 ...
	 *
	 * @deprecated use
	 *             {@link Intersection#intersection(Coordinate, Coordinate, Coordinate, Coordinate)}
	 */
	...
	/*
	 * public static Coordinate OLDintersection( Coordinate p1, Coordinate p2,
	 * Coordinate q1, Coordinate q2) throws NotRepresentableException { HCoordinate
	 * l1 = new HCoordinate(p1, p2); HCoordinate l2 = new HCoordinate(q1, q2);
	 * HCoordinate intHCoord = new HCoordinate(l1, l2); Coordinate intPt =
