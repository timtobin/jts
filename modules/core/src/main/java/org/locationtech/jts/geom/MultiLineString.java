...
public class MultiLineString extends GeometryCollection implements Lineal {
	 ...
	 *            geometry. Elements may be empty <code>LineString</code>s, but not
	 *            <code>null</code> s.
	...
	/**
	 * Creates a {@link MultiLineString} in the reverse order to this object. Both
	 * the order of the component LineStrings and the order of their coordinate
