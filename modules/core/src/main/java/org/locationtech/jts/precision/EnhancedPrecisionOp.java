...
/**
 * Provides versions of Geometry spatial functions which use enhanced precision techniques to reduce
 * the likelihood of robustness problems.
 *
 * @version 1.7
 */
public class EnhancedPrecisionOp {
  ...
  /**
   * Computes the set-theoretic symmetric difference of two {@link Geometry}s, using enhanced
   * precision.
   *
   * @param geom0 the first Geometry
   * @param geom1 the second Geometry
  ...
  /**
   * Computes the buffer of a {@link Geometry}, using enhanced precision. This method should no
   * longer be necessary, since the buffer algorithm now is highly robust.
   *
