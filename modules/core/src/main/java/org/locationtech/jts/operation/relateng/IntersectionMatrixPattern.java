 ...
 * {@link RelateNG#evaluate(org.locationtech.jts.geom.Geometry, String)} and
 * {@link RelateNG#relate(org.locationtech.jts.geom.Geometry, org.locationtech.jts.geom.Geometry, String)}.
 *
 * <h3>DE-9IM Pattern Matching</h3>
 *
 * Matrix patterns are specified as a 9-character string containing the pattern
 * symbols for the DE-9IM 3x3 matrix entries, listed row-wise. The pattern
 * symbols are:
 *
 * <ul>
...
public class IntersectionMatrixPattern {
	...
	/**
	 * A DE-9IM pattern to detect whether two polygonal geometries are adjacent
	 * along an edge, but do not overlap.
	 */
