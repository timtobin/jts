...
public class GeometryCollection extends Geometry {
	 ...
	 *            <code>GeometryCollection</code>, or <code>null</code> or an empty
	...
	public int getDimension() {
		/*
		 * int dimension = Dimension.FALSE; for (int i = 0; i < geometries.length; i++)
		 * { dimension = Math.max(dimension, geometries[i].getDimension()); } return
		 * dimension; //
		 */
		// *
		if (geomCollDim == null) {
	...
	/**
	 * Creates a {@link GeometryCollection} with every component reversed. The order
