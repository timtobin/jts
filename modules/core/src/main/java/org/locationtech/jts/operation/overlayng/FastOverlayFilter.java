...
public class FastOverlayFilter {
	...
	/**
	 * Computes the overlay operation on the input geometries, if it can be
	 * determined that the result is either empty or equal to one of the input
	 * values. Otherwise <code>null</code> is returned, indicating that a full
	 * overlay operation must be performed.
	 *
	 * @param geom
	 * @param overlayOpCode
