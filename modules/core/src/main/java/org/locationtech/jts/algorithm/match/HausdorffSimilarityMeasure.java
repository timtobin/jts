 ...
 * Hausdorff distance metric. The measure is normalized to lie in the range [0,
 * 1]. Higher measures indicate a great degree of similarity.
 *
 * <p>
 * The measure is computed by computing the Hausdorff distance between the input
...
public class HausdorffSimilarityMeasure implements SimilarityMeasure {
	 ...
	 * HausdorffSimilarityMeasure gv = new HausdorffSimilarityMeasure(a, b); return
	 * gv.measure(); }
	 */
