 ...
 * {@link Geometry}. For polygonal geometries, this will extract all the
 * component {@link LinearRing}s. If desired, <code>
...
public class LinearComponentExtracter implements GeometryComponentFilter {
	/**
	 * Extracts the linear components from a single {@link Geometry} and returns
	 * them as either a {@link LineString} or {@link MultiLineString}.
	 *
	 * @param geom
	 ...
	 *
	 * @param geoms
	 *            the collection of geometries from which to extract linear
	 *            components
	 * @param lines
