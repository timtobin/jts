 ...
 * {@link Geometry} specified by a subsequence of a {@link CoordinateSequence}.
 *
 * @author Martin Davis
 */
public class FacetSequence {
	...
	/**
	 * Computes the locations of the nearest points between this sequence and
	 * another sequence. The locations are presented in the same order as the input
	 * sequences.
	 *
	...
	private void updateNearestLocationsPointLine(Coordinate pt, FacetSequence facetSeq, int i, Coordinate q0,
			Coordinate q1, GeometryLocation[] locs) {
		locs[0] = new GeometryLocation(geom, start, new Coordinate(pt));
