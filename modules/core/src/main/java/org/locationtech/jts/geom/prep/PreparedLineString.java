...
public class PreparedLineString extends BasicPreparedGeometry {
  ...
  /**
   * There's not much point in trying to optimize contains, since contains for linear targets
   * requires the entire test geometry to exactly match the target linework.
   */
}
