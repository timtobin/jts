 ...
 * creating new Geometrys with the same structure but (possibly) modified components.
 *
 ...
 *       The modified coordinate lists must be consistent with their original parent component (e.g.
 ...
 * via the {@link #GeometryEditor(GeometryFactory)} constructor. Examples of situations where this
 * is required is if the geometry is transformed to a new SRID and/or a new PrecisionModel.
 *
 * <p><b>Usage Notes</b>
 *
 * <ul>
...
public class GeometryEditor {
  ...
  public interface GeometryEditorOperation {
     ...
     * @param factory the factory with which to construct the modified Geometry (may be different to
  ...
  public abstract static class CoordinateOperation implements GeometryEditorOperation {
     ...
     *
     * <p>If it is desired to preserve the immutability of Geometrys, if the coordinates are changed
