...
/**
 * The Class BoundablePairDistanceComparator. It implements Java comparator and
 * is used as a parameter to sort the BoundablePair list.
 */
public class BoundablePairDistanceComparator implements Comparator<BoundablePair>, Serializable {
	 ...
	 *
	 * @param normalOrder
	 *            true puts the lowest record at the head of this queue. This is the
	 *            natural order. PriorityQueue peek() will get the least element.
	 */
