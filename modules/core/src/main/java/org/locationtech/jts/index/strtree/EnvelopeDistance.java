...
public class EnvelopeDistance {
	 ...
	 * @param by2
	 *            y ordinate of second endpoint of segment 2
	 * @return maximum distance between the segments
	 */
	private static double maxDistance(double ax1, double ay1, double ax2, double ay2, double bx1, double by1,
	...
	/**
	 * Computes the maximum distance between the points defining two envelopes. It
	 * is equal to the length of the diagonal of the envelope containing both input
	 * envelopes. This is a coarse upper bound on the distance between geometries
	 * bounded by the envelopes.
	 *
	 * @param env1
	 *            an envelope
	 * @param env2
	...
	/**
	 * Computes the Min-Max Distance between two {@link Envelope}s. It is equal to
	 * the minimum of the maximum distances between all pairs of edge segments from
	 * the two envelopes. This is the tight upper bound on the distance between
	 * geometric items bounded by the envelopes.
	 *
	 * <p>
	 * Theoretically this bound can be used in the R-tree nearest-neighbour
	 * branch-and-bound search instead of
	 * {@link #maximumDistance(Envelope, Envelope)}. However, little performance
	 * improvement is observed in practice.
	 *
	 * @param a
	 *            an envelope
	 * @param b
