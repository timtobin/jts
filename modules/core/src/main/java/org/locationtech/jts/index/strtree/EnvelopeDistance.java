...
public class EnvelopeDistance {
   ...
   *
   * <p>Theoretically this bound can be used in the R-tree nearest-neighbour branch-and-bound search
   * instead of {@link #maximumDistance(Envelope, Envelope)}. However, little performance
