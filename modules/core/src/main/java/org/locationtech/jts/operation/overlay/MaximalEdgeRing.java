 ...
 * <tt>MaximalEdgeRing</tt> may represent two different spatial entities:
 *
 * <ul>
 ...
 * under the OGC SFS model, {@link MinimalEdgeRing}s are required. A MaximalEdgeRing can be
 * converted to a list of MinimalEdgeRings using the {@link #buildMinimalRings() } method.
 *
 * @version 1.7
