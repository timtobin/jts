...
public class EdgeIntersection implements Comparable {
	 ...
	 *
	 * @param segmentIndex
	 *            index of the containing line segment
	 * @param dist
	 *            dge distance of this point along the containing line segment
	 * @return {@code 1} this EdgeIntersection is located before the argument
	 *         location, {@code 0} this EdgeIntersection is at the argument
	 *         location, {@code 1} this EdgeIntersection is located after the
	 *         argument location
	 */
