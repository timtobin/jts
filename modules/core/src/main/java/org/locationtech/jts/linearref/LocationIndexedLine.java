...
/**
 * Supports linear referencing along a linear {@link Geometry} using
 * {@link LinearLocation}s as the index.
 */
public class LocationIndexedLine {
	 ...
	 * given indices. If the start location is after the end location, the computed
	 * linear geometry has reverse orientation to the input line.
	 *
	 * @param startIndex
	 ...
	 * <i>conform</i> to the line; that is, all vertices in the subline (except
