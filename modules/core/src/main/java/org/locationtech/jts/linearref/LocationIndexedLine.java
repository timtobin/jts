...
/**
 * Supports linear referencing along a linear {@link Geometry} using {@link LinearLocation}s as the
 * index.
 */
public class LocationIndexedLine {
   ...
   * start location is after the end location, the computed linear geometry has reverse orientation
   * to the input line.
   *
  ...
  /**
   * Computes the indices for a subline of the line. (The subline must <i>conform</i> to the line;
