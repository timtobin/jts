...
/**
 * Combines {@link Geometry}s to produce a {@link GeometryCollection} of the
 * most appropriate type. Input geometries which are already collections will
 * have their elements extracted first. No validation of the result geometry is
 * performed. (The only case where invalidity is possible is where
 * {@link Polygonal} geometries are combined and result in a self-intersection).
 *
 * @author mbdavis
...
public class GeometryCombiner {
	...
	/**
	 * Computes the combination of the input geometries to produce the most
	 * appropriate {@link Geometry} or {@link GeometryCollection}
	 *
