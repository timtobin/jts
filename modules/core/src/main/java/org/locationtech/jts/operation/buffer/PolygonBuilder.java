...
class PolygonBuilder {
  ...
  /**
   * Determines finds a containing shell for all holes which have not yet been assigned to a shell.
   *
   * <p>Holes which do not lie in any shell are (probably) an eroded element, so are simply
   * discarded
   */
