 ...
 *
 * <p>
 * A <b>polygonal coverage</b> is a collection of {@link Polygon}s which satisfy
 * the following conditions:
 *
 * <ol>
 * <li><b>Vector-clean</b> - Line segments within the collection must either be
 * identical or intersect only at endpoints.
 * <li><b>Non-overlapping</b> - No two polygons may overlap. Equivalently,
 * polygons must be interior-disjoint.
 * </ol>
 *
 * <p>
 * A <b>linear coverage</b> is a collection of {@link LineString}s which
 * satisfies the <b>Vector-clean</b> condition. Note that this does not require
 * the LineStrings to be fully noded - i.e. they may contain coincident
 * linework. Coincident line segments are dissolved by the union. Currently
 * linear output is not merged (this may be added in a future release.)
 *
 * <p>
 ...
 * {@link org.locationtech.jts.geom.TopologyException} is thrown. Otherwise, the
 * computation will produce output, but it will be invalid.
 *
 * <p>
