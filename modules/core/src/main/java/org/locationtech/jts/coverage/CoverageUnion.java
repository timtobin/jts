 ...
 *
 * <p>No checking is done to determine whether the input is a valid coverage. If the input is not a
 * valid coverage then in <i>some</i> cases this will be detected during processing and a {@link
 * org.locationtech.jts.geom.TopologyException} is thrown. Otherwise, the computation will produce
 * output, but it will be invalid.
 *
 * @author Martin Davis
