 ...
 *
 * <p>
 * No checking is done to determine whether the input is a valid coverage. If
 * the input is not a valid coverage then in <i>some</i> cases this will be
 * detected during processing and a
