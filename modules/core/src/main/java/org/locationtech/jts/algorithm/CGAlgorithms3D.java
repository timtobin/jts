...
/**
 * Basic computational geometry algorithms for geometry and coordinates defined
 * in 3-dimensional Cartesian space.
 *
 * @author mdavis
 */
public class CGAlgorithms3D {
	...
	public static double distanceSegmentSegment(Coordinate A, Coordinate B, Coordinate C, Coordinate D) {
		/*
		 * This calculation is susceptible to round off errors when passed large
		 * ordinate values. It may be possible to improve this by using {@link DD}
		 * arithmetic.
		 */
		if (A.equals3D(B))
		...
		if (denom <= 0.0) {
			/*
			 * The lines are parallel. In this case solve for the parameters s and t by
			 * assuming s is 0.
			 */
			s = 0;
