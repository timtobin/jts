...
/**
 * A {@link CoordinateFilter} that creates an array containing every coordinate in a {@link
 * Geometry}.
 *
 * @version 1.7
 */
public class CoordinateArrayFilter implements CoordinateFilter {
   ...
   *
   * @param size the number of points that the <code>CoordinateArrayFilter</code> will collect
   */
