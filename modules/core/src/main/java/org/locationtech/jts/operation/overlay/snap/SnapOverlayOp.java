 ...
 * improve the robustness of the result. This class <i>always</i> uses snapping.
 * This is less performant than the standard JTS overlay code, and may even
 * introduce errors which were not present in the original data. For this
...
public class SnapOverlayOp {
	...
	/*
	 * private void checkValid(Geometry g) { if (! g.isValid()) {
