...
public class CoordinateSequences {
	...
	/**
	 * Copies a section of a {@link CoordinateSequence} to another
	 * {@link CoordinateSequence}. The sequences may have different dimensions; in
	 * this case only the common dimensions are copied.
	 *
	 * @param src
	...
	/**
	 * Copies a coordinate of a {@link CoordinateSequence} to another
	 * {@link CoordinateSequence}. The sequences may have different dimensions; in
	 * this case only the common dimensions are copied.
	 *
	 * @param src
	...
	private static CoordinateSequence createClosedRing(CoordinateSequenceFactory fact, CoordinateSequence seq,
			int size) {
	...
	/**
	 * Ensures that a CoordinateSequence forms a valid ring, returning a new closed
	 * sequence of the correct length if required. If the input sequence is already
	 * a valid ring, it is returned without modification. If the input sequence is
	 * too short or is not closed, it is extended with one or more copies of the
	 * start point.
	 *
	 * @param fact
	 ...
	 * @return the original sequence, if it was a valid ring, or a new sequence
	 *         which is valid.
	 */
	...
	/**
	 * Tests whether two {@link CoordinateSequence}s are equal. To be equal, the
	 ...
	 * be equal. Two <code>NaN</code> ordinates values are considered to be equal.
	 *
	 * @param cs1
	 ...
	 * by checking the sequence length and closure (whether the first and last
	 * points are identical in 2D). Self-intersection is not checked.
	 *
	 * @param seq
	 *            the sequence to test
	 ...
	 * @param seq
	 *            the coordinate sequence to search
	 * @return the minimum coordinate in the sequence, found using
	 *         <code>compareTo</code>
	...
	/**
	 * Returns the index of the minimum coordinate of the whole coordinate sequence,
	 * using the usual lexicographic comparison.
	 *
	 * @param seq
	 *            the coordinate sequence to search
	 * @return the index of the minimum coordinate in the sequence, found using
	 *         <code>compareTo</code>
	 * @see Coordinate#compareTo(Object)
	 */
	...
	/**
	 * Returns the index of the minimum coordinate of a part of the coordinate
	 * sequence (defined by {@code from} and {@code to}, using the usual
	...
	/**
	 * Creates a string representation of a {@link CoordinateSequence}. The format
	 * is:
	 *
	 * <pre>
	 *   ( ord0,ord1.. ord0,ord1,...  ... )
