 ...
 *
 * <p>The format has the following characteristics:
 *
 * <ul>
 *   <li>It is consistent in all locales (in particular, the decimal separator is always a period)
 *   <li>Scientific notation is never output, even for very large numbers. This means that it is
 *       possible that output can contain a large number of digits.
...
public class OrdinateFormat {
   ...
   *
   * <p>The default is chosen to allow representing the smallest possible IEEE-754 double-precision
