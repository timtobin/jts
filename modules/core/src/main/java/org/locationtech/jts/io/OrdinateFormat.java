 ...
 *
 * <ul>
 * <li>It is consistent in all locales (in particular, the decimal separator is
 * always a period)
 * <li>Scientific notation is never output, even for very large numbers. This
 * means that it is possible that output can contain a large number of digits.
...
public class OrdinateFormat {
	...
	/**
	 * Creates a new formatter with the given maximum number of digits in the
	...
	/**
	 * Creates an OrdinateFormat using the default maximum number of fraction
	 * digits.
	 */
