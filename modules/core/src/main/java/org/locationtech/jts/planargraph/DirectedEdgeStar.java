...
/**
 * A sorted collection of {@link DirectedEdge}s which leave a {@link Node} in a
 * {@link PlanarGraph}.
 *
 * @version 1.7
 */
public class DirectedEdgeStar {
	 ...
	 * the remainder when i is divided by the number of edges)
	 *
	 * @param i
	...
	/**
	 * Returns an Iterator over the DirectedEdges, in ascending order by angle with
	 * the positive x-axis.
	 */
