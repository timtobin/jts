...
/**
 * A sorted collection of {@link DirectedEdge}s which leave a {@link Node} in a {@link PlanarGraph}.
 *
 * @version 1.7
 */
public class DirectedEdgeStar {
  ...
  /**
   * Returns an Iterator over the DirectedEdges, in ascending order by angle with the positive
   * x-axis.
   */
  ...
  /**
   * Returns the zero-based index of the given Edge, after sorting in ascending order by angle with
   * the positive x-axis.
   */
  ...
  /**
   * Returns the zero-based index of the given DirectedEdge, after sorting in ascending order by
  ...
  /**
   * Returns value of i modulo the number of edges in this DirectedEdgeStar (i.e. the remainder when
   * i is divided by the number of edges)
   *
  ...
  /**
   * Returns the {@link DirectedEdge} on the left-hand (CCW) side of the given {@link DirectedEdge}
  ...
  /**
   * Returns the {@link DirectedEdge} on the right-hand (CW) side of the given {@link DirectedEdge}
   * (which must be a member of this DirectedEdgeStar).
   */
