...
/**
 * A simple elevation model used to populate missing Z values in overlay
 * results.
 *
 * <p>
 ...
 *
 * <p>
 * An elevation model can be used to populate missing Z values in an overlay
 * result geometry.
 *
 * @author Martin Davis
 */
class ElevationModel {
	...
	/**
	 * Creates a new elevation model covering an extent by a grid of given
	 * dimensions.
	 *
	 * @param extent
	 *            the XY extent to cover
	 * @param numCellX
	 *            the number of grid cells in the X dimension
	 * @param numCellY
	 ...
	 *
	 * @param geom
	 *            the geometry to scan for Z values
	 */
	...
	/**
	 * Gets the model Z value at a given location. If the location lies outside the
	 * model grid extent, this returns the Z value of the nearest grid cell. If the
	 * model has no elevation computed (i.e. due to empty input), the value is
	 * returned as {@link Double#NaN}.
	 *
	 * @param x
	 *            the x ordinate of the location
	 * @param y
	 *            the y ordinate of the location
	...
	/**
	 * Computes Z values for any missing Z values in a geometry, using the computed
	 * model. If the model has no Z value, or the geometry coordinate dimension does
	 * not include Z, the geometry is not updated.
	 *
	 * @param geom
	 *            the geometry to populate Z values for
	 */
