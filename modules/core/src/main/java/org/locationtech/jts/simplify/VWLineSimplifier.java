...
/**
 * Simplifies a linestring (sequence of points) using the Visvalingam-Whyatt
 * algorithm. The Visvalingam-Whyatt algorithm simplifies geometry by removing
 * vertices while trying to minimize the area changed.
 *
 * @version 1.7
 */
class VWLineSimplifier {
	...
	private double simplifyVertex(VWLineSimplifier.VWVertex vwLine) {
		...
		// TODO: use an appropriate data structure to optimize finding the smallest area
		// vertex
