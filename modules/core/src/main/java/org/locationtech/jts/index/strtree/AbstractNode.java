 ...
 * </ul>
 *
 * A node stores the bounds of its children, and its level within the index
 * tree.
 *
 * @version 1.7
 */
public abstract class AbstractNode implements Boundable, Serializable {
	 ...
	 * not much bigger than this Boundable's boundary yet fast to test for
	 * intersection with the bounds of other Boundables. The class of object
	...
	/**
	 * Returns either child {@link AbstractNode}s, or if this is a leaf node, real
	 * data (wrapped in {@link ItemBoundable}s).
	 *
