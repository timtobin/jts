...
public class TopologyValidationError {
	...
	/**
	 * Indicates that the interior of a polygon is disjoint (often caused by set of
	 * contiguous holes splitting the polygon into two parts)
	 */
	...
	/**
	 * Indicates that the <code>X</code> or <code>Y</code> ordinate of a Coordinate
	 * is not a valid numeric value (e.g. {@link Double#NaN} )
	 */
	...
	/**
	 * Indicates that a ring is not correctly closed (the first and the last
	...
	public static final String[] errMsg = {"Topology Validation Error", "Repeated Point", "Hole lies outside shell",
			"Holes are nested", "Interior is disconnected", "Self-intersection", "Ring Self-intersection",
			"Nested shells", "Duplicate Rings", "Too few distinct points in geometry component", "Invalid Coordinate",
			"Ring is not closed"};
	...
	/**
	 * Gets an error message describing this error. The error message does not
