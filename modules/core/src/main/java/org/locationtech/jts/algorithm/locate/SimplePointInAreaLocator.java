 ...
 * {@link Geometry}, using a simple <tt>O(n)</tt> algorithm.
 *
 * <p>
 ...
 * {@link SimplePointInAreaLocator}. However, they provide no performance
 * advantage over the class methods.
 *
 * <p>
 * This algorithm is suitable for use in cases where only a few points will be
 * tested. If many points will be tested, {@link IndexedPointInAreaLocator} may
...
public class SimplePointInAreaLocator implements PointOnGeometryLocator {
	...
	/**
	 * Determines whether a point lies in a {@link Polygon}. If the point lies on
	 * the polygon boundary it is considered to be inside.
	 *
	 * @param p
	 *            the point to test
	 * @param poly
	...
	/**
	 * Determines whether a point is contained in a {@link Geometry}, or lies on its
	 * boundary. This is a convenience method for
	 *
	 * <pre>
	...
	/**
	 * Determines the {@link Location} of a point in an areal {@link Geometry}. The
	...
	/**
	 * Determines the {@link Location} of a point in a {@link Polygon}. The return
	 * value is one of:
	 *
	 * <ul>
	 * <li>{@link Location#INTERIOR} if the point is in the geometry interior
	 ...
	 * </ul>
	 *
	 * This method is provided for backwards compatibility only. Use
	 * {@link #locate(Coordinate, Geometry)} instead.
	 *
	 * @param p
	 *            the point to test
	 * @param poly
	...
	/**
	 * Create an instance of a point-in-area locator, using the provided areal
	 * geometry.
	 *
	 * @param geom
