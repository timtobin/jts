...
/**
 * Computes an interior point of a <code>{@link Geometry}</code>. An interior
 ...
 * of the geometry. For collections the interior point is computed for the
 * collection of non-empty elements of highest dimension. The interior point of
 * an empty geometry is <code>null</code>.
 *
 * <h2>Algorithm</h2>
 *
 * The point is chosen to be "close to the center" of the geometry. The location
 * depends on the dimension of the input:
 *
 * <ul>
 * <li><b>Dimension 2</b> - the interior point is constructed in the middle of
 * the longest interior segment of a line bisecting the area.
 * <li><b>Dimension 1</b> - the interior point is the interior or boundary
...
public class InteriorPoint {
	...
	/**
	 * Computes a location of an interior point in a {@link Geometry}. Handles all
	 * geometry types.
	 *
	 * @param geom
	 *            a geometry in which to find an interior point
	 * @return the location of an interior point, or <code>null</code> if the input
	 *         is empty
	 */
