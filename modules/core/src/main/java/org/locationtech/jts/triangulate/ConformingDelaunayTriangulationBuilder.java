 ...
 * collections of points and linear constraints, and extract the resulting
...
public class ConformingDelaunayTriangulationBuilder {
	...
	/**
	 * Sets the linear constraints to be conformed to. All linear components in the
	 * input will be used as constraints. The constraint vertices do not have to be
	 * disjoint from the site vertices. The constraints must not contain duplicate
	 * segments (up to orientation).
	 *
	 ...
	 * of the given geometry will be used as sites. The site vertices do not have to
	 * contain the constraint vertices as well; any site vertices which are
