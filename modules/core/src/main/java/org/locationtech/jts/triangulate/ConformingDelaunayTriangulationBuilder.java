...
/**
 * A utility class which creates Conforming Delaunay Triangulations from collections of points and
 * linear constraints, and extract the resulting triangulation edges or triangles as geometries.
 *
 * @author Martin Davis
 */
public class ConformingDelaunayTriangulationBuilder {
  ...
  /**
   * Sets the sites (point or vertices) which will be triangulated. All vertices of the given
   * geometry will be used as sites. The site vertices do not have to contain the constraint
   * vertices as well; any site vertices which are identical to a constraint vertex will be removed
  ...
  /**
   * Sets the linear constraints to be conformed to. All linear components in the input will be used
   * as constraints. The constraint vertices do not have to be disjoint from the site vertices. The
   * constraints must not contain duplicate segments (up to orientation).
   *
