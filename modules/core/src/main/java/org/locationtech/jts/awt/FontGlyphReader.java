...
/**
 * Provides methods to read {@link Font} glyphs for strings into
 * {@link Polygonal} geometry.
 *
 * <p>
 * It is suggested to use larger point sizes to render fonts glyphs, to reduce
 * the effects of scale-dependent hints. The result geometry is in the base
 * coordinate system of the font. The geometry can be further transformed as
 * necessary using {@link AffineTransformation}s.
 *
 * @author Martin Davis
 */
public class FontGlyphReader {
	...
	/**
	 * Converts text rendered in the given {@link Font} to a {@link Geometry} using
	 * a standard flatness factor.
	 *
	 * @param text
	 *            the text to render
	 * @param font
	 ...
	 * @param geomFact
	 *            the geometryFactory to use to create the result
