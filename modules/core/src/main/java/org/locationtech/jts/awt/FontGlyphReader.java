...
/**
 * Provides methods to read {@link Font} glyphs for strings into {@link Polygonal} geometry.
 *
 * <p>It is suggested to use larger point sizes to render fonts glyphs, to reduce the effects of
 * scale-dependent hints. The result geometry is in the base coordinate system of the font. The
 * geometry can be further transformed as necessary using {@link AffineTransformation}s.
 *
 * @author Martin Davis
 */
public class FontGlyphReader {
   ...
   *
   * <p>DEPRECATED - use FONT_SANSSERIF
   */
  ...
  /**
   * Converts text rendered in the given font and pointsize to a {@link Geometry} using a standard
   * flatness factor.
   *
  ...
  public static Geometry read(
      String text, String fontName, int pointSize, GeometryFactory geomFact) {
