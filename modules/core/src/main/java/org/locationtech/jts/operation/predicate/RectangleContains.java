 ...
 *
 * <p>As a further optimization, this class can be used to test many geometries against a single
...
public class RectangleContains {
  ...
  private boolean isPointContainedInBoundary(Coordinate pt) {
     ...
     *
     * <p>This code assumes that the point lies in the rectangle envelope
     */
  ...
  private boolean isLineSegmentContainedInBoundary(Coordinate p0, Coordinate p1) {
     ...
     *
     * <p>In either case, the segment is not wholely in the boundary
     */
    return false;
  }
}
