...
class EnvelopeIntersectsVisitor extends ShortCircuitedGeometryVisitor {
	...
	/**
	 * Reports whether it can be concluded that an intersection occurs, or whether
	 * further testing is required.
	 *
	 * @return true if an intersection must occur or false if no conclusion about
	 *         intersection can be made
	 */
	...
	protected void visit(Geometry element) {
		...
		/**
		 * Since the envelopes intersect and the test element is connected, if the test
		 * envelope is completely bisected by an edge of the rectangle the element and
		 * the rectangle must touch (This is basically an application of the Jordan
		 * Curve Theorem). The alternative situation is that the test envelope is "on a
		 * corner" of the rectangle envelope, i.e. is not completely bisected. In this
		 * case it is not possible to make a conclusion about the presence of an
		 * intersection.
		 */
...
/**
 * A visitor which tests whether it can be concluded that a geometry contains a
 * vertex of a query geometry.
 *
 * @author Martin Davis
 * @version 1.7
 */
class GeometryContainsPointVisitor extends ShortCircuitedGeometryVisitor {
	 ...
	 *
	 * @return true if a corner point is contained or false if no conclusion about
	 *         intersection can be made
	 */
...
/**
 * Implementation of the <tt>intersects</tt> spatial predicate optimized for the
 * case where one {@link Geometry} is a rectangle. This class works for all
 * input geometries, including {@link GeometryCollection}s.
 *
 * <p>
 * As a further optimization, this class can be used in batch style to test many
 * geometries against a single rectangle.
 *
 * @version 1.7
 */
public class RectangleIntersects {
	...
	public boolean intersects(Geometry geom) {
		...
		/**
		 * Test if rectangle envelope intersects any component envelope. This handles
		 * Point components as well
		 */
...
/**
 * A visitor to test for intersection between the query rectangle and the line
...
class RectangleIntersectsSegmentVisitor extends ShortCircuitedGeometryVisitor {
	 ...
	 *
	 * @return true if a segment intersection exists or false if no segment
	 *         intersection exists
	 */
	public boolean intersects() {
