 ...
 *
 * <p>A linestring must have either 0 or 2 or more points. If these conditions are not met, the
 * constructors throw an {@link IllegalArgumentException}
 *
 * @version 1.7
 */
public class LineString extends Geometry implements Lineal {
  @Serial private static final long serialVersionUID = 3110669828065365560L;

  /**
   * The minimum number of vertices allowed in a valid non-empty linestring. Empty linestrings with
   * 0 vertices are also valid.
   */
   ...
   *
   * @param points the points of the linestring, or <code>null</code> to create the empty geometry.
   *     This array must not contain <code>null</code> elements. Consecutive points may be equal.
   * @param precisionModel the specification of the grid of allowable points for this <code>
   *     LineString</code>
   * @param SRID the ID of the Spatial Reference System used by this <code>LineString</code>
   ...
   * @return <code>true</code> if <code>pt</code> is one of this <code>LineString</code> 's vertices
   */
