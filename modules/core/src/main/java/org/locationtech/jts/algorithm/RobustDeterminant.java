...
public class RobustDeterminant {
	 ...
	 * originalSignOfDet2x2(x1, y1, x2, y2); int d2 = -originalSignOfDet2x2(y1, x1,
	 * x2, y2); assert d1 == -d2; return d1; }
	 */

	/*
	 * Test code to force a standard ordering of input ordinates. A possible fix for
	 * a rare problem where evaluation is order-dependent.
	 */
	/*
	 ...
	 * signOfDet2x2ordX(x1, y1, x2, y2); }
	 *
	 * private static int signOfDet2x2ordX(double x1, double y1, double x2, double
	 * y2) { if (y1 > y2) { return -originalSignOfDet2x2(y1, x1, y2, x2); } return
	 * originalSignOfDet2x2(x1, y1, x2, y2); } //
	 */

	/**
	 * Returns the index of the direction of the point <code>q</code> relative to a
	 ...
	 */
	// private static int originalSignOfDet2x2(double x1, double y1, double x2,
	// double y2) {
	public static int signOfDet2x2(double x1, double y1, double x2, double y2) {
