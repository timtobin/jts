...
/**
 * Determines the maximum number of common most-significant bits in the mantissa
 * of one or numbers. Can be used to compute the double-precision number which
 * is represented by the common bits. If there are no common bits, the number
 * computed is 0.0.
 *
 * @version 1.7
 */
public class CommonBits {
	...
	/**
	 * This computes the number of common most-significant bits in the mantissas of
	 * two double-precision numbers. It does not count the hidden bit, which is
	 * always 1. It does not determine whether the numbers have the same exponent -
	...
	/**
	 * Computes the bit pattern for the sign and exponent of a double-precision
	 * number.
	 *
	 * @param num
