...
/**
 * Detects and records an intersection between two {@link SegmentString}s, if
 * one exists. Only a single intersection is recorded. This strategy can be
 * configured to search for <b>proper intersections</b>. In this case, the
 * presence of <i>any</i> kind of intersection will still be recorded, but
 * searching will continue until either a proper intersection has been found or
 * no intersections are detected.
 *
 * @version 1.7
 */
public class SegmentIntersectionDetector implements SegmentIntersector {
	...
	/**
	 * Tests whether processing can terminate, because all required information has
	 * been obtained (e.g. an intersection of the desired type has been detected).
	 *
	 ...
	 *
	 * @param findProper
	 *            true if processing should continue until a proper intersection is
	 *            found
	 */
