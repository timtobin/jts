...
public interface SpatialIndex {
  ...
  /**
   * Queries the index for all items whose extents intersect the given search {@link Envelope} Note
   * that some kinds of indexes may also return objects which do not in fact intersect the query
   * envelope.
   *
  ...
  /**
   * Queries the index for all items whose extents intersect the given search {@link Envelope}, and
   * applies an {@link ItemVisitor} to them. Note that some kinds of indexes may also return objects
