...
public interface SpatialIndex {
	/**
	 * Adds a spatial item with an extent specified by the given {@link Envelope} to
	 * the index
	 */
	...
	/**
	 * Queries the index for all items whose extents intersect the given search
	 * {@link Envelope}, and applies an {@link ItemVisitor} to them. Note that some
	 * kinds of indexes may also return objects which do not in fact intersect the
	 * query envelope.
	 *
	 * @param searchEnv
	 *            the envelope to query for
