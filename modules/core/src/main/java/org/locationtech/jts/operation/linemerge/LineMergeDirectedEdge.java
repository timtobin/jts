...
public class LineMergeDirectedEdge extends DirectedEdge {
	/**
	 * Constructs a LineMergeDirectedEdge connecting the <code>from</code> node to
	 * the <code>to</code> node.
	 *
	 * @param directionPt
	...
	/**
	 * Returns the directed edge that starts at this directed edge's end point, or
	 * null if there are zero or multiple directed edges starting there.
	 *
