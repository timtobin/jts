...
/**
 * Checks if simplifying (flattening) line sections or segments would cause them
 * to "jump" over other components in the geometry.
 *
 * @author mdavis
 */
class ComponentJumpChecker {
	...
	/**
	 * Checks if two consecutive segments jumps a component if flattened. The
	 * segments are assumed to be consecutive. (so the seg1.p1 = seg2.p0). The
	 * flattening segment must be the segment between seg1.p0 and seg2.p1.
	 *
	 * @param line
