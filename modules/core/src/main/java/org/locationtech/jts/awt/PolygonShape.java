...
/**
 * A {@link Shape} which represents a polygon which may contain holes. Provided
 * because the standard AWT Polygon class does not support holes.
 *
 * @author Martin Davis
 */
public class PolygonShape implements Shape {
	// use a GeneralPath with a winding rule, since it supports floating point
	// coordinates
	 ...
	 *
	 * @param shellVertices
	 *            the vertices of the shell
	 * @param holeVerticesCollection
	...
	/**
	 * Creates a GeneralPath representing a polygon ring having the given coordinate
	 * sequence. Uses the GeneralPath.WIND_EVEN_ODD winding rule.
	 *
	 * @param coordinates
