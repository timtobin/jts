...
/**
 * Represents a planar triangle, and provides methods for calculating various properties of
 * triangles.
 *
 * @version 1.7
 */
public class Triangle {
  ...
  /**
   * Tests whether a triangle is acute. A triangle is acute if all interior angles are acute. This
   * is a strict test - right triangles will return <tt>false</tt>. A triangle which is not acute is
   * either right or obtuse.
   *
   * <p>Note: this implementation is not robust for angles very close to 90 degrees.
   *
  ...
  public static boolean intersects(Coordinate a, Coordinate b, Coordinate c, Coordinate p) {
    int exteriorIndex = isCCW(a, b, c) ? Orientation.CLOCKWISE : Orientation.COUNTERCLOCKWISE;
   ...
   *
   * <p>Formula is as per https://math.stackexchange.com/a/3610959
   *
   * @param a a vertex of the triangle
   * @param b a vertex of the triangle
   * @param c a vertex of the triangle
  ...
  public static double circumradius(Coordinate a, Coordinate b, Coordinate c) {
    ...
    if (area == 0.0) return Double.POSITIVE_INFINITY;
    return (lenAB * lenBC * lenCA) / (4 * area);
  }

  /**
   * Computes the circumcentre of a triangle. The circumcentre is the centre of the circumcircle,
   * the smallest circle which encloses the triangle. It is also the common intersection point of
   * the perpendicular bisectors of the sides of the triangle, and is the only point which has equal
   ...
   * distance to all three vertices of the triangle.
   *
   * <p>The circumcentre does not necessarily lie within the triangle. For example, the circumcentre
   * of an obtuse isosceles triangle lies outside the triangle.
   *
   * <p>This method uses an algorithm due to J.R.Shewchuk which uses normalization to the origin to
   * improve the accuracy of computation. (See <i>Lecture Notes on Geometric Robustness</i>,
   ...
   * of an obtuse isosceles triangle lies outside the triangle.
   *
   * <p>This method uses {@link DD} extended-precision arithmetic to provide more accurate results
   * than {@link #circumcentre(Coordinate, Coordinate, Coordinate)}
   *
   * @param a a vertex of the triangle
   * @param b a vertex of the triangle
   * @param c a vertex of the triangle
  ...
  /**
   * Computes the determinant of a 2x2 matrix. Uses standard double-precision arithmetic, so is
  ...
  /**
   * Computes the incentre of a triangle. The <i>inCentre</i> of a triangle is the point which is
   * equidistant from the sides of the triangle. It is also the point at which the bisectors of the
   * triangle's angles meet. It is the centre of the triangle's <i>incircle</i>, which is the unique
   * circle that is tangent to each of the triangle's three sides (and hence the Maximum Inscribed
   * Circle).
   *
   * <p>The incentre always lies within the triangle.
   *
   * @param a a vertex of the triangle
   * @param b a vertex of the triangle
   * @param c a vertex of the triangle
  ...
  /**
   * Computes the centroid (centre of mass) of a triangle. This is also the point at which the
   * triangle's three medians intersect (a triangle median is the segment from a vertex of the
   * triangle to the midpoint of the opposite side). The centroid divides each median in a ratio of
   * 2:1.
   *
   * <p>The centroid always lies within the triangle.
   *
   * @param a a vertex of the triangle
   * @param b a vertex of the triangle
   * @param c a vertex of the triangle
  ...
  public static Coordinate angleBisector(Coordinate a, Coordinate b, Coordinate c) {
    /**
     * Uses the fact that the lengths of the parts of the split segment are proportional to the
     * lengths of the adjacent triangle sides
     */
  ...
  /**
   * Computes the signed 2D area of a triangle. The area value is positive if the triangle is
   * oriented CW, and negative if it is oriented CCW.
   *
   * <p>The signed area value can be used to determine point orientation, but the implementation in
   * this method is susceptible to round-off errors. Use {@link Orientation#index(Coordinate,
   * Coordinate, Coordinate)} for robust orientation calculation.
   *
   * @param a a vertex of the triangle
   * @param b a vertex of the triangle
   * @param c a vertex of the triangle
  ...
  public static double signedArea(Coordinate a, Coordinate b, Coordinate c) {
     ...
     * vector cross-product For 2D vectors, this formula simplifies to the expression below
     */
  ...
  /**
   * Computes the Z-value (elevation) of an XY point on a three-dimensional plane defined by a
   * triangle whose vertices have Z-values. The defining triangle must not be degenerate (in other
   * words, the triangle must enclose a non-zero area), and must not be parallel to the Z-axis.
   *
   * <p>This method can be used to interpolate the Z-value of a point inside a triangle (for
   * example, of a TIN facet with elevations on the vertices).
   *
  ...
  /**
   * Computes the incentre of this triangle. The <i>incentre</i> of a triangle is the point which is
   * equidistant from the sides of the triangle. It is also the point at which the bisectors of the
   * triangle's angles meet. It is the centre of the triangle's <i>incircle</i>, which is the unique
   * circle that is tangent to each of the triangle's three sides.
   *
  ...
  /**
   * Tests whether this triangle is acute. A triangle is acute if all interior angles are acute.
   * This is a strict test - right triangles will return <tt>false</tt>. A triangle which is not
   * acute is either right or obtuse.
   *
   * <p>Note: this implementation is not robust for angles very close to 90 degrees.
   *
  ...
  /**
   * Computes the circumcentre of this triangle. The circumcentre is the centre of the circumcircle,
   * the smallest circle which passes through all the triangle vertices. It is also the common
   * intersection point of the perpendicular bisectors of the sides of the triangle, and is the only
   * point which has equal distance to all three vertices of the triangle.
   *
   * <p>The circumcentre does not necessarily lie within the triangle.
   *
   * <p>This method uses an algorithm due to J.R.Shewchuk which uses normalization to the origin to
   * improve the accuracy of computation. (See <i>Lecture Notes on Geometric Robustness</i>,
   * Jonathan Richard Shewchuk, 1999).
  ...
  /**
   * Computes the centroid (centre of mass) of this triangle. This is also the point at which the
   * triangle's three medians intersect (a triangle median is the segment from a vertex of the
   * triangle to the midpoint of the opposite side). The centroid divides each median in a ratio of
   * 2:1.
   *
  ...
  /**
   * Computes the signed 2D area of this triangle. The area value is positive if the triangle is
   * oriented CW, and negative if it is oriented CCW.
   *
   * <p>The signed area value can be used to determine point orientation, but the implementation in
   * this method is susceptible to round-off errors. Use {@link Orientation#index(Coordinate,
  ...
  /**
   * Computes the Z-value (elevation) of an XY point on a three-dimensional plane defined by this
   * triangle (whose vertices must have Z-values). This triangle must not be degenerate (in other
   * words, the triangle must enclose a non-zero area), and must not be parallel to the Z-axis.
   *
   * <p>This method can be used to interpolate the Z-value of a point inside this triangle (for
   * example, of a TIN facet with elevations on the vertices).
   *
   * @param p the point to compute the Z-value of
   * @return the computed Z-value (elevation) of the point
