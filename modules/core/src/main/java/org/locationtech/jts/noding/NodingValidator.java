...
/**
 * Validates that a collection of {@link SegmentString}s is correctly noded. Throws an appropriate
 * exception if an noding error is found.
 *
 * @version 1.7
 */
public class NodingValidator {
  ...
  /**
   * Checks for intersections between an endpoint of a segment string and an interior vertex of
   * another segment string
   */
