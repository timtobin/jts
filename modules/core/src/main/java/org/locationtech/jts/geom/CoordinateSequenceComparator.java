...
/**
 * Compares two {@link CoordinateSequence}s. For sequences of the same
 * dimension, the ordering is lexicographic. Otherwise, lower dimensions are
 * sorted before higher. The dimensions compared can be limited; if this is done
...
public class CoordinateSequenceComparator implements Comparator {
	...
	/**
	 * Compares the same coordinate of two {@link CoordinateSequence}s along the
	 ...
	 * @param dimension
	 *            the number of dimensions to test
	 * @return -1, 0, or 1 depending on whether s1[i] is less than, equal to, or
	 *         greater than s2[i]
	 */
