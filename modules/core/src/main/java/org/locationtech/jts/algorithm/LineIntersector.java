...
/**
 * A <code>LineIntersector</code> is an algorithm that can both test whether two
 * line segments intersect and compute the intersection point(s) if they do.
 *
 * <p>
 ...
 * <li>{@link #COLLINEAR_INTERSECTION} - the segments are collinear and they
 ...
 * interior of both segments, this is termed a <i>proper intersection</i>. The
 * method {@link #isProper()} test for this situation.
 *
 * <p>
...
public abstract class LineIntersector {
	 ...
	 * @param intIndex
	 *            is 0 or 1
	 * @return the intIndex'th intersection point in the direction of the specified
	 *         input line segment
	 */
	 ...
	 * input segments.
	 *
	 * @return <code>true</code> if either intersection point is in the interior of
	...
	public String toString() {
		return WKTWriter.toLineString(inputLines[0][0], inputLines[0][1]) + " - "
				+ WKTWriter.toLineString(inputLines[1][0], inputLines[1][1]) + getTopologySummary();
	}
}
