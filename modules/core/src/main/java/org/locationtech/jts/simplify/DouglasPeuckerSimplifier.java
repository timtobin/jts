...
/**
 * Simplifies a {@link Geometry} using the Douglas-Peucker algorithm. Ensures
 ...
 *
 * <p>
 * Note that in general D-P does not preserve topology - e.g. polygons can be
 * split, collapse to lines or disappear holes can be created or disappear, and
 * lines can cross. To simplify geometry while preserving topology use
 * {@link TopologyPreservingSimplifier}. (However, using D-P is significantly
 * faster).
 *
 * <h2>KNOWN BUGS</h2>
 *
 * <ul>
 * <li>In some cases the approach used to clean invalid simplified polygons can
 * distort the output geometry severely.
 * </ul>
 *
 * @version 1.7
...
public class DouglasPeuckerSimplifier {
	...
	static class DPTransformer extends GeometryTransformer {
		 ...
		 * actual area. If the input is empty or is not polygonal, this ensures that
