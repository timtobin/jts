...
public class DoubleBits {
	...
	/**
	 * This computes the number of common most-significant bits in the mantissa. It
	 * does not count the hidden bit, which is always 1. It does not determine
	 * whether the numbers have the same exponent - if they do not, the value
	 * computed by this function is meaningless.
	 *
	 * @param db
	...
	public String toString() {
		...
		String str = bitStr.substring(0, 1) + "  " + bitStr.substring(1, 12) + "(" + getExponent() + ") "
