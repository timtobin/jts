...
/**
 * Contains the <CODE>Geometry</CODE> interface hierarchy and supporting
 * classes.
 *
 * <p>
 ...
 *
 * <p>
 * JTS attempts to implement the OpenGIS Simple Features Specification (SFS) as
 * accurately as possible. In some cases the SFS is unclear or omits a
