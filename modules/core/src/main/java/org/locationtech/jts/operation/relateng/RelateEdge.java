...
class RelateEdge {
	...
	/*
	 * private int aDim = DIM_UNKNOWN; private int aLocLeft = Location.EXTERIOR;
	 * private int aLocRight = Location.EXTERIOR; private int aLocLine =
	 * Location.EXTERIOR;
	 *
	 * private int bDim = DIM_UNKNOWN; private int bLocLeft = Location.EXTERIOR;
	 * private int bLocRight = Location.EXTERIOR; private int bLocLine =
	 * Location.EXTERIOR;
	 */
