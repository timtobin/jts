...
public class OrientedCoordinateArray implements Comparable {
	private static int compareOriented(Coordinate[] pts1, boolean orientation1, Coordinate[] pts2,
	 ...
	 * @param pts
	 *            the array to test
	 * @return <code>true</code> if the points are oriented forwards or
	 ...
	 *
	 * @return -1 this one is smaller; 0 the two objects are equal; 1 this one is
	 *         greater
	 */
	public int compareTo(Object o1) {
		 ...
		 *
		 * boolean orient1 = orientation(pts); boolean orient2 = orientation(oca.pts);
