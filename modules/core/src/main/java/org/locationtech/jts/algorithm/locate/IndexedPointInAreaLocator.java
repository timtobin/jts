...
/**
 * Determines the {@link Location} of {@link Coordinate}s relative to an areal
 * geometry, using indexing for efficiency. This algorithm is suitable for use
 * in cases where many points will be tested against a given area.
 *
 * <p>
 * The Location is computed precisely, in that points located on the geometry
 * boundary or segments will return {@link Location#BOUNDARY}.
 *
 * <p>
...
public class IndexedPointInAreaLocator implements PointOnGeometryLocator {
	...
	/**
	 * Creates a new locator for a given {@link Geometry}. Geometries containing
	 * {@link Polygon}s and {@link LinearRing} geometries are supported.
	 *
	 * @param g
