...
public class CoordinateList extends ArrayList<Coordinate> {
  @Serial private static final long serialVersionUID = -1626110935756089896L;
  ...
  /**
   * Constructs a new list from an array of Coordinates, allowing caller to specify if repeated
