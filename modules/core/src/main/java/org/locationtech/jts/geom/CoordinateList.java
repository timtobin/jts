 ...
 * coordinates from occurring in the list.
 *
 * @version 1.7
 */
public class CoordinateList extends ArrayList<Coordinate> {
	 ...
	 * (I.e. this constructor produces a {@link CoordinateList} with exactly the
	 * same set of points as the input array.)
	 *
	 * @param coord
	...
	/**
	 * Returns the Coordinates in this list as an array. Coordinates are not copied
	 *
	...
	/**
	 * Creates an array containing the coordinates in this list, oriented in the
	 * given direction (forward or reverse).
	 *
	 * @param isForward
	 *            true if the direction is forward, false for reverse
