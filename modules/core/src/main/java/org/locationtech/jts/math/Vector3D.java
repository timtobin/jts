...
public class Vector3D {
	...
	/**
	 * Creates a vector from a 3D {@link Coordinate}. The coordinate should have the
	...
	/**
	 * Creates a new vector with the direction and magnitude of the difference
	 * between the <tt>to</tt> and <tt>from</tt> {@link Coordinate}s.
	 *
	 * @param from
	...
	/**
	 * Creates a new vector which has the same direction and with length equals to
	 * the length of this vector divided by the scalar value <code>d</code>.
	 *
	 * @param d
	 *            the scalar divisor
	 ...
	 *
	 * @param o
	 *            a <tt>Vector3D</tt> with which to do the comparison.
	...
	/**
	 * Computes a vector which is the difference of this vector and the given
	 * vector.
	 *
	 * @param v
