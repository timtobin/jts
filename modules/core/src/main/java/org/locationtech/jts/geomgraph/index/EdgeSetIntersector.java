...
/**
 * An EdgeSetIntersector computes all the intersections between the edges in the set. It adds the
 * computed intersections to each edge they are found on. It may be used in two scenarios:
 *
 * <ul>
...
public abstract class EdgeSetIntersector {
  ...
  /**
   * Computes all self-intersections between edges in a set of edges, allowing client to choose
   * whether self-intersections are computed.
   *
   ...
   */
  public abstract void computeIntersections(
      List edges, SegmentIntersector si, boolean testAllSegments);
   ...
   */
  public abstract void computeIntersections(List edges0, List edges1, SegmentIntersector si);
}
