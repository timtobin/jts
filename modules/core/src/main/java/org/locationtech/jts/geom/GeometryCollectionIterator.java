...
/**
 * Iterates over all {@link Geometry}s in a {@link Geometry}, (which may be
 * either a collection or an atomic geometry). The iteration sequence follows a
 * pre-order, depth-first traversal of the structure of the
 * <code>GeometryCollection</code> (which may be nested). The original <code>
 * Geometry</code> object is returned as well (as the first object), as are all
...
public class GeometryCollectionIterator implements Iterator {
	 ...
	 * <code>GeometryCollection</code>) has been returned.
	 */
	private boolean atStart;

	/**
	 * The index of the <code>Geometry</code> that will be returned when
	 * <code>next</code> is called.
	 */
	private int index;

	/**
	 * The number of <code>Geometry</code>s in the the
	...
	/**
	 * The iterator over a nested <code>Geometry</code>, or <code>null</code> if
	 * this <code>
	 * GeometryCollectionIterator</code> is not currently iterating over a nested
	 * <code>
	 ...
	 *
	 * @param parent
	 *            the geometry over which to iterate; also, the first element
