...
/**
 * Union of high-precision polygons - result misses one input area. Original issue was a unary union
 * of 6 polygons. Problem is also manifested in a simpler form by two specific polygons.
 *
 * <p>See https://github.com/locationtech/jts/issues/784
 */
public class Issue784 {

  private final GeometryFactory gf = new GeometryFactory();

  private final Function<double[][], Polygon> createPolygon =
      points ->
          gf.createPolygon(
  ...
  public void xtestUnionOriginal() throws ParseException {
    ...
    Polygon[] polygons = {p1, p2, p3, p4, p5, p6};
    ...
    Geometry indUnion =
        Arrays.stream(polygons).map(Geometry.class::cast).reduce(Geometry::union).orElseThrow(null);
