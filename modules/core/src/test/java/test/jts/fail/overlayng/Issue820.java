 ...
 *
 * <p>See https://github.com/locationtech/jts/issues/820
 */
public class Issue820 {

  public void testIntersection() {
    Geometry smallerArea =
        new GeometryFactory()
            .createPolygon(
                new Coordinate[] {
    ...
    Geometry intersection =
        OverlayNGRobust.overlay(smallerArea, biggerArea, OverlayNG.INTERSECTION);

    // Expected: POLYGON ((0.0000000022101801 1.4126466987753772, 1.2696784445936622
    // 1.41264669888319, 1.2696784494332027 0.0000000001078129, 0.0000000070497208 0,
