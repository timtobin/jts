...
public class PolygonUnionPerfTest {
  ...
  /**
   * Creates a grid of circles with a small percentage of overlap in both directions. This
   * approximated likely real-world cases well, and seems to produce close to worst-case performance
   * for the Iterated algorithm.
   *
   * <p>Sample times: 1000 items/100 pts - Cascaded: 2718 ms, Iterated 150 s
   *
   * @param nItems
   * @param size
   * @param nPts
