...
/**
 * Test repeated buffering of a given input shape. Intended to test the robustness of buffering.
 * Repeated buffering tends to generate challenging somewhat pathological linework, which stresses
