...
public class RectangleIntersectsPerfTest {
	...
	/**
	 * Creates a set of rectangular Polygons which cover the given envelope. The
	 * rectangles At least nRect rectangles are created.
	 *
	 * @param env
	 * @param nRect
	 * @param rectSize
	...
	void test(int nPts) {
		...
		/**
		 * Make the geometry "crinkly" by rounding off the points. This defeats the
