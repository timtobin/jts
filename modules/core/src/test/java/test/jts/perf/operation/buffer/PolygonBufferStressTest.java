...
/**
 * Stress-tests buffering by repeatedly buffering a geometry using alternate
 * positive and negative distances.
 *
 * <p>
 * In older versions of JTS this used to quickly cause failure due to robustness
 * issues (bad noding causing topology failures). However by ver 1.13 (at least)
 * this test should pass perfectly. This is due to the many heuristics
 * introduced to improve buffer robustness.
 *
 * @author Martin Davis
 */
public class PolygonBufferStressTest {
	...
	private Geometry getSampleGeometry() {
		...
		// wkt ="POLYGON ((260 400, 220 300, 80 300, 180 220, 40 200, 180 160, 60 20,
		// 200 80, 280 20,
		// 260 140, 440 20, 340 180, 520 160, 280 220, 460 340, 300 300, 260 400))";

		// star polygon with NO hole, 10x size
		// wkt ="POLYGON ((2600 4000, 2200 3000, 800 3000, 1800 2200, 400 2000, 1800
		// 1600, 600 200, 2000
		// 800, 2800 200, 2600 1400, 4400 200, 3400 1800, 5200 1600, 2800 2200, 4600
		// 3400, 3000 3000,
		// 2600 4000))";
	...
	public void test() {
		...
		// Geometry handle = GeometricShapeFactory.createRectangle(fact, 0, 0, 400, 20,
		// 1);
