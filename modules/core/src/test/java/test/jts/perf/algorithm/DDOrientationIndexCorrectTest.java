 ...
 *
 * <p>This is primarily to capture the case for future research.
 *
 * @author Martin Davis
 */
public class DDOrientationIndexCorrectTest extends GeometryTestCase {
   ...
   *
   * <p>According to the stated decimal representation the two orientations should be equal, but
   * they are not.
   *
   * <p>Even more disturbingly, the orientationIndexFilter handles this case, without dropping
   * through to the actual DD code. The result is the same, however.
   */
  public void testPointCloseToLine() {
    ...
    /**
     * Same arrangement as above, but translated by removing digits before decimal point to reduce
     * numeric precision
     */
