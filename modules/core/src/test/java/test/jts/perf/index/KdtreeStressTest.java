...
/**
 * Tests an issue where deep KdTrees caused a {@link StackOverflowError} when using a recursive
 * query implementation.
 *
 * <p>See a fix for this issue in GEOS at https://github.com/libgeos/geos/pull/481.
 *
 * @author mdavis
 */
public class KdtreeStressTest {
  ...
  /**
   * Create an unbalanced tree by loading a series of monotonically increasing points
   *
