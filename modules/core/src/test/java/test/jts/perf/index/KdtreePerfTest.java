...
public class KdtreePerfTest extends PerformanceTestCase {
  ...
  public void runKdTreeNearest() {
    @SuppressWarnings("unused") List<KdNode> result = tree.nearestNeighbors(query, k);
  }
  ...
  public void runBruteForceNearest() {
    ...
    @SuppressWarnings("unused") List<Coordinate> nearest = copy.subList(0, Math.min(k, copy.size()));
  }
