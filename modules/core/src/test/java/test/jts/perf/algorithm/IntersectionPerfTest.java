...
/**
 * Performance test for various line intersection implementations. These include:
 *
 * <ul>
 ...
 *       arithmetic
 *   <li>DDFilter - an experimental implementation using extended-precision {@link
 *       org.locationtech.jts.math.DD} arithmetic along with a filter that uses DP if the accuracy
 *       is sufficient
 * </ul>
 *
 * <h2>Results</h2>
 ...
 *   <li>the performance of DP-Filter is similar to DP or DD, depending on which method is chosen by
 *       the filter
 *       <ul>
 *         This test is evaluated together with the accuracy results from {@link
 *         IntersectionStressTest}. The conclusion is that the best combination of accuracy and
 *         performance is provided by DP-Cond.
 *
 * @author Martin Davis
 */
