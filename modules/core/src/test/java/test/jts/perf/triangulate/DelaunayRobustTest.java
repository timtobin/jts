...
/**
 * Test robustness of Delaunay computation. Test dataset is constructed to have
 * many points with a large base offset. This reduces the precision available
 * for the arithmetic in the inCircle test. This causes incorrect values to be
 * computed by using the simple double-precision approach.
 *
 * @author Martin Davis
 */
