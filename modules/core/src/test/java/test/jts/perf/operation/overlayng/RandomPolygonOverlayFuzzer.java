...
/**
 * Runs overlay operations on pairs of random polygonal geometries to see if errors occur.
 *
 * <p>For OverlayNG a spectrum of scale factors is used. Using a Floating precision model can be
...
public class RandomPolygonOverlayFuzzer {
  ...
  private String stats() {
    return String.format(
        "\nTest %d: %s   (# errs: %d = %d%%)\n",
        testIndex, testDesc, errCount, (100 * errCount) / testIndex);
  }
