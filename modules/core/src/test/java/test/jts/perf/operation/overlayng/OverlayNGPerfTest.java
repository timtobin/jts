...
public class OverlayNGPerfTest extends PerformanceTestCase {
	...
	/**
	 * Switching input order doesn't make much difference. Update: actually it looks
	 * like having the smaller geometry as the prepared one is faster (by a variable
	 * amount)
	 */
