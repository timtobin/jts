...
/**
 * Test the accuracy of DD orientation index computation, using the built-in
 * double value conversion and an experimental conversion approach with better
 * decimal accuracy.
 *
 * @author Martin Davis
 */
public class DDOrientationIndexAccuracyTest extends GeometryTestCase {
	...
	private void checkPointOnSeg(Coordinate p1, Coordinate p2, Coordinate q) {
		System.out
				.println("  Pt: " + WKTWriter.toPoint(q) + "  seg: " + WKTWriter.toLineString(p1, p2) + " --- DDstd = "
						+ orientationDet(p1, p2, q, DD_STD) + " --- DDdec = " + orientationDet(p1, p2, q, DD_DEC));
	}
