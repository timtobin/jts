...
public class GeometryTestData {
	...
	public static String[] WKT_ALL = {WKT_POINT, WKT_POINT_EMPTY, WKT_LINESTRING, WKT_LINESTRING_EMPTY, WKT_LINEARRING,
			WKT_LINEARRING_EMPTY, WKT_POLY, WKT_POLY_HOLE, WKT_POLY_HOLE2, WKT_POLY_EMPTY, WKT_MULTIPOINT,
			WKT_MULTIPOINT_SINGLE, WKT_MULTIPOINT_EMPTY, WKT_MULTILINESTRING, WKT_MULTILINESTRING_SINGLE,
			WKT_MULTILINESTRING_EMPTY, WKT_MULTIPOLYGON, WKT_MULTIPOLYGON_SINGLE, WKT_MULTIPOLYGON_EMPTY, WKT_GC,
			WKT_GC_ALP, WKT_GC_NESTED, WKT_GC_EMPTY};
}
