...
public class GeometryTestFactory {
	 ...
	 *            the centre y coord
	 * @param size
	 *            the size of the envelope of the star
	 * @param nPts
	...
	public static Polygon createSineStar(GeometryFactory fact, double basex, double basey, double size, double armLen,
			int nArms, int nPts) {
	 ...
	 *            the size of the envelope of the star
	 * @param armLen
	 *            the length of an arm of the star
	 * @param nArms
	 *            the number of arms of the star
	 * @param nPts
	 *            the number of points in the star
	 */
	public static Coordinate[] createSineStar(double basex, double basey, double size, double armLen, int nArms,
			int nPts) {
