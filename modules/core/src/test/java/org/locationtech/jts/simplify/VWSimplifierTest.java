...
class VWSimplifierResult {
	...
	public static Geometry[] getResult(String wkt, double tolerance) throws ParseException {
 ...
 * @version 1.7
 */
public class VWSimplifierTest extends GeometryTestCase {
	@Test
	public void testEmptyPolygon() throws Exception {
		String geomStr = "POLYGON(EMPTY)";
		new GeometryOperationValidator(VWSimplifierResult.getResult(geomStr, 1)).setExpectedResult(geomStr).test();
	}
	...
	public void testPolygonNoReduction() throws Exception {
		new GeometryOperationValidator(VWSimplifierResult.getResult(
