...
public class PolygonHoleJoinerTest extends GeometryTestCase {
	...
	/**
	 * Revealed a bug due to original use of tolerance for coordinate comparison
	 * (now removed)
	 */
	@Test
	...
	public void testHoleTouchesEdge() {
		checkJoin("POLYGON ((5 5, 9 5, 9 0, 0 0, 5 5), (3 3, 6 1, 5 3, 3 3))",
				"POLYGON ((5 5, 9 5, 9 0, 0 0, 3 3, 6 1, 5 3, 3 3, 5 5))");
	}

	@Test
	public void testHoleTouchesEdgeVertical() {
		checkJoin("POLYGON ((1 9, 9 9, 9 0, 1 0, 1 9), (1 5, 5 5, 6 8, 1 5))",
	...
	public void testHoleTouchesEdgeWithCloserVertex() {
		checkJoin("POLYGON ((1 9, 9 9, 5 6, 9 6, 19 1, 9 1, 1 9), (8 5, 9 3, 5 5, 8 5))",
				"POLYGON ((1 9, 9 9, 5 6, 9 6, 19 1, 9 1, 5 5, 9 3, 8 5, 5 5, 1 9))");
	}

	@Test
	public void testHoleTouchesVertex() {
		checkJoin("POLYGON ((70 10, 0 0, 7 47, 20 90, 70 60, 70 10), (10 40, 30 50, 7 47, 10 40))",
	...
	public void testHolesTouchEdgeVertical() {
		checkJoin("POLYGON ((1 9, 9 9, 9 0, 1 0, 1 9), (1 4, 5 1, 5 4, 1 4), (1 5, 5 5, 6 8, 1 5))",
	 ...
	 * Fails due to PolygonHoleJoiner joining holes with same leftmost vertex so
	 * that the result linework self-crosses. Note that input is normalized.
	 */
	@Test
	public void testTouchingHoles() {
		checkJoin("POLYGON ((0 0, 0 9, 9 9, 9 0, 0 0), (1 4, 5 1, 5 4, 1 4), (1 4, 5 5, 6 8, 1 4))",
				"POLYGON ((0 0, 0 9, 1 4, 5 1, 5 4, 1 4, 5 5, 6 8, 1 4, 0 9, 9 9, 9 0, 0 0))");
	}

	/**
	 * A failing case revealing that joining a hole by a zero-length cut was
	 * introducing duplicate vertices.
	 */
	@Test
