...
public class LineSegmentTest {
   ...
   *
   * <p>See https://github.com/locationtech/jts/issues/871
   */
  public void testHashCode() {
    checkHashcode(new LineSegment(0, 0, 10, 0), new LineSegment(0, 10, 10, 10));
    checkHashcode(
        new LineSegment(580.0, 1330.0, 590.0, 1330.0),
        new LineSegment(580.0, 1340.0, 590.0, 1340.));
  }
  ...
  private void checkDistancePerpendicular(
      double x0, double y0, double x1, double y1, double px, double py, double expected) {
  ...
  private void checkDistancePerpendicularOriented(
      double x0, double y0, double x1, double y1, double px, double py, double expected) {
    LineSegment seg = new LineSegment(x0, y0, x1, y1);
  ...
  void checkOrientationIndex(
      double x0, double y0, double x1, double y1, double px, double py, int expectedOrient) {
    LineSegment seg = new LineSegment(x0, y0, x1, y1);
