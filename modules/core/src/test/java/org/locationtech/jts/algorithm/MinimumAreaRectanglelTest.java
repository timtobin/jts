...
public class MinimumAreaRectanglelTest extends GeometryTestCase {
  ...
  public void testLineObtuseAngle() {
    checkMinRectangle(
        "LINESTRING (1 2, 3 8, 9 8)", "POLYGON ((9 8, 1 2, -1.16 4.88, 6.84 10.88, 9 8))");
  }

  @Test
  public void testLineAcuteAngle() {
    checkMinRectangle("LINESTRING (5 2, 3 8, 9 8)", "POLYGON ((5 2, 3 8, 8.4 9.8, 10.4 3.8, 5 2))");
  }
  ...
  public void testConvex() {
    checkMinRectangle(
        "POLYGON ((3 8, 6 8, 9 5, 7 3, 3 1, 2 4, 3 8))",
