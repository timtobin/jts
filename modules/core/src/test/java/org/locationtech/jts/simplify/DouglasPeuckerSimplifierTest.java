...
public class DouglasPeuckerSimplifierTest extends GeometryTestCase {
  ...
  public void testPolygonWithTouchingHole() {
    checkDP(
        "POLYGON ((10 10, 10 90, 90 90, 90 10, 10 10), (80 20, 20 20, 20 80, 50 90, 80 80, 80 20))",
        10,
  ...
  public void testMultiPolygonWithEmpty() {
    checkDP(
        "MULTIPOLYGON (EMPTY, ((10 90, 10 10, 90 10, 50 60, 10 90)), ((70 90, 90 90, 90 70, 70 70, 70 90)))",
        10,
  ...
  /**
   * Test that a polygon made invalid by simplification is fixed in a sensible way. Fixed by
   * buffer(0) area-base orientation See https://github.com/locationtech/jts/issues/498
   */
  ...
  /**
   * Test that a collapsed polygon is removed. Not an error in JTS, but included to avoid regression
   * errors in future.
   *
   * <p>See https://trac.osgeo.org/geos/ticket/1115
   */
