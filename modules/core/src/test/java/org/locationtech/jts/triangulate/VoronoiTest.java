...
public class VoronoiTest extends GeometryTestCase {
	...
	/**
	 * This test fails if the frame is forced to be convex via
	 * {@link IncrementalDelaunayTriangulator#forceConvex(boolean)}. It is also
	 * dependent on the frame size factor - a value of 10 causes failure, but larger
	 * values may not.
	 */
	 ...
	 * computed for adjacent triangles for sites in a square. Switching to
	 * {@link DD} solved the problem by computing identical circumcentres.
	 */
