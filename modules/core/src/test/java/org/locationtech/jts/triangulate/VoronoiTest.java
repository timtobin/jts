...
public class VoronoiTest extends GeometryTestCase {
  public void testSimple() throws ParseException {
    ...
    String expected =
        "GEOMETRYCOLLECTION (POLYGON ((-82.19544457292888 56.1992407621548, -82.19544457292888 162.19544457292886, 50 162.19544457292886, 50 60, 27.857142857142858 37.857142857142854, -82.19544457292888 56.1992407621548)), POLYGON ((-82.19544457292888 -82.19544457292888, -82.19544457292888 56.1992407621548, 27.857142857142858 37.857142857142854, 75.87817782917156 -82.19544457292888, -82.19544457292888 -82.19544457292888)), POLYGON ((172.19544457292886 -1.0977222864644354, 172.19544457292886 -82.19544457292888, 75.87817782917156 -82.19544457292888, 27.857142857142858 37.857142857142854, 50 60, 172.19544457292886 -1.0977222864644354)), POLYGON ((50 162.19544457292886, 172.19544457292886 162.19544457292886, 172.19544457292886 -1.0977222864644354, 50 60, 50 162.19544457292886)))";
   ...
   *
   * <p>Running with original Triangle.circumcentre double-precision code caused invalid polygons to
   * be computed, due to different circumcentres being computed for adjacent triangles for sites in
   * a square. Switching to {@link DD} solved the problem by computing identical circumcentres.
   */
  ...
  /**
   * This test fails if the frame is forced to be convex via {@link
   * IncrementalDelaunayTriangulator#forceConvex(boolean)}. It is also dependent on the frame size
   * factor - a value of 10 causes failure, but larger values may not.
   */
  public void testFrameDisableForceConvex() {
    String wkt =
        "MULTIPOINT ((259 289), (46 194), (396 359), (243 349), (206 99), (470 40), (429 185), (54 9), (78 208), (457 406), (355 191), (346 497), (144 79), (35 459), (322 37), (181 371), (359 257), (57 331), (225 139), (475 245), (416 364), (155 477), (123 232), (102 141), (251 434))";
    runVoronoi(wkt);
  }
