...
public class WKBWriterTest extends GeometryTestCase {
	...
	public void testGeometryCollection() {
		checkWKB(
				...
				2, ByteOrderValues.LITTLE_ENDIAN, 4326,
	...
	public void testMultiPolygon() {
		checkWKB("MULTIPOLYGON(((0 0,0 10,10 10,10 0,0 0),(1 1,1 9,9 9,9 1,1 1)),((-9 0,-9 10,-1 10,-1 0,-9 0)))", 2,
				ByteOrderValues.LITTLE_ENDIAN, 4326,
	...
	public void testWkbLineStringM() {
		checkWKB("LINESTRING M(1 2 3, 5 6 7)", 4, ByteOrderValues.LITTLE_ENDIAN, -1,
