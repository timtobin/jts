...
public class ConvexHullTest extends GeometryTestCase {
	...
	/**
	 * Tests robustness issue in radial sort. See
	...
	/**
	 * Test case fails in GEOS due to incorrect fix to radial sorting. This did not
	 * trigger a failure in JTS, probably because the sorting is less strict.
	 */
	...
	/**
	 * Tests a bug which modified the input point array in some cases (larger
	 * geometries which are nearly linear).
	 *
	 * <p>
	...
	public void testToArray() {
		...
		assertNotEquals(array1[0], array1[1]);
	}
