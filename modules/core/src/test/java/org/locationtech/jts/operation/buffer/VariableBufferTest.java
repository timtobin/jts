...
public class VariableBufferTest extends GeometryTestCase {
	...
	public void testLargeDistance() {
		checkBuffer("LINESTRING( 0 0, 10 10)", 1, 200,
	...
	public void testNoReverseSpike() {
		checkBuffer("LINESTRING (0 70, 0 80)", new double[]{4, 7},
	...
	public void testNoShortCapSegments() {
		checkBuffer("LINESTRING (6.85 78.25, 18 87)", new double[]{5, 9},
	...
	public void testOneSegment() {
		checkBuffer("LINESTRING (100 100, 200 100)", 10, 30,
	...
	public void testSegmentInverseDist() {
		checkBuffer("LINESTRING (100 100, 200 100)", 10, 1,
	...
	public void testSegmentSameDist() {
		checkBuffer("LINESTRING (100 100, 200 100)", 10, 10,
	...
	public void testSegments2() {
		checkBuffer("LINESTRING( 0 0, 40 40, 60 -20)", 10, 20,
	...
	public void testZeroDistanceAtVertex() {
		checkBuffer("LINESTRING( 10 10, 20 20, 30 30)", new double[]{5, 0, 5},
	...
	public void testZeroDistancesForSegment() {
		checkBuffer("LINESTRING( 10 10, 20 20, 30 30, 40 40)", new double[]{5, 0, 0, 5},
	...
	public void testZeroLength() {
		checkBuffer("LINESTRING( 10 10, 10 10 )", 0, 0, "POLYGON EMPTY");
	}

	@Test
	public void testZeroWidth() {
		checkBuffer("LINESTRING( 0 0, 6 6, 10 10)", 0, 0, "POLYGON EMPTY");
	}
}
