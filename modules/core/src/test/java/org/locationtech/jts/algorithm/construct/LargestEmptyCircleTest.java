...
public class LargestEmptyCircleTest extends GeometryTestCase {
	...
	private void checkCircle(LargestEmptyCircle lec, double tolerance, double x, double y, double expectedRadius) {
	...
	private void checkCircle(String wktObstacles, String wktBoundary, double tolerance, double x, double y,
	...
	/**
	 * A simple distance check, mainly testing that there is not a huge number of
	 * iterations. (This will be revealed by CI taking a very long time!)
	 *
	 * @param wkt
	 * @param tolerance
	 */
	...
	private void checkCircle(String wktObstacles, double tolerance, double x, double y, double expectedRadius) {
		Geometry obstacles = read(wktObstacles);
	...
	private void checkCircleAutoTol(String wktObstacles, double tolerance, double x, double y, double expectedRadius) {
		Geometry obstacles = read(wktObstacles);
	...
	private void checkCircleZeroRadius(Geometry geom, double tolerance) {
		...
		LineString radiusLine = lec.getRadiusLine();
		double actualRadius = radiusLine.getLength();
		assertEquals(0.0, actualRadius, tolerance, "Radius: ");
	...
	public void testBoundaryAsObstacle() {
		checkCircle("GEOMETRYCOLLECTION (LINESTRING (1 9, 9 9, 9 1, 1 1, 1 9), POINT (4 3), POINT (7 6))",
				"POLYGON ((1 9, 9 9, 9 1, 1 1, 1 9))", 0.01, 4, 6, 3);
	}

	@Test
	public void testBoundaryEmpty() {
		checkCircle("MULTIPOINT ((2 2), (8 8), (7 5))", "POLYGON EMPTY", 0.01, 4.127, 4.127, 3);
	}

	@Test
	public void testBoundaryMultiSquares() {
		checkCircle("MULTIPOINT ((10 10), (10 0), (5 5))",
				"MULTIPOLYGON (((1 9, 9 9, 9 1, 1 1, 1 9)), ((15 20, 20 20, 20 15, 15 15, 15 20)))", 0.01, 19.995,
				19.997, 14.137);
	}
	...
	public void testBoundarySquare() {
		checkCircle("MULTIPOINT ((2 2), (6 4), (8 8))", "POLYGON ((1 9, 9 9, 9 1, 1 1, 1 9))", 0.01, 1.00390625,
				8.99609375, 7.065);
	}

	@Test
	public void testBoundarySquareObstaclesOutside() {
		checkCircle("MULTIPOINT ((10 10), (10 0))", "POLYGON ((1 9, 9 9, 9 1, 1 1, 1 9))", 0.01, 1.0044, 4.997, 10.29);
	}

	@Test
	public void testLineFlat() {
		checkCircleZeroRadius("LINESTRING (0 0, 50 50)", 0.01);
	}
	...
	public void testLinesCrossed() {
		checkCircle("MULTILINESTRING ((100 100, 300 300), (100 200, 300 0))", 0.01, 299.99, 150.00, 106.05);
	}
	...
	public void testObstacleEmptyElement() {
		checkCircle("GEOMETRYCOLLECTION (LINESTRING EMPTY, POINT (4 3), POINT (7 6), POINT (4 6))", 0.01, 5.5, 4.5,
				2.12);
	}

	@Test
	public void testPoint() {
		checkCircleZeroRadius("POINT (100 100)", 0.01);
	}
	...
	public void testPointsSquare() {
		checkCircle("MULTIPOINT ((100 100), (100 200), (200 200), (200 100))", 0.01, 150, 150, 70.71);
	}

	@Test
	public void testPointsTriangleInterior() {
		checkCircle("MULTIPOINT ((100 100), (300 100), (200 250))", 0.01, 200.00, 141.66, 108.33);
	}

	@Test
	public void testPointsTriangleOnHull() {
		checkCircle("MULTIPOINT ((100 100), (300 100), (150 50))", 0.01, 216.66, 99.99, 83.33);
	}

	@Test
	public void testPolygonConcave() {
		checkCircle("POLYGON ((1 9, 9 6, 6 5, 5 3, 8 3, 9 4, 9 1, 1 1, 1 9))", 0.01, 7.495, 4.216, 1.21);
	}

	@Test
	public void testPolygonLines() {
		checkCircle(
				"GEOMETRYCOLLECTION (POLYGON ((1 6, 6 6, 6 1, 1 1, 1 6)), LINESTRING (6 7, 3 9), LINESTRING (1 7, 3 8))",
				0.01, 3.74, 7.14, 1.14);
	}

	@Test
	public void testPolygonsBoxes() {
		checkCircle("MULTIPOLYGON (((1 6, 6 6, 6 1, 1 1, 1 6)), ((6 7, 4 7, 4 9, 6 9, 6 7)))", 0.01, 2.50, 7.50, 1.50);
	}

	@Test
	public void testThinExtent() {
		checkCircle("MULTIPOINT ((100 100), (300 100), (200 100.1))", 0.01);
	}
}
