...
public class LargestEmptyCircleTest extends GeometryTestCase {
  ...
  public void testLinesOpenDiamond() {
    checkCircle(
        "MULTILINESTRING ((50 100, 150 50), (250 50, 350 100), (350 150, 250 200), (50 150, 150 200))",
        0.01,
        200,
        125,
        90.13);
  ...
  public void testLinesCrossed() {
    checkCircle(
        "MULTILINESTRING ((100 100, 300 300), (100 200, 300 0))", 0.01, 299.99, 150.00, 106.05);
  }
  ...
  public void testPolygonConcave() {
    checkCircle(
        "POLYGON ((1 9, 9 6, 6 5, 5 3, 8 3, 9 4, 9 1, 1 1, 1 9))", 0.01, 7.495, 4.216, 1.21);
  }

  @Test
  public void testPolygonsBoxes() {
    checkCircle(
        "MULTIPOLYGON (((1 6, 6 6, 6 1, 1 1, 1 6)), ((6 7, 4 7, 4 9, 6 9, 6 7)))",
        0.01,
        2.50,
        7.50,
        1.50);
  ...
  public void testBoundaryAsObstacle() {
    checkCircle(
        "GEOMETRYCOLLECTION (LINESTRING (1 9, 9 9, 9 1, 1 1, 1 9), POINT (4 3), POINT (7 6))",
        "POLYGON ((1 9, 9 9, 9 1, 1 1, 1 9))",
        0.01,
        4,
        6,
  ...
  public void testObstacleEmptyElement() {
    checkCircle(
        "GEOMETRYCOLLECTION (LINESTRING EMPTY, POINT (4 3), POINT (7 6), POINT (4 6))",
        0.01,
        5.5,
        4.5,
        2.12);
  ...
  /**
   * A simple distance check, mainly testing that there is not a huge number of iterations. (This
  ...
  private void checkCircle(
      String wktObstacles, double tolerance, double x, double y, double expectedRadius) {
  ...
  private void checkCircle(
      LargestEmptyCircle lec, double tolerance, double x, double y, double expectedRadius) {
    Geometry centerPoint = lec.getCenter();
