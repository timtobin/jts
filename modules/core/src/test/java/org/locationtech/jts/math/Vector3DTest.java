...
public class Vector3DTest {
	...
	public void testDotABCD() {
		double dot = Vector3D.dot(coord(2, 3, 4), coord(3, 4, 5), coord(0, 1, -1), coord(1, 5, 2));
	...
	public void testNormlize() {
		assertEquals(create(-0.5773502691896258, 0.5773502691896258, 0.5773502691896258), create(-1, 1, 1).normalize());
		assertEquals(create(0.5773502691896258, 0.5773502691896258, 0.5773502691896258), create(2, 2, 2).normalize());
		assertEquals(create(0.2672612419124244, 0.5345224838248488, 0.8017837257372732), create(1, 2, 3).normalize());
	}
