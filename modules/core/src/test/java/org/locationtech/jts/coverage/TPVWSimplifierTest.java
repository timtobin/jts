...
public class TPVWSimplifierTest extends GeometryTestCase {
	...
	private void checkSimplify(String wkt, int[] freeRingIndex, String wktConstraints, double tolerance,
			String wktExpected) {
	...
	private void checkSimplify(String wkt, int[] freeRingIndex, double tolerance, String wktExpected) {
	...
	public void testConstraint() {
		checkSimplify("MULTILINESTRING ((6 8, 2 8, 2.1 5, 2 2, 6 2, 5.9 5, 6 8))", new int[]{},
				"MULTILINESTRING ((1 9, 9 9, 6 5, 9 1), (1 9, 1 1, 9 1))", 1,
	...
	public void testFreeRing() {
		checkSimplify("MULTILINESTRING ((1 9, 9 9, 9 1), (1 9, 1 1, 9 1), (7 5, 8 8, 2 8, 2 2, 8 2, 7 5))",
				new int[]{2}, 2, "MULTILINESTRING ((1 9, 1 1, 9 1), (1 9, 9 9, 9 1), (8 8, 2 8, 2 2, 8 2, 8 8))");
	}
	...
	public void testSimple() {
		checkSimplify("MULTILINESTRING ((9 9, 3 9, 1 4, 4 1, 9 1), (9 1, 6 3, 2 4, 5 7, 9 9))", 2,
