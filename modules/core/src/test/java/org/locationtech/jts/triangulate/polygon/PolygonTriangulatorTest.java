...
public class PolygonTriangulatorTest extends GeometryTestCase {
  ...
  /**
   * A failing case revealing that joining holes by a zero-length cut was introducing duplicate
   * vertices.
   */
  @Test
  ...
  /**
   * A failing case for hole joining with two touching holes. Fails due to PolygonHoleJoiner not
   * handling holes which have same leftmost vertex. Note that input is normalized.
   */
  @Test
