...
public class PolygonTriangulatorTest extends GeometryTestCase {
	...
	/**
	 * A failing case for hole joining with two touching holes. Fails due to
	 * PolygonHoleJoiner not handling holes which have same leftmost vertex. Note
	 * that input is normalized.
	 */
	@Test
	...
	/**
	 * A failing case revealing that joining holes by a zero-length cut was
	...
	/**
	 * Ear clipping creates a collapsed corner (A-B-A), which was not detected by
	 * flat corner removal
	 */
	@Test
	...
	public void testEmpty() {
		checkTri("POLYGON EMPTY", "GEOMETRYCOLLECTION EMPTY");
	}
