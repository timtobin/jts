 ...
 *
 * <p>
 * Note: currently only "simple" GCs are supported. Simple GCs are ones which
 * can be flattened to a valid Multi-geometry.
 *
 * @author mdavis
 */
public class OverlayNGGeometryCollectionTest extends OverlayNGTestCase {
	public void testSimpleA_AA() {
		...
		checkIntersection(a, b, "MULTIPOLYGON (((2 2, 2 5, 5 5, 5 2, 2 2)), ((5 5, 5 8, 8 8, 8 5, 5 5)))");
		checkUnion(a, b, "POLYGON ((1 1, 1 5, 2 5, 2 8, 5 8, 5 9, 9 9, 9 5, 8 5, 8 2, 5 2, 5 1, 1 1))");
	}

	public void testSimpleA_mP() {
		String a = "POLYGON ((0 0, 0 1, 1 1, 0 0))";
		String b = "GEOMETRYCOLLECTION ( MULTIPOINT ((0 0), (99 99)) )";
		checkIntersection(a, b, "POINT (0 0)");
		checkUnion(a, b, "GEOMETRYCOLLECTION (POINT (99 99), POLYGON ((0 0, 0 1, 1 1, 0 0)))");
	}

	public void testSimpleL_AA() {
		String a = "LINESTRING (0 0, 10 10)";
		String b = "GEOMETRYCOLLECTION ( POLYGON ((1 1, 1 5, 5 5, 5 1, 1 1)), POLYGON ((9 9, 9 5, 5 5, 5 9, 9 9)) )";
		checkIntersection(a, b, "MULTILINESTRING ((1 1, 5 5), (5 5, 9 9))");
		checkUnion(a, b,
	...
	public void testSimpleP_AA() {
		String a = "POINT(5 5)";
		String b = "GEOMETRYCOLLECTION ( POLYGON ((1 1, 1 5, 5 5, 5 1, 1 1)), POLYGON ((9 9, 9 5, 5 5, 5 9, 9 9)) )";
		checkIntersection(a, b, "POINT (5 5)");
		checkUnion(a, b, "MULTIPOLYGON (((1 1, 1 5, 5 5, 5 1, 1 1)), ((9 9, 9 5, 5 5, 5 9, 9 9)))");
	}
	...
	public void testSimpleP_mL() {
		...
		checkIntersection(a, b, "POINT (5 5)");
		checkUnion(a, b, "MULTILINESTRING ((1 1, 5 5), (1 9, 5 5), (5 5, 9 1), (5 5, 9 9))");
	}
	...
	public void testSimpleP_mP() {
		...
		String b = "GEOMETRYCOLLECTION ( MULTIPOINT ((0 0), (99 99)) )";
		checkIntersection(a, b, "POINT (0 0)");
		checkUnion(a, b, "MULTIPOINT ((0 0), (99 99))");
	}
}
