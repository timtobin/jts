 ...
 *
 * <p>Note: currently only "simple" GCs are supported. Simple GCs are ones which can be flattened to
 * a valid Multi-geometry.
 *
 * @author mdavis
 */
public class OverlayNGGeometryCollectionTest extends OverlayNGTestCase {
  ...
  public void testSimpleA_AA() {
    ...
    String b =
        "GEOMETRYCOLLECTION ( POLYGON ((1 1, 1 5, 5 5, 5 1, 1 1)), POLYGON ((9 9, 9 5, 5 5, 5 9, 9 9)) )";
    checkIntersection(
        a, b, "MULTIPOLYGON (((2 2, 2 5, 5 5, 5 2, 2 2)), ((5 5, 5 8, 8 8, 8 5, 5 5)))");
