...
public class LineStringGenerator extends GeometryGenerator {
	/**
	 * Create the points in an approximation of an open circle (one edge will not be
	 * included).
	 *
	 * <p>
	 ...
	 * random valid linestring decreases. Please take not of this when selecting the
