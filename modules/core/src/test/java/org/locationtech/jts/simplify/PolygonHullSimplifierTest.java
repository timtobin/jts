...
public class PolygonHullSimplifierTest extends GeometryTestCase {
	...
	public void testByAreaOuterSimple() {
		...
		checkHullByAreaDelta(wkt, 0,
				"POLYGON ((10 40, 30 90, 60 70, 50 50, 30 40, 70 40, 80 80, 90 30, 70 10, 40 10, 10 40))");
		checkHullByAreaDelta(wkt, 0.01,
				"POLYGON ((10 40, 30 90, 60 70, 50 50, 30 40, 70 40, 80 80, 90 30, 70 10, 40 10, 10 40))");
		checkHullByAreaDelta(wkt, 0.1,
				"POLYGON ((10 40, 30 90, 60 70, 50 50, 70 40, 80 80, 90 30, 70 10, 40 10, 10 40))");
	...
	public void testGoreRemoval() {
		checkHullByAreaDelta(
				"POLYGON ((30 120, 60 240, 200 220, 60.02 240.08, 80 320, 320 280, 230 160, 250 60, 30 120))", 0.01,
				"POLYGON ((30 120, 80 320, 320 280, 230 160, 250 60, 30 120))");
	}

	@Test
	public void testInner() {
		checkHullInner("POLYGON ((11 14, 2 31, 18 29, 25 17, 38 16, 29 5, 19 11, 11 0, 0 10, 11 14))", 0.5,
	...
	public void testOuterFlat() {
		checkHullOuter("POLYGON ((10 10, 10 90, 90 90, 90 50, 90 10, 50 10, 10 10))", 0.4,
	...
	public void testOuterSimple() {
		...
		checkHullOuter(wkt, 1,
				"POLYGON ((30 90, 10 40, 40 10, 70 10, 90 30, 80 80, 70 40, 30 40, 50 50, 60 70, 30 90))");
	}
