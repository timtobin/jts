...
public class PolygonHullSimplifierTest extends GeometryTestCase {
  ...
  public void testOuterZGore() {
    ...
    checkHullOuter(
        wkt, 0.7, "POLYGON ((10 90, 40 60, 30 40, 60 70, 50 90, 90 90, 90 10, 10 10, 10 90))");
  }
  ...
  public void testByAreaOuterSimple() {
    ...
    checkHullByAreaDelta(
        wkt, 0.2, "POLYGON ((30 90, 60 70, 70 40, 80 80, 90 30, 70 10, 40 10, 10 40, 30 90))");
  ...
  public void testGoreRemoval() {
    checkHullByAreaDelta(
        "POLYGON ((30 120, 60 240, 200 220, 60.02 240.08, 80 320, 320 280, 230 160, 250 60, 30 120))",
        0.01,
  ...
  private void checkHull(
      String wkt, boolean isOuter, double vertexNumFraction, String wktExpected) {
