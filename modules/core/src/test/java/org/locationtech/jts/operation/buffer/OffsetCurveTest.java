...
/**
 * Note: most expected results are rounded to precision of 100, to reduce size
 * and improve robustness. The test cases are chosen so that this has no effect
 * on comparing expected to actual.
 *
 * @author Martin Davis
 */
public class OffsetCurveTest extends GeometryTestCase {
	...
	private void checkOffsetCurve(String wkt, double distance, int quadSegs, int joinStyle, double mitreLimit,
			String wktExpected) {
	...
	public void testAsymmetricU() {
		...
		checkOffsetCurve(wkt, 1, "LINESTRING (1 2, 4 2)");
	...
	public void testClosedCurve() {
		checkOffsetCurve("LINESTRING (30 70, 80 80, 50 10, 10 80, 60 70)", 10,
	...
	public void testInfiniteLoop() {
		checkOffsetCurve("LINESTRING (21 101, -1 78, 12 43, 50 112, 73 -5, 19 2, 87 85, -7 38, 105 40)", 4, null);
	}

	@Test
	public void testJoinBevel() {
		checkOffsetCurve("LINESTRING (20 20, 50 50, 80 20)", 10, -1, BufferParameters.JOIN_BEVEL, -1,
				"LINESTRING (12.93 27.07, 42.93 57.07, 57.07 57.07, 87.07 27.07)");
	}

	@Test
	public void testJoinMitre() {
		checkOffsetCurve("LINESTRING (20 20, 50 50, 80 20)", 10, -1, BufferParameters.JOIN_MITRE, -1,
	...
	public void testJoinMitreErrorSimple() {
		checkOffsetCurve("LINESTRING (4.821 0.72, 7.767 1.801, 4.94 9.552, 0 7.79, 2.858 0, 4.821 0.72)", -0.045, 0,
				BufferParameters.JOIN_MITRE, -1,
	...
	public void testJoinMitreNegDistance() {
		checkOffsetCurve("LINESTRING (0 0, 10 0, 10 10, 0 10, 0 0)", -1, 0, BufferParameters.JOIN_MITRE, 5,
	...
	public void testJoined() {
		...
		checkOffsetCurveJoined(input, 10, "LINESTRING (0 60, 75.85 60, 60 75.85, 60 0)");
	...
	public void testMinQuadrantSegments() {
		checkOffsetCurve(
				...
				-11, 0, BufferParameters.JOIN_MITRE, -1, "LINESTRING (553770.76 177759.13, 553777.54 177758.32)");
	}

	// See https://github.com/qgis/QGIS/issues/53165#issuecomment-1563214857
	@Test
	public void testMinQuadrantSegments_QGIS() {
		checkOffsetCurve("LINESTRING (421 622, 446 625, 449 627)", 133, 0, BufferParameters.JOIN_MITRE, -1,
				"LINESTRING (405.15 754.05, 416.3 755.39)");
	}

	@Test
	public void testMixedWithPoint() {
		checkOffsetCurve("GEOMETRYCOLLECTION (LINESTRING (20 30, 60 10, 80 60), POINT (0 0))", 10,
				"LINESTRING (24.47 38.94, 54.75 23.8, 70.72 63.71)");
	}

	@Test
	public void testMultiLine() {
		checkOffsetCurve("MULTILINESTRING ((20 30, 60 10, 80 60), (40 50, 80 30))", 10,
	...
	public void testOffsetError() {
		checkOffsetCurve("LINESTRING (12 20, 60 68, 111 114, 151 159, 210 218)", 3,
	...
	public void testOverlapTriangleInside() {
		checkOffsetCurve("LINESTRING (70 80, 10 80, 50 10, 90 80, 40 80)", 10,
	...
	public void testPolygon() {
		checkOffsetCurve("POLYGON ((100 200, 200 100, 100 100, 100 200))", 10,
	...
	public void testPolygonJoinMitre() {
		checkOffsetCurve("POLYGON ((1 1, 1 7, 5 4, 8 8, 8 1, 1 1))", 1, 0, BufferParameters.JOIN_MITRE, 5,
				"LINESTRING (0 0, 0 9, 4.8 5.4, 9 11, 9 0, 0 0)", 0.0001);
		checkOffsetCurve("POLYGON ((1 1, 1 7, 5 4, 8 8, 8 1, 1 1))", -1, 0, BufferParameters.JOIN_MITRE, 5,
				"LINESTRING (2 2, 2 5, 5.2 2.6, 7 5, 7 2, 2 2)", 0.0001);
	}

	@Test
	public void testPolygonWithHole() {
		checkOffsetCurve("POLYGON ((20 80, 80 80, 80 20, 20 20, 20 80), (30 70, 70 70, 70 30, 30 30, 30 70))", 10,
	...
	public void testQuadSegs() {
		checkOffsetCurve("LINESTRING (20 20, 50 50, 80 20)", 10, 10, -1, -1,
	...
	/**
	 * Test bug fix for removing repeated points in input for raw curve. See
	 * https://github.com/locationtech/jts/issues/957
	 */
	@Test
	public void testRepeatedPoint() {
		checkOffsetCurve("LINESTRING (4 9, 1 2, 7 5, 7 5, 4 9)", 1,
	...
	public void testRightAngle() {
		checkOffsetCurve("LINESTRING (2 8, 8 8, 8 1)", 1,
	...
	public void testRing() {
		checkOffsetCurve("LINESTRING (10 10, 50 90, 90 10, 10 10)", -10,
				"LINESTRING (26.18 20, 50 67.63, 73.81 20, 26.18 20)");
	}

	@Test
	public void testSegment1() {
		checkOffsetCurve("LINESTRING (0 0, 9 9)", 1, "LINESTRING (-0.71 0.71, 8.29 9.71)");
	}
	...
	public void testSegment1Neg() {
		checkOffsetCurve("LINESTRING (0 0, 9 9)", -1, "LINESTRING (0.71 -0.71, 9.71 8.29)");
	}

	@Test
	public void testSegment1Short() {
		checkOffsetCurve("LINESTRING (2 2, 2 2.0000001)", 1, "LINESTRING (1 2, 1 2.0000001)", 0.00000001);
	}

	@Test
	public void testSegments2() {
		checkOffsetCurve("LINESTRING (0 0, 9 9, 25 0)", 1,
	...
	public void testSegments3() {
		checkOffsetCurve("LINESTRING (0 0, 9 9, 25 0, 30 15)", 1,
	...
	public void testSymmetricU() {
		...
		checkOffsetCurve(wkt, 1, "LINESTRING EMPTY");
		checkOffsetCurve(wkt, -1,
	...
	public void testZeroOffsetLine() {
		checkOffsetCurve("LINESTRING (0 0, 1 0, 1 1)", 0, "LINESTRING (0 0, 1 0, 1 1)");
	}
	...
	public void testZigzagOneEndCurved1() {
		checkOffsetCurve("LINESTRING (1 3, 6 3, 4 5, 9 5)", 1,
	...
	public void testZigzagOneEndCurved4() {
		checkOffsetCurve("LINESTRING (1 3, 6 3, 4 5, 9 5)", 4,
