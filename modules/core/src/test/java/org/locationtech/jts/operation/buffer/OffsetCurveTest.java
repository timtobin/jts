...
/**
 * Note: most expected results are rounded to precision of 100, to reduce size and improve
 * robustness. The test cases are chosen so that this has no effect on comparing expected to actual.
 *
 * @author Martin Davis
 */
public class OffsetCurveTest extends GeometryTestCase {
  ...
  public void testSegment1Short() {
    checkOffsetCurve(
        "LINESTRING (2 2, 2 2.0000001)", 1, "LINESTRING (1 2, 1 2.0000001)", 0.00000001);
  }
  ...
  public void testInfiniteLoop() {
    checkOffsetCurve(
        "LINESTRING (21 101, -1 78, 12 43, 50 112, 73 -5, 19 2, 87 85, -7 38, 105 40)", 4, null);
  }
