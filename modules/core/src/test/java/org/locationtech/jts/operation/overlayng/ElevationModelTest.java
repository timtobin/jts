...
public class ElevationModelTest extends GeometryTestCase {
  ...
  public void testPopulateZLine() {
    checkElevationPopulateZ(
        "LINESTRING Z (0 0 0, 10 10 10)", "LINESTRING (1 1, 9 9)", "LINESTRING (1 1 0, 9 9 10)");
  }
  ...
  /**
   * Tests that XY geometries are scanned correctly (avoiding reading Z) and that they produce a
   * model Z value of NaN
   */
  @Test
