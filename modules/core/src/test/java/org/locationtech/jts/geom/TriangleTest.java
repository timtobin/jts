...
public class TriangleTest extends GeometryTestCase {
	...
	public void checkCircumradius(String wkt) throws Exception {
		Geometry g = reader.read(wkt);
		Coordinate[] pt = g.getCoordinates();
	...
	public void checkInCentre(String wkt, Coordinate expectedValue) throws Exception {
	...
	public void testCentroid() throws Exception {
		...
		checkCentroid("POLYGON((10 10, 20 20, 20 10, 10 10))",
				new Coordinate((10.0 + 20.0 + 20.0) / 3.0, (10.0 + 20.0 + 10.0) / 3.0));
		// CCW right tri
		checkCentroid("POLYGON((10 10, 20 10, 20 20, 10 10))",
				new Coordinate((10.0 + 20.0 + 20.0) / 3.0, (10.0 + 10.0 + 20.0) / 3.0));
		// acute
		checkCentroid("POLYGON((10 10, 20 10, 15 20, 10 10))",
				new Coordinate((10.0 + 20.0 + 15.0) / 3.0, (10.0 + 10.0 + 20.0) / 3.0));
	}

	@Test
	public void testCircumCentre() throws Exception {
		// right triangle
		checkCircumCentre("POLYGON((10 10, 20 20, 20 10, 10 10))", new Coordinate(15.0, 15.0));
		// CCW right tri
		checkCircumCentre("POLYGON((10 10, 20 10, 20 20, 10 10))", new Coordinate(15.0, 15.0));
		// acute
		checkCircumCentre("POLYGON((10 10, 20 10, 15 20, 10 10))", new Coordinate(15.0, 13.75));
	}
	...
	public void testInCentre() throws Exception {
		// right triangle
		checkInCentre("POLYGON((10 10, 20 20, 20 10, 10 10))", new Coordinate(17.071067811865476, 12.928932188134524));
		// CCW right tri
		checkInCentre("POLYGON((10 10, 20 10, 20 20, 10 10))", new Coordinate(17.071067811865476, 12.928932188134524));
		// acute
		checkInCentre("POLYGON((10 10, 20 10, 15 20, 10 10))", new Coordinate(14.999999999999998, 13.090169943749475));
		// obtuse
		checkInCentre("POLYGON ((10 10, 20 10, 40 20, 10 10))", new Coordinate(19.63104841334295, 11.56290400148567));
	}
