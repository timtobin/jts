...
public class ConcaveHullOfPolygonsTest extends GeometryTestCase {
	...
	public void testEmpty() {
		...
		checkHullTight(wkt, 1000, "POLYGON EMPTY");
	}

	@Test
	public void testPoly3Concave1() {
		checkHullTight(
				"MULTIPOLYGON (((1 5, 5 8, 5 5, 1 5)), ((5 1, 1 4, 5 4, 5 1)), ((6 8, 9 6, 7 5, 9 4, 6 1, 6 8)))", 100,
				"POLYGON ((6 8, 9 6, 7 5, 9 4, 6 1, 5 1, 1 4, 1 5, 5 8, 6 8))");
	}
	...
	public void testPoly3Concave3() {
		...
		checkHullTight(wkt, 4, "POLYGON ((4 0, 0 2, 3 4, 4 5, 0 7, 4 10, 5 9, 9 10, 8 8, 10 9, 8 5, 10 3, 7 0, 4 0))");
		checkHullTight(wkt, 100, "POLYGON ((0 7, 4 10, 9 10, 8 8, 10 9, 8 5, 10 3, 7 0, 4 0, 0 2, 0 7))");
		...
		checkHullByLenRatio(wkt, 1, "POLYGON ((9 10, 10 9, 10 3, 7 0, 4 0, 0 2, 0 7, 4 10, 9 10))");
	}
	...
	public void testPoly3WithHullHole() {
		...
		checkHullWithHoles(wkt, 9, "POLYGON ((6 9, 8 9, 9 5, 8 0, 6 0, 5 0, 1 0, 1 4, 1 5, 1 9, 5 9, 6 9))");
	}

	@Test
	public void testPolygon() {
		String wkt = "POLYGON ((1 9, 5 8, 9 9, 4 4, 7 1, 2 1, 1 9))";
		checkHullTight(wkt, 1000, "POLYGON ((1 9, 5 8, 9 9, 4 4, 7 1, 2 1, 1 9))");
		checkHull(wkt, 1000, "POLYGON ((1 9, 9 9, 7 1, 2 1, 1 9))");
	}
	...
	public void testSimple() {
		...
		checkHull(wkt, 1000, "POLYGON ((100 100, 100 200, 100 300, 200 300, 200 200, 200 100, 150 50, 100 100))");
	}
	...
	public void testSimpleNeck() {
		...
		checkHullTight(wkt, 0, wkt);
		checkHullTight(wkt, 2, "POLYGON ((6 3, 9 1, 1 1, 4 3, 4 4, 1 6, 1 9, 5 8, 9 9, 9 6, 6 4, 6 3))");
		checkHullTight(wkt, 6, "POLYGON ((1 1, 1 6, 1 9, 5 8, 9 9, 9 6, 9 1, 1 1))");
	}
}
