...
public class RectangleTest extends GeometryTestCase {
	...
	private void checkRectangle(String wkt, String wktExpected) {
		...
		Geometry actual = Rectangle.createFromSidePts(baseRightPt, baseLeftPt, oppositePt, leftSidePt, rightSidePt,
				line.getFactory());
	...
	@Test
	public void test45() {
		checkRectangle("LINESTRING (10 5, 5 0, 2 1, 2 7, 9 9)", "POLYGON ((-1 4, 6.5 11.5, 11.5 6.5, 4 -1, -1 4))");
	}
	...
	public void testOrthogonal() {
		checkRectangle("LINESTRING (9 1, 1 1, 0 5, 7 10, 10 6)", "POLYGON ((0 1, 0 10, 10 10, 10 1, 0 1))");
	}
}
