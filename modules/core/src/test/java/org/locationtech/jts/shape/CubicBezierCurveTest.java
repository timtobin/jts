 ...
 *
 * <p>Because of the inherent approximation and variability of Bezier Curves, this class is not
 * intended to check exact results, only that results are reasonable.
 *
 * @author mdavis
 */
public class CubicBezierCurveTest extends GeometryTestCase {
  public void testAlphaSquare() {
    checkCurve(
        "POLYGON ((40 60, 60 60, 60 40, 40 40, 40 60))",
        1,
  ...
  public void testAlphaRightAngleControl() {
    checkControl(
        "LINESTRING (30 40, 40 50, 50 40)", 1, "LINESTRING (30 45.3, 34.7 50, 45.3 50, 50 45.3)");
  }

  public void testAlphaRightZigzag() {
    checkCurve(
        "LINESTRING (10 10, 20 19, 30 10, 40 20)",
        1,
  ...
  public void testCtrlRightZigzag() {
    checkCurve(
        "LINESTRING (10 10, 20 20, 30 10, 40 20)",
  ...
  public void testSingleSegment() {
    checkCurve("LINESTRING (10 10, 20 20)", 1, "LINESTRING (10 10, 20 20)");
  }
