 ...
 *
 * <p>
 * Because of the inherent approximation and variability of Bezier Curves, this
 * class is not intended to check exact results, only that results are
 * reasonable.
 *
 * @author mdavis
 */
public class CubicBezierCurveTest extends GeometryTestCase {
	...
	public void testAlphaRightAngleControl() {
		checkControl("LINESTRING (30 40, 40 50, 50 40)", 1, "LINESTRING (30 45.3, 34.7 50, 45.3 50, 50 45.3)");
	}
	...
	public void testCtrlRightZigzag() {
		checkCurve("LINESTRING (10 10, 20 20, 30 10, 40 20)", "LINESTRING (10 15, 15 20, 25 20, 28 10, 32 10, 40 25)",
