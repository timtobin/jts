...
/**
 * Tests the {@link WKBReader} and {@link WKBWriter}. Tests all geometries with both 2 and 3
 * dimensions and both byte orderings.
 */
public class WKBTest {
  ...
  @Test
  public void testGeometryCollectionContainingEmptyGeometries() throws IOException, ParseException {
