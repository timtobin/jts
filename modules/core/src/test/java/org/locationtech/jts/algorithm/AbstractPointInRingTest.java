...
public abstract class AbstractPointInRingTest extends GeometryTestCase {
	...
	protected abstract void runPtInRing(int expectedLoc, Coordinate pt, String wkt) throws Exception;

	@Test
	public void testBox() throws Exception {
		runPtInRing(Location.INTERIOR, new Coordinate(10, 10), "POLYGON ((0 0, 0 20, 20 20, 20 0, 0 0))");
	}
	...
	public void testRobustStressTriangles() throws Exception {
		runPtInRing(Location.EXTERIOR, new Coordinate(25.374625374625374, 128.35564435564436),
				"POLYGON ((0.0 0.0, 0.0 172.0, 100.0 0.0, 0.0 0.0))");
		runPtInRing(Location.INTERIOR, new Coordinate(97.96039603960396, 782.0),
				"POLYGON ((642.0 815.0, 69.0 764.0, 394.0 966.0, 642.0 815.0))");
	}

	@Test
	public void testRobustTriangle() throws Exception {
		runPtInRing(Location.EXTERIOR, new Coordinate(3.166572116932842, 48.5390194687463),
