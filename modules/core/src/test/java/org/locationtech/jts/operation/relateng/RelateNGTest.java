...
public class RelateNGTest extends RelateNGTestCase {
	...
	/**
	 * This case shows that lines must be self-noded, so that node topology is
	 * constructed correctly (at least for some predicates).
	 */
	@Test
	...
	/**
	 * Case from https://github.com/locationtech/jts/issues/270 Strictly, the lines
	 * cross, since their interiors intersect according to the Orientation
	 * predicate. However, the computation of the intersection point is non-robust,
	 * and reports it as being equal to the endpoint POINT (-10 0.0000000000000012)
	...
	public void testPreparedPA() {
		...
		// -- see https://github.com/libgeos/geos/issues/1275 (not a bug, but a good
		// test to have)
		String pattern = "T*****FF*";
