...
public class LineLimiterTest extends GeometryTestCase {
	...
	public void testCrossesTwice() {
		checkLimit("LINESTRING (7 17, 23 17, 23 13, 7 13)", new Envelope(10, 20, 10, 20),
				"MULTILINESTRING ((7 17, 23 17), (23 13, 7 13))");
	}

	@Test
	public void testCrossing() {
		checkLimit("LINESTRING (5 17, 8 14, 12 18, 15 15, 18 18, 22 14, 25 18)", new Envelope(10, 20, 10, 20),
				"LINESTRING (8 14, 12 18, 15 15, 18 18, 22 14)");
	}

	@Test
	public void testDiamond() {
		checkLimit("LINESTRING (8 15, 15 22, 22 15, 15 8, 8 15)", new Envelope(10, 20, 10, 20),
	...
	public void testNonIntersecting() {
		checkLimit("LINESTRING (5 15, 5 25, 25 25, 25 5, 5 5)", new Envelope(10, 20, 10, 20), "MULTILINESTRING EMPTY");
	}

	@Test
	public void testOctagon() {
		checkLimit("LINESTRING (9 12, 12 9, 18 9, 21 12, 21 18, 18 21, 12 21, 9 18, 9 13)",
	...
	public void testPartiallyInside() {
		checkLimit("LINESTRING (4 17, 8 14, 12 18, 15 15)", new Envelope(10, 20, 10, 20),
				"LINESTRING (8 14, 12 18, 15 15)");
	}

	@Test
	public void testPointEnv() {
		checkLimit("LINESTRING (5 15, 5 25, 25 25, 25 5, 5 5)", new Envelope(10, 10, 10, 10), "MULTILINESTRING EMPTY");
	}
}
