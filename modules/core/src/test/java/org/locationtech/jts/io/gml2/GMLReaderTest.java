...
public class GMLReaderTest extends GeometryTestCase {
  ...
  private static final GeometryFactory geometryFactory =
      new GeometryFactory(new PrecisionModel(), DEFAULT_SRID);

  @Test
  public void testPoint() {
    checkRead(
        "<gml:Point>" + "    <gml:coordinates>45.67,88.56</gml:coordinates>" + " </gml:Point>",
        "POINT (45.67 88.56)");
  }
  ...
  public void testPointNoNamespace() {
    checkRead(
        "<Point>" + "    <coordinates>45.67,88.56</coordinates>" + " </Point>",
        "POINT (45.67 88.56)");
  }
  ...
  public void testPointSRIDHash() {
    checkRead(
        "<gml:Point srsName='some.prefix#4326'>"
            + "    <gml:coordinates>45.67,     88.56</gml:coordinates>"
            + " </gml:Point>",
        "POINT (45.67 88.56)",
        4326);
