...
public class MinimumDiameterTest {
  ...
  public void testMinimumDiameter2() throws Exception {
    doMinimumDiameterTest(
        true, "LINESTRING (0 240, 220 240)", new Coordinate(0, 240), new Coordinate(0, 240));
  }
  ...
  public void testMinimumDiameter5() throws Exception {
    doMinimumDiameterTest(
        true,
        "POLYGON ((0 240, 160 140, 220 0, 0 0, 0 240))",
        new Coordinate(185.86206896551724, 79.65517241379311),
        new Coordinate(0, 0));
  }
  ...
  public void testMinimumDiameter6() throws Exception {
    doMinimumDiameterTest(
        ...
        new Coordinate(95, 35));
  }

  private void doMinimumDiameterTest(boolean convex, String wkt, Coordinate c0, Coordinate c1)
      throws ParseException {
    Coordinate[] minimumDiameter =
        new MinimumDiameter(new WKTReader().read(wkt), convex).getDiameter().getCoordinates();
