...
public class MinimumDiameterTest {
	...
	public void testMinimumDiameter3() throws Exception {
		doMinimumDiameterTest(true, "POLYGON ((0 240, 220 240, 220 0, 0 0, 0 240))", new Coordinate(220, 240),
	...
	public void testMinimumDiameter5() throws Exception {
		doMinimumDiameterTest(true, "POLYGON ((0 240, 160 140, 220 0, 0 0, 0 240))",
				new Coordinate(185.86206896551724, 79.65517241379311), new Coordinate(0, 0));
	}

	@Test
	public void testMinimumDiameter6() throws Exception {
		doMinimumDiameterTest(false,
				...
				new Coordinate(64.46262341325811, 196.41184767277855), new Coordinate(95, 35));
	}
}
