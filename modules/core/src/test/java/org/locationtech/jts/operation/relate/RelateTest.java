...
public class RelateTest extends GeometryTestCase {
	 ...
	 *
	 * <p>
	 * The original failure is caused by the intersection computed during noding not
	 * lying exactly on each original line segment. This is due to numerical error
	 * in the FP intersection algorithm. This is fixed by using DD intersection
	 * calculation.
	 */
	 ...
	 * snaps to a boundary endpoint due to roundoff. Fixed by detecting that
	 * computed intersection snapped to a boundary node.
	 *
	 * <p>
