...
public class RelateTest extends GeometryTestCase {
   ...
   *
   * <p>The original failure is caused by the intersection computed during noding not lying exactly
   * on each original line segment. This is due to numerical error in the FP intersection algorithm.
  ...
  /**
   * Tests case where segments intersect properly, but computed intersection point snaps to a
   * boundary endpoint due to roundoff. Fixed by detecting that computed intersection snapped to a
   * boundary node.
   *
   * <p>See https://lists.osgeo.org/pipermail/postgis-users/2022-February/045266.html
   */
   ...
   * boundary node.
   *
   * <p>See https://lists.osgeo.org/pipermail/postgis-users/2022-February/045277.html
   */
