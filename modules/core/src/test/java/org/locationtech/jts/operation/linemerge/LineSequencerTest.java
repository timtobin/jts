...
public class LineSequencerTest {
	...
	public void test2SimpleLoops() throws Exception {
		String[] wkt = {"LINESTRING ( 0 0, 0 10 )", "LINESTRING ( 0 10, 0 0 )", "LINESTRING ( 0 0, 0 20 )",
				"LINESTRING ( 0 20, 0 0 )",};
	...
	public void testLineWithRing() throws Exception {
		String[] wkt = {"LINESTRING ( 0 0, 0 10 )", "LINESTRING ( 0 10, 10 10, 10 20, 0 10 )",
	...
	public void testMultipleGraphsWithMultipeRings() throws Exception {
		String[] wkt = {"LINESTRING ( 0 0, 0 10 )", "LINESTRING ( 0 10, 10 10, 10 20, 0 10 )",
				"LINESTRING ( 0 10, 40 40, 40 20, 0 10 )", "LINESTRING ( 0 30, 0 20 )", "LINESTRING ( 0 20, 0 10 )",
	...
	public void testSimple() throws Exception {
		String[] wkt = {"LINESTRING ( 0 0, 0 10 )", "LINESTRING ( 0 20, 0 30 )", "LINESTRING ( 0 10, 0 20 )"};
	...
	public void testSimpleBigLoop() throws Exception {
		String[] wkt = {"LINESTRING ( 0 0, 0 10 )", "LINESTRING ( 0 20, 0 30 )", "LINESTRING ( 0 30, 0 00 )",
	...
	public void testSimpleLoop() throws Exception {
		String[] wkt = {"LINESTRING ( 0 0, 0 10 )", "LINESTRING ( 0 10, 0 0 )",};
	...
	public void testSimpleLoopWithTail() throws Exception {
		String[] wkt = {"LINESTRING ( 0 0, 0 10 )", "LINESTRING ( 0 10, 10 10 )", "LINESTRING ( 10 10, 10 20, 0 10 )",};
	...
	public void testWide8WithTail() throws Exception {
		String[] wkt = {"LINESTRING ( 0 0, 0 10 )", "LINESTRING ( 10 0, 10 10 )", "LINESTRING ( 0 0, 10 0 )",
				"LINESTRING ( 0 10, 10 10 )", "LINESTRING ( 0 10, 0 20 )", "LINESTRING ( 10 10, 10 20 )",
				"LINESTRING ( 0 20, 10 20 )", "LINESTRING ( 10 20, 30 30 )",};
		String result = null;
		runLineSequencer(wkt, result);
	}
}
