...
public class Distance3DOpTest {
  ...
  */
  ...
  public void testPartiallyEmpty() {
    checkDistance(
        "GEOMETRYCOLLECTION( MULTIPOINT (0 0 0), POLYGON EMPTY)",
        "POINT (0 1 0)",
        1,
        coord(0, 0, 0),
        coord(0, 1, 0));
    checkDistance(
        "GEOMETRYCOLLECTION( MULTIPOINT (11 11 0), POLYGON EMPTY)",
  ...
  public void testPointPointFlat() {
    checkDistance(
        "POINT (10 10 0 )", "POINT (20 20 0 )", 14.1421356, coord(10, 10, 0), coord(20, 20, 0));
    checkDistance(
        "POINT (5 10 0 )", "POINT (15 20 0 )", 14.1421356, coord(5, 10, 0), coord(15, 20, 0));
  }
  ...
  public void testPointSeg() {
    checkDistance(
        "LINESTRING (0 0 0, 10 10 10 )", "POINT (5 5 5 )", 0, coord(5, 5, NaN), coord(5, 5, 5));
    checkDistance(
  ...
  public void testPointSegRobust() {
    checkDistance(
        "LINESTRING (0 0 0, 10000000 10000000 1 )", "POINT (9999999 9999999 .9999999 )", 0);
  ...
  /**
   * Many of these tests exhibit robustness errors due to numerical roundoff in the distance
   * algorithm mathematics. This happens when computing nearly-coincident lines with very large
   * ordinate values
   */
  @Test
  public void testCrossSegmentsRobust() {
    checkDistance(
        "LINESTRING (0 0 0, 10000000 10000000 1 )",
        "LINESTRING (0 0 1, 10000000 10000000 0 )",
        0,
        0.001); // expected is 0, but actual is larger

    checkDistance(
        "LINESTRING (-10000 -10000 0, 10000 10000 1 )",
        "LINESTRING (-10000 -10000 1, 10000 10000 0 )",
        0);

    // previous case with X,Y scaled by 1000 - exposes robustness issue
    checkDistance(
        "LINESTRING (-10000000 -10000000 0, 10000000 10000000 1 )",
        "LINESTRING (-10000000 -10000000 1, 10000000 10000000 0 )",
        0,
        0.02); // expected is 0, but actual is larger

    // works because lines are orthogonal, so doesn't hit roundoff problems
    checkDistance(
        "LINESTRING (20000000 10000000 20, 10000000 20000000 10 )",
  ...
  public void testParallelSegmentsFlat() {
    checkDistance(
        "LINESTRING (10 10 0, 20 20 0 )", "LINESTRING (10 20 0, 20 30 0 )", 7.0710678118654755);
  }
  ...
  public void testParallelSegments() {
    ...
    checkDistance(
        "LINESTRING (10 10 0, 20 20 0 )", "LINESTRING (10 20 10, 20 30 10 )", 12.24744871391589);
  ...
  public void testLineLine() {
    checkDistance(
        "LINESTRING (0 1 2, 1 1 1, 1 0 2 )",
        "LINESTRING (0 0 0.1, .5 .5 0, 1 1 0, 1.5 1.5 0, 2 2 0 )",
        1);
    checkDistance(
        "LINESTRING (10 10 20, 20 20 30, 20 20 1, 30 30 5 )",
  ...
  public void testLinePolygonFlat() {
    // line inside
    checkDistance(
        "LINESTRING (150 150 0, 160 160 0)",
        "POLYGON ((100 200 0, 200 200 0, 200 100 0, 100 100 0, 100 200 0))",
        0);
    // line outside
    checkDistance(
        "LINESTRING (200 250 0, 260 260 0)",
        "POLYGON ((100 200 0, 200 200 0, 200 100 0, 100 100 0, 100 200 0))",
        50,
        coord(200, 250, 0),
        coord(200, 200, 0));
    // line touching
    checkDistance(
        "LINESTRING (200 200 0, 260 260 0)",
        "POLYGON ((100 200 0, 200 200 0, 200 100 0, 100 100 0, 100 200 0))",
        0);
  }
  ...
  public void testLinePolygonSimple() {
    ...
    checkDistance(
        "LINESTRING (150 150 10, 150 150 -10)",
        "POLYGON ((100 200 0, 200 200 0, 200 100 0, 100 100 0, 100 200 0))",
        0);
    // vertical line above
    checkDistance(
        "LINESTRING (200 200 10, 260 260 100)",
        "POLYGON ((100 200 0, 200 200 0, 200 100 0, 100 100 0, 100 200 0))",
        10);
    // vertical line touching
    checkDistance(
        "LINESTRING (200 200 0, 260 260 100)",
        "POLYGON ((100 200 0, 200 200 0, 200 100 0, 100 100 0, 100 200 0))",
        0);
  }

  String polyHoleFlat =
      "POLYGON ((100 200 0, 200 200 0, 200 100 0, 100 100 0, 100 200 0), (120 180 0, 180 180 0, 180 120 0, 120 120 0, 120 180 0))";
  ...
  public void testLinePolygonHoleFlat() {
    ...
    checkDistance(
        "LINESTRING (110 110 10, 110 110 -10)",
        polyHoleFlat,
        0,
        coord(110, 110, -10),
        coord(110, 110, -10));
    ...
    checkDistance(
        "LINESTRING (130 130 10, 150 150 100)",
        polyHoleFlat,
        14.14213562373095,
        coord(130, 130, 10),
        coord(130, 120, NaN));
    ...
    checkDistance(
        "LINESTRING (120 180 0, 120 180 100)",
        polyHoleFlat,
        0,
        coord(120, 180, 0),
        coord(120, 180, 0));
  ...
  public void testPointPolygonHoleFlat() {
    ...
    // point above poly
    checkDistance(
        "POINT (110 110 100)", polyHoleFlat, 100, coord(110, 110, 100), coord(110, 110, 100));
  }

  String poly2HoleFlat =
      "POLYGON ((100 200 0, 200 200 0, 200 100 0, 100 100 0, 100 200 0), (110 110 0, 110 130 0, 130 130 0, 130 110 0, 110 110 0), (190 110 0, 170 110 0, 170 130 0, 190 130 0, 190 110 0))";

  /**
   * A case proving that polygon/polygon distance requires computing distance between all rings, not
   * just the shells.
   */
  @Test
  ...
  private void checkDistance(
      String wkt1, String wkt2, double expectedDistance, Coordinate... expectedCoordinates) {
