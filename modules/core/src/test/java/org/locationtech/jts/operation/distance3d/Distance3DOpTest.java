...
public class Distance3DOpTest {
	...
	final String poly2HoleFlat = "POLYGON ((100 200 0, 200 200 0, 200 100 0, 100 100 0, 100 200 0), (110 110 0, 110 130 0, 130 130 0, 130 110 0, 110 110 0), (190 110 0, 170 110 0, 170 130 0, 190 130 0, 190 110 0))";
	...
	private void checkDistance(Geometry g1, Geometry g2, double expectedDistance, Coordinate[] expectedCoords,
			double tolerance) {
	...
	private void checkDistance(String wkt1, String wkt2, double expectedDistance, Coordinate[] expectedCoords,
			double tolerance) {
		Geometry g1;
		Geometry g2;
		try {
	...
	/**
	 * Many of these tests exhibit robustness errors due to numerical roundoff in
	 * the distance algorithm mathematics. This happens when computing
	 * nearly-coincident lines with very large ordinate values
	 */
	@Test
	public void testCrossSegmentsRobust() {
		checkDistance("LINESTRING (0 0 0, 10000000 10000000 1 )", "LINESTRING (0 0 1, 10000000 10000000 0 )", 0, 0.001); // expected
		// is
		// 0,
		// but
		// actual
		...
		checkDistance("LINESTRING (-10000 -10000 0, 10000 10000 1 )", "LINESTRING (-10000 -10000 1, 10000 10000 0 )",
				0);
		...
		checkDistance("LINESTRING (-10000000 -10000000 0, 10000000 10000000 1 )",
				"LINESTRING (-10000000 -10000000 1, 10000000 10000000 0 )", 0, 0.02); // expected is 0, but actual is
		// larger
		...
		checkDistance("LINESTRING (20000000 10000000 20, 10000000 20000000 10 )",
				"LINESTRING (10000000 10000000 20, 20000000 20000000 10 )", 0);
	}
	...
	public void testLineLine() {
		checkDistance("LINESTRING (0 1 2, 1 1 1, 1 0 2 )", "LINESTRING (0 0 0.1, .5 .5 0, 1 1 0, 1.5 1.5 0, 2 2 0 )",
				1);
		checkDistance("LINESTRING (10 10 20, 20 20 30, 20 20 1, 30 30 5 )",
				"LINESTRING (1 80 10, 0 39 5, 39 0 5, 80 1 20)", 0.7071067811865476, coord(20, 20, 30),
				coord(19.5, 19.5, NaN));
	}
	...
	public void testLinePolygonFlat() {
		...
		checkDistance("LINESTRING (200 250 0, 260 260 0)",
				"POLYGON ((100 200 0, 200 200 0, 200 100 0, 100 100 0, 100 200 0))", 50, coord(200, 250, 0),
				coord(200, 200, 0));
		// line touching
	...
	public void testLinePolygonHoleFlat() {
		// line crossing hole
		checkDistance("LINESTRING (150 150 10, 150 150 -10)", polyHoleFlat, 30, coord(150, 150, 10),
				coord(150, 180, NaN));
		// line crossing interior
		checkDistance("LINESTRING (110 110 10, 110 110 -10)", polyHoleFlat, 0, coord(110, 110, -10),
				coord(110, 110, -10));
		// vertical line above hole
		checkDistance("LINESTRING (130 130 10, 150 150 100)", polyHoleFlat, 14.14213562373095, coord(130, 130, 10),
				coord(130, 120, NaN));
		// vertical line touching hole
		checkDistance("LINESTRING (120 180 0, 120 180 100)", polyHoleFlat, 0, coord(120, 180, 0), coord(120, 180, 0));
	}
	...
	public void testMultiLineString() {
		checkDistance("MULTILINESTRING ((0 0 0, 10 10 10), (0 0 100, 25 25 25, 40 40 50), (100 100 100, 100 101 102))",
				"MULTILINESTRING ((100 100 99, 100 100 99), (100 102 102, 200 200 20), (25 100 33, 25 100 35))", 1);
	}

	@Test
	public void testMultiMixed() {
		checkDistance("MULTILINESTRING ((0 0 0, 10 10 10), (0 0 100, 25 25 25, 40 40 50), (100 100 100, 100 101 101))",
				"MULTIPOINT ((100 100 99), (50 50 50), (25 100 33))", 1, coord(100, 100, 100), coord(100, 100, 99));
	}

	@Test
	public void testMultiPoint() {
		checkDistance("MULTIPOINT ((0 0 0), (0 0 100), (100 100 100))",
				"MULTIPOINT ((100 100 99), (50 50 50), (25 100 33))", 1, coord(100, 100, 100), coord(100, 100, 99));
	}
	...
	public void testParallelSegments() {
		...
		checkDistance("LINESTRING (10 10 0, 20 20 0 )", "LINESTRING (10 20 10, 20 30 10 )", 12.24744871391589);
	...
	public void testParallelSegmentsFlat() {
		checkDistance("LINESTRING (10 10 0, 20 20 0 )", "LINESTRING (10 20 0, 20 30 0 )", 7.0710678118654755);
	}

	@Test
	public void testPartiallyEmpty() {
		checkDistance("GEOMETRYCOLLECTION( MULTIPOINT (0 0 0), POLYGON EMPTY)", "POINT (0 1 0)", 1, coord(0, 0, 0),
				coord(0, 1, 0));
		checkDistance("GEOMETRYCOLLECTION( MULTIPOINT (11 11 0), POLYGON EMPTY)",
				"GEOMETRYCOLLECTION( MULTIPOINT EMPTY, LINESTRING (10 10 0, 10 20 0 ))", 1, coord(11, 11, 0),
				coord(10, 11, NaN));
	}

	@Test
	public void testPointPoint() {
		checkDistance("POINT (0 0 0 )", "POINT (0 0 1 )", 1, coord(0, 0, 0), coord(0, 0, 1));
		checkDistance("POINT (10 10 1 )", "POINT (11 11 2 )", 1.7320508075688772, coord(10, 10, 1), coord(11, 11, 2));
		checkDistance("POINT (10 10 0 )", "POINT (10 20 10 )", 14.142135623730951, coord(10, 10, 0), coord(10, 20, 10));
	}

	@Test
	public void testPointPointFlat() {
		checkDistance("POINT (10 10 0 )", "POINT (20 20 0 )", 14.1421356, coord(10, 10, 0), coord(20, 20, 0));
		checkDistance("POINT (5 10 0 )", "POINT (15 20 0 )", 14.1421356, coord(5, 10, 0), coord(15, 20, 0));
	}
	...
	public void testPointPolygon() {
		// point above poly
		checkDistance("POINT (150 150 10)", "POLYGON ((100 200 0, 200 200 0, 200 100 0, 100 100 0, 100 200 0))", 10);
		// point below poly
		checkDistance("POINT (150 150 -10)", "POLYGON ((100 200 0, 200 200 0, 200 100 0, 100 100 0, 100 200 0))", 10);
	...
	public void testPointPolygonFlat() {
		// inside
		checkDistance("POINT (150 150 0)", "POLYGON ((100 200 0, 200 200 0, 200 100 0, 100 100 0, 100 200 0))", 0,
				coord(150, 150, 0), coord(150, 150, 0));
		// outside
		checkDistance("POINT (250 250 0)", "POLYGON ((100 200 0, 200 200 0, 200 100 0, 100 100 0, 100 200 0))",
				70.71067811865476, coord(250, 250, 0), coord(200, 200, 0));
		// on
		checkDistance("POINT (200 200 0)", "POLYGON ((100 200 0, 200 200 0, 200 100 0, 100 100 0, 100 200 0))", 0);
	}

	@Test
	public void testPointPolygonHoleFlat() {
		// point above poly hole
		checkDistance("POINT (130 130 10)", polyHoleFlat, 14.14213562373095, coord(130, 130, 10), coord(130, 120, NaN));
		// point below poly hole
		checkDistance("POINT (130 130 -10)", polyHoleFlat, 14.14213562373095, coord(130, 130, -10),
				coord(130, 120, NaN));
		// point above poly
		checkDistance("POINT (110 110 100)", polyHoleFlat, 100, coord(110, 110, 100), coord(110, 110, 100));
	}

	@Test
	public void testPointSeg() {
		checkDistance("LINESTRING (0 0 0, 10 10 10 )", "POINT (5 5 5 )", 0, coord(5, 5, NaN), coord(5, 5, 5));
		checkDistance("LINESTRING (10 10 10, 20 20 20 )", "POINT (11 11 10 )", 0.816496580927726, coord(11, 11, NaN),
				coord(11, 11, 10));
	}

	@Test
	public void testPointSegFlat() {
		checkDistance("LINESTRING (10 10 0, 10 20 0 )", "POINT (20 15 0 )", 10, coord(10, 15, NaN), coord(20, 15, 0));
	}

	@Test
	public void testPointSegRobust() {
		checkDistance("LINESTRING (0 0 0, 10000000 10000000 1 )", "POINT (9999999 9999999 .9999999 )", 0);
		checkDistance("LINESTRING (0 0 0, 10000000 10000000 1 )", "POINT (5000000 5000000 .5 )", 0);
	}

	/**
	 * A case proving that polygon/polygon distance requires computing distance
	 * between all rings, not just the shells.
	 */
	@Test
	...
	public void testTSegmentsFlat() {
		checkDistance("LINESTRING (10 10 0, 10 20 0 )", "LINESTRING (20 15 0, 25 15 0 )", 10, coord(10, 15, NaN),
				coord(20, 15, 0));
	}
}
