...
public class CoverageSimplifierTest extends GeometryTestCase {
	...
	public void testAllEmpty() {
		checkResult(readArray("POLYGON EMPTY", "POLYGON EMPTY"), 1, readArray("POLYGON EMPTY", "POLYGON EMPTY"));
	}

	@Test
	public void testAtStartingNode() {
		checkResult(
				readArray("POLYGON (( 0 5, 0 9, 6 9, 6 2, 1 2, 0 5 ), ( 1 5, 2 3, 5 3, 5 7, 1 7, 1 5 ))",
						"POLYGON (( 1 5, 1 7, 5 7, 5 3, 2 3, 1 5 ))"),
				1.5, readArray("POLYGON ((0 9, 6 9, 6 2, 1 2, 0 9), (1 7, 2 3, 5 3, 5 7, 1 7))",
						"POLYGON ((1 7, 5 7, 5 3, 2 3, 1 7))"));
	}

	@Test
	public void testEmptyHole() {
		checkResult(readArray("POLYGON ((1 9, 5 9.1, 9 9, 9 1, 1 1, 1 9), EMPTY)", "POLYGON EMPTY"), 1,
				readArray("POLYGON ((1 9, 9 9, 9 1, 1 1, 1 9), EMPTY)", "POLYGON EMPTY"));
	}
	...
	public void testFilledHole() {
		checkResult(
				readArray("POLYGON ((20 30, 20 80, 60 50, 80 20, 50 20, 20 30))",
						"POLYGON ((10 90, 90 90, 90 10, 10 10, 10 90), (50 20, 20 30, 20 80, 60 50, 80 20, 50 20))"),
				28, readArray("POLYGON ((20 30, 20 80, 60 50, 80 20, 20 30))",
	...
	public void testHolesTouchingHolesAndShell() {
		checkResult(readArray(
				...
				4.0, readArray("POLYGON ((8 5, 9 2, 1 2, 1 8, 9 8, 8 5), (8 5, 7 6, 6 6, 6 4, 7 4, 8 5))"));
	}
	...
	public void testInnerAtStartingNode() {
		checkResultInner(
				readArray("POLYGON (( 0 5, 0 9, 6 9, 6 2, 1 2, 0 5 ), ( 1 5, 2 3, 5 3, 5 7, 1 7, 1 5 ))",
						"POLYGON (( 1 5, 1 7, 5 7, 5 3, 2 3, 1 5 ))"),
				1.5, readArray("POLYGON ((0 5, 0 9, 6 9, 6 2, 1 2, 0 5), (1 7, 2 3, 5 3, 5 7, 1 7))",
						"POLYGON ((1 7, 5 7, 5 3, 2 3, 1 7))"));
	}
	...
	public void testInnerHoleTouchingShell() {
		checkResultInner(readArray(
				...
				"POLYGON ((170 250, 180 280, 200 300, 200 250, 170 250))"), 70.0,
				readArray(
	...
	public void testInnerSimple() {
		checkResultInner(
				readArray("POLYGON ((50 50, 50 150, 100 190, 100 200, 200 200, 160 150, 120 120, 90 80, 50 50))",
						"POLYGON ((100 0, 50 50, 90 80, 120 120, 160 150, 200 200, 250 100, 170 50, 100 0))"),
				100, readArray("POLYGON ((50 50, 50 150, 100 190, 100 200, 200 200, 50 50))",
						"POLYGON ((200 200, 50 50, 100 0, 170 50, 250 100, 200 200))"));
	}

	@Test
	public void testInnerTouchingShells() {
		checkResultInner(readArray("POLYGON ((0 0, 0 5, 5 6, 10 5, 10 0, 0 0))", "POLYGON ((0 10, 5 6, 10 10, 0 10))"),
				4.0, readArray("POLYGON ((0 0, 0 5, 5 6, 10 5, 10 0, 0 0))", "POLYGON ((0 10, 5 6, 10 10, 0 10))"));
	}

	/**
	 * Checks that a polygon on the edge of the coverage does not collapse under
	 * maximal simplification
	 */
	@Test
	public void testMultiEdgeRingNoCollapse() {
		checkResult(
				readArray("POLYGON ((50 250, 200 200, 180 170, 200 150, 50 50, 50 250))",
						"POLYGON ((200 200, 180 170, 200 150, 200 200))"),
				40, readArray("POLYGON ((50 250, 200 200, 180 170, 200 150, 50 50, 50 250))",
						"POLYGON ((200 200, 180 170, 200 150, 200 200))"));
	}

	@Test
	public void testMultiPolygonHolesSmallPart() {
		checkResultRemovalSize(
				readArray("POLYGON ((0 9, 9 9, 9 0, 0 0, 0 9), (2 5, 2 4, 3 5, 2 5), (4 5, 4 3, 6 3, 6 5, 4 5))",
						"MULTIPOLYGON (((2 5, 3 5, 2 4, 2 5)), ((4 5, 6 5, 6 3, 4 3, 4 5)))"),
				1, 0, readArray("POLYGON ((0 9, 9 9, 9 0, 0 0, 0 9), (2 5, 2 4, 3 5, 2 5), (4 5, 4 3, 6 3, 6 5, 4 5))",
						"MULTIPOLYGON (((2 5, 3 5, 2 4, 2 5)), ((4 5, 6 5, 6 3, 4 3, 4 5)))"));
	}
	...
	public void testMultiPolygonHolesSmallPartRemoved() {
		checkResult(
				readArray("POLYGON ((0 9, 9 9, 9 0, 0 0, 0 9), (2 5, 2 4, 3 5, 2 5), (4 5, 4 3, 6 3, 6 5, 4 5))",
						"MULTIPOLYGON (((2 5, 3 5, 2 4, 2 5)), ((4 5, 6 5, 6 3, 4 3, 4 5)))"),
				1, readArray("POLYGON ((0 9, 9 9, 9 0, 0 0, 0 9), (4 5, 4 3, 6 3, 6 5, 4 5))",
	...
	public void testMultiPolygonWithSmallPartRemoved() {
		checkResult(
				readArray("MULTIPOLYGON (((11 9, 15 9, 15 5, 11 5, 11 9)), ((11 2, 12 2, 11 1, 11 2)))",
						"POLYGON ((15 9, 18 9, 19 4, 14 1, 15 5, 15 9))"),
				1, readArray("POLYGON ((11 5, 11 9, 15 9, 15 5, 11 5))",
						"POLYGON ((15 9, 18 9, 19 4, 14 1, 15 5, 15 9))"));
	}
	...
	public void testMultiPolygonWithTouchingSmallPartsRemoved() {
		checkResult(
				readArray("MULTIPOLYGON (((1 5, 5 5, 5 1, 1 1, 1 5)), ((6 3, 7 2, 6 2, 6 3)), ((8 2, 7 2, 8 3, 8 2)))"),
				1, readArray("POLYGON ((1 5, 5 5, 5 1, 1 1, 1 5)))"));
	}

	@Test
	public void testMultiPolygons() {
		checkResult(
				readArray("MULTIPOLYGON (((5 9, 2.5 7.5, 1 5, 5 5, 5 9)), ((5 5, 9 5, 7.5 2.5, 5 1, 5 5)))",
						"MULTIPOLYGON (((5 9, 6.5 6.5, 9 5, 5 5, 5 9)), ((1 5, 5 5, 5 1, 3.5 3.5, 1 5)))"),
				3, readArray("MULTIPOLYGON (((1 5, 5 9, 5 5, 1 5)), ((5 1, 5 5, 9 5, 5 1))))",
	...
	public void testNoopHole() {
		checkNoop(readArray("POLYGON ((10 90, 90 90, 90 10, 10 10, 10 90), (20 80, 80 80, 80 20, 20 20, 20 80))",
	...
	public void testNoopMulti() {
		checkNoop(
				readArray("MULTIPOLYGON (((10 10, 10 50, 50 50, 50 10, 10 10)), ((90 90, 90 50, 50 50, 50 90, 90 90)))",
						"MULTIPOLYGON (((10 90, 50 90, 50 50, 10 50, 10 90)), ((90 10, 50 10, 50 50, 90 50, 90 10)))"));
	}

	@Test
	public void testNoopSimple2() {
		checkNoop(readArray("POLYGON ((100 100, 200 200, 300 100, 200 101, 100 100))",
				"POLYGON ((150 0, 100 100, 200 101, 300 100, 250 0, 150 0))"));
	}

	@Test
	public void testNoopSimple3() {
		checkNoop(readArray("POLYGON ((100 300, 200 200, 100 200, 100 300))",
	...
	public void testOneEmpty() {
		checkResult(readArray("POLYGON ((1 9, 5 9.1, 9 9, 9 1, 1 1, 1 9))", "POLYGON EMPTY"), 1,
				readArray("POLYGON ((1 9, 9 9, 9 1, 1 1, 1 9))", "POLYGON EMPTY"));
	}

	// A Polygon with a small hole containing another Polygon - small Polygon is
	// primary so is not
	// removed
	@Test
	public void testPolygonInHoleNotRemoved() {
		checkResult(
				readArray("POLYGON ((1 9, 9 9, 9 1, 1 1, 1 9), (2 2, 2 3, 3 3, 2 2))",
						"POLYGON ((2 2, 2 3, 3 3, 2 2))"),
				1, readArray("POLYGON ((1 9, 9 9, 9 1, 1 1, 1 9), (2 2, 2 3, 3 3, 2 2))",
						"POLYGON ((2 2, 2 3, 3 3, 2 2))"));
	}
	...
	public void testRepeatedPointRemoved() {
		checkResult(readArray("POLYGON ((2 9, 7 6, 9 1, 2 1, 2 1, 3 6, 2 9))"), 2,
				readArray("POLYGON ((2 1, 2 9, 7 6, 9 1, 2 1))"));
	}
	...
	public void testShellSimplificationAtStartingNode() {
		checkResult(readArray("POLYGON (( 1 5, 1 7, 5 7, 5 3, 2 3, 1 5 ))"), 1.5,
				readArray("POLYGON ((1 7, 5 7, 5 3, 2 3, 1 7))"));
	}

	@Test
	public void testSimple2() {
		checkResult(
				readArray("POLYGON ((100 100, 200 200, 300 100, 200 101, 100 100))",
						"POLYGON ((150 0, 100 100, 200 101, 300 100, 250 0, 150 0))"),
				10, readArray("POLYGON ((100 100, 200 200, 300 100, 100 100))",
						"POLYGON ((150 0, 100 100, 300 100, 250 0, 150 0))"));
	}

	@Test
	public void testSingleRingNoCollapse() {
		checkResult(readArray("POLYGON ((10 50, 50 90, 60 90, 70 50, 60 10, 10 50))"), 100000,
				readArray("POLYGON ((10 50, 60 90, 70 50, 60 10, 10 50))"));
	}

	@Test
	public void testTolerances() {
		checkResult(
				readArray("POLYGON ((1 19, 6 19, 7 11, 6 1, 1 1, 1 19))",
						"POLYGON ((6 19, 12 19, 11 15, 12 1, 6 1, 7 11, 6 19))",
						"POLYGON ((12 19, 19 19, 22 10, 19 1, 12 1, 11 15, 12 19))"),
				new double[]{0, 3, 6},
				readArray("POLYGON ((6 19, 7 11, 6 1, 1 1, 1 19, 6 19))",
	...
	public void testTouchingHoles() {
		checkResult(readArray(
				...
				"POLYGON (( 12 6, 12 7, 13 7, 13 9, 14 9, 14 6, 12 6 ))"), 1.0,
				readArray(
