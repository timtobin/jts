...
public class CoverageSimplifierTest extends GeometryTestCase {
  ...
  public void testRepeatedPointRemoved() {
    checkResult(
        readArray("POLYGON ((2 9, 7 6, 9 1, 2 1, 2 1, 3 6, 2 9))"),
        2,
  ...
  public void testSingleRingNoCollapse() {
    checkResult(
        readArray("POLYGON ((10 50, 50 90, 60 90, 70 50, 60 10, 10 50))"),
        100000,
        readArray("POLYGON ((10 50, 60 90, 70 50, 60 10, 10 50))"));
  }

  /**
   * Checks that a polygon on the edge of the coverage does not collapse under maximal
   * simplification
   */
  @Test
  ...
  public void testHolesTouchingHolesAndShell() {
    checkResult(
        readArray(
            "POLYGON (( 8 5, 9 4, 9 2, 1 2, 1 4, 2 4, 2 5, 1 5, 1 8, 9 8, 9 6, 8 5 ), ( 8 5, 7 6, 6 6, 6 4, 7 4, 8 5 ), ( 7 6, 8 6, 7 7, 7 6 ), ( 6 6, 6 7, 5 6, 6 6 ), ( 6 4, 5 4, 6 3, 6 4 ), ( 7 4, 7 3, 8 4, 7 4 ))"),
        4.0,
        readArray("POLYGON ((8 5, 9 2, 1 2, 1 8, 9 8, 8 5), (8 5, 7 6, 6 6, 6 4, 7 4, 8 5))"));
  }
  ...
  public void testInnerTouchingShells() {
    checkResultInner(
        readArray(
            "POLYGON ((0 0, 0 5, 5 6, 10 5, 10 0, 0 0))", "POLYGON ((0 10, 5 6, 10 10, 0 10))"),
        4.0,
        readArray(
            "POLYGON ((0 0, 0 5, 5 6, 10 5, 10 0, 0 0))", "POLYGON ((0 10, 5 6, 10 10, 0 10))"));
  }
  ...
  public void testShellSimplificationAtStartingNode() {
    checkResult(
        readArray("POLYGON (( 1 5, 1 7, 5 7, 5 3, 2 3, 1 5 ))"),
        1.5,
  ...
  public void testAllEmpty() {
    checkResult(
        readArray("POLYGON EMPTY", "POLYGON EMPTY"),
        1,
        readArray("POLYGON EMPTY", "POLYGON EMPTY"));
  }
  ...
  public void testOneEmpty() {
    checkResult(
        readArray("POLYGON ((1 9, 5 9.1, 9 9, 9 1, 1 1, 1 9))", "POLYGON EMPTY"),
        1,
  ...
  public void testEmptyHole() {
    checkResult(
        readArray("POLYGON ((1 9, 5 9.1, 9 9, 9 1, 1 1, 1 9), EMPTY)", "POLYGON EMPTY"),
        1,
  ...
  // A Polygon with a small hole containing another Polygon - small Polygon is primary so is not
  // removed
  @Test
  ...
  public void testMultiPolygonWithTouchingSmallPartsRemoved() {
    checkResult(
        ...
        1,
        readArray("POLYGON ((1 5, 5 5, 5 1, 1 1, 1 5)))"));
  }
  ...
  private void checkResultRemovalSize(
      Geometry[] input, double tolerance, double removalFactor, Geometry[] expected) {
