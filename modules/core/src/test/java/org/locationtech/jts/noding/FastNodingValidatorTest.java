...
public class FastNodingValidatorTest extends GeometryTestCase {
	...
	private static final String[] INTERIOR_INT = new String[]{"LINESTRING (100 100, 300 300)",
			"LINESTRING (100 300, 300 100)"};
	private static final String[] NO_INT = new String[]{"LINESTRING (100 100, 200 200)",
			"LINESTRING (200 200, 300 300)", "LINESTRING (100 300, 200 200)"};
	...
	private static final String[] VERTEX_INT = new String[]{"LINESTRING (100 100, 200 200, 300 300)",
