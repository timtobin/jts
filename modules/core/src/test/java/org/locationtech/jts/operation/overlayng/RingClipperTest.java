...
public class RingClipperTest extends GeometryTestCase {
	...
	public void testClipCompletely() {
		checkClip("POLYGON ((2 9, 7 27, 26 34, 45 10, 26 9, 17 -7, 14 4, 2 9))", new Envelope(10, 20, 10, 20),
				"LINESTRING (10 20, 20 20, 20 10, 10 10, 10 20)");
	}

	@Test
	public void testEmptyEnv() {
		checkClip("POLYGON ((2 9, 7 27, 26 34, 45 10, 26 9, 17 -7, 14 4, 2 9))", new Envelope(), "LINESTRING EMPTY");
	}

	@Test
	public void testInside() {
		checkClip("POLYGON ((12 13, 13 17, 18 17, 15 16, 17 12, 14 14, 12 13))", new Envelope(10, 20, 10, 20),
				"LINESTRING (12 13, 13 17, 18 17, 15 16, 17 12, 14 14, 12 13)");
	}

	@Test
	public void testPointEnv() {
		checkClip("POLYGON ((2 9, 7 27, 26 34, 45 10, 26 9, 17 -7, 14 4, 2 9))", new Envelope(10, 10, 10, 10),
				"LINESTRING EMPTY");
	}

	@Test
	public void testStarClipped() {
		checkClip("POLYGON ((7 15, 12 18, 15 23, 18 18, 24 15, 18 12, 15 7, 12 12, 7 15))",
	...
	public void testWrapPartial() {
		checkClip("POLYGON ((30 60, 60 60, 40 80, 40 110, 110 110, 110 80, 90 60, 120 60, 120 120, 30 120, 30 60))",
				new Envelope(50, 100, 50, 100),
