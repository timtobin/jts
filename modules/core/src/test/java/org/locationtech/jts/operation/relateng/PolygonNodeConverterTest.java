...
public class PolygonNodeConverterTest extends GeometryTestCase {
	...
	private NodeSection section(int ringId, double v0x, double v0y, double nx, double ny, double v1x, double v1y) {
		return new NodeSection(true, Dimension.A, 1, ringId, null, false, new Coordinate(v0x, v0y),
				new Coordinate(nx, ny), new Coordinate(v1x, v1y));
	}
	...
	public void testHoles() {
		checkConversion(collect(sectionHole(7, 0, 5, 5, 6, 0), sectionHole(4, 0, 5, 5, 3, 0)),
	...
	public void testShellAnd2Holes() {
		checkConversion(
				collect(sectionShell(1, 1, 5, 5, 9, 9), sectionHole(7, 0, 5, 5, 6, 0), sectionHole(4, 0, 5, 5, 3, 0)),
				collect(sectionShell(1, 1, 5, 5, 3, 0), sectionShell(4, 0, 5, 5, 6, 0),
						sectionShell(7, 0, 5, 5, 9, 9)));
	}

	@Test
	public void testShellAndHole() {
		checkConversion(collect(sectionShell(1, 1, 5, 5, 9, 9), sectionHole(6, 0, 5, 5, 4, 0)),
	...
	public void testShells() {
		checkConversion(
				collect(sectionShell(1, 1, 5, 5, 9, 9), sectionShell(8, 9, 5, 5, 6, 9), sectionShell(4, 9, 5, 5, 2, 9)),
				collect(sectionShell(1, 1, 5, 5, 9, 9), sectionShell(8, 9, 5, 5, 6, 9),
	...
	public void testShellsAndHoles() {
		checkConversion(
				collect(sectionShell(1, 1, 5, 5, 9, 9), sectionHole(6, 0, 5, 5, 4, 0), sectionShell(8, 8, 5, 5, 1, 8),
						sectionHole(4, 8, 5, 5, 6, 8)),
				collect(sectionShell(1, 1, 5, 5, 4, 0), sectionShell(6, 0, 5, 5, 9, 9), sectionShell(4, 8, 5, 5, 1, 8),
