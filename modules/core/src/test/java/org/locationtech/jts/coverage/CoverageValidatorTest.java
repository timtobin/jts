...
public class CoverageValidatorTest extends GeometryTestCase {
	...
	public void testCollinearUnmatchedEdge() {
		checkInvalid(
				readArray("POLYGON ((100 200, 200 200, 200 100, 100 100, 100 200))",
	...
	public void testFullyCoveredTriangles() {
		checkInvalid(
				readArray("POLYGON ((1 9, 9 1, 1 1, 1 9))", "POLYGON ((9 9, 1 9, 9 1, 9 9))",
						"POLYGON ((9 9, 9 1, 1 1, 1 9, 9 9))"),
				readArray("LINESTRING (9 1, 1 1, 1 9)", "LINESTRING (9 1, 9 9, 1 9)",
	...
	public void testGap() {
		checkInvalidWithGaps(
				readArray("POLYGON ((1 5, 9 5, 9 1, 1 1, 1 5))", "POLYGON ((1 9, 5 9, 5 5.1, 1 5, 1 9))",
						"POLYGON ((5 9, 9 9, 9 5, 5.5 5.1, 5 9))"),
				0.5,
				readArray("LINESTRING (1 5, 9 5)", "LINESTRING (1 5, 5 5.1, 5 9)", "LINESTRING (5 9, 5.5 5.1, 9 5)"));
	}
	...
	public void testGapDisjoint() {
		checkInvalidWithGaps(
				readArray("POLYGON ((1 5, 9 5, 9 1, 1 1, 1 5))", "POLYGON ((1 9, 5 9, 5 5.1, 1 5.1, 1 9))",
						"POLYGON ((5 9, 9 9, 9 5.1, 5 5.1, 5 9))"),
				0.5, readArray("LINESTRING (1 5, 9 5)", "LINESTRING (5 5.1, 1 5.1)", "LINESTRING (9 5.1, 5 5.1)"));
	}

	@Test
	public void testGore() {
		checkInvalidWithGaps(
				readArray("POLYGON ((1 5, 5 5, 9 5, 9 1, 1 1, 1 5))", "POLYGON ((1 9, 5 9, 5 5, 1 5.1, 1 9))",
						"POLYGON ((5 9, 9 9, 9 5, 5 5, 5 9))"),
				0.5, readArray("LINESTRING (1 5, 5 5)", "LINESTRING (1 5.1, 5 5)", null));
	}

	@Test
	public void testGrid() {
		checkValid(readArray("POLYGON ((1 9, 5 9, 5 5, 1 5, 1 9))", "POLYGON ((9 9, 9 5, 5 5, 5 9, 9 9))",
				"POLYGON ((1 1, 1 5, 5 5, 5 1, 1 1))", "POLYGON ((9 1, 5 1, 5 5, 9 5, 9 1))"));
	}

	@Test
	public void testMultiPolygon() {
		checkValid(readArray("MULTIPOLYGON (((1 9, 5 9, 5 5, 1 5, 1 9)), ((9 1, 5 1, 5 5, 9 5, 9 1)))",
	...
	public void testOverlappingSquares() {
		checkInvalid(readArray("POLYGON ((1 9, 6 9, 6 4, 1 4, 1 9))", "POLYGON ((9 1, 4 1, 4 6, 9 6, 9 1))"),
	...
	public void testPolygonEmpty() {
		checkValid(readArray("POLYGON ((1 9, 5 9, 5 5, 1 5, 1 9))", "POLYGON ((9 9, 9 5, 5 5, 5 9, 9 9))",
				"POLYGON ((1 1, 1 5, 5 5, 5 1, 1 1))", "POLYGON EMPTY"));
	}

	@Test
	public void testRingCollapse() {
		checkValid(readArray("POLYGON ((1 9, 5 9, 1 9))", "POLYGON ((9 9, 9 5, 5 5, 5 9, 9 9))",
				"POLYGON ((1 1, 1 5, 5 5, 5 1, 1 1))", "POLYGON ((9 1, 5 1, 5 5, 9 5, 9 1))"));
	}

	@Test
	public void testValidDuplicatePoints() {
		checkValid(readArray("POLYGON ((1 9, 5 9, 5 5, 1 5, 1 5, 1 5, 1 9))", "POLYGON ((9 9, 9 5, 5 5, 5 9, 9 9))",
				"POLYGON ((1 1, 1 5, 5 5, 5 1, 1 1))", "POLYGON ((9 1, 5 1, 5 5, 9 5, 9 1))"));
	}
}
