...
public class ConcaveHullTest extends GeometryTestCase {
	private static final String WKT_CIRCLE = "MULTIPOINT ((90 20), (80 10), (45 5), (10 20), (20 10), (21 30), (40 20), (11 60), (20 70), (20 90), (40 80), (70 80), (80 60), (90 70), (80 90), (56 95), (95 45), (80 40), (70 20), (15 45), (5 40), (40 96), (60 15))";

	private static final String WKT_SIMPLE = "MULTIPOINT ((14 18), (18 14), (15 6), (15 2), (5 5), (3 13), (8 14), (8 10), (16 8))";
	...
	public void testAlphaSimple() {
		checkAlphaShape(WKT_SIMPLE, 4, "POLYGON ((5 5, 3 13, 8 14, 14 18, 18 14, 16 8, 8 10, 15 6, 15 2, 5 5))");
	}
	...
	public void testLenRatioCShape() {
		checkHullByLengthRatio(
				...
				0.2,
				"POLYGON ((20 40, 30 70, 50 80, 80 90, 90 70, 70 80, 41 67, 40 50, 40 30, 90 20, 50 10, 30 20, 20 40))");
	}
	...
	public void testLenRatioXYZChevronP5() {
		checkHullByLengthRatioXYZ("MULTIPOINT Z ((10 10 1), (90 10 2), (30 70 3), (70 70 4), (50 60 5))", 0.5,
				"POLYGON Z ((30 70 3, 70 70 4, 90 10 2, 50 60 5, 10 10 1, 30 70 3))");
	}
	...
	public void testLengthChevron() {
		checkHullByLength("MULTIPOINT ((10 10), (90 10), (30 70), (70 70), (50 60))", 70,
				"POLYGON ((30 70, 70 70, 90 10, 50 60, 10 10, 30 70))");
	}

	@Test
	public void testLengthCollinear() {
		checkHullByLength("LINESTRING (10 10, 20 20, 30 30))", 70, "LINESTRING (10 10, 30 30)");
	}

	@Test
	public void testLengthConvex() {
		checkHullByLength("MULTIPOINT ((10 10), (90 10), (70 70), (50 60), (50 90), (40 70), (30 30))", 100,
				"POLYGON ((10 10, 40 70, 50 90, 70 70, 90 10, 10 10))");
	}

	@Test
	public void testLengthEmpty() {
		checkHullByLength("MULTIPOINT EMPTY", 70, "POLYGON EMPTY");
	}
	...
	public void testLengthPoint() {
		checkHullByLength("MULTIPOINT ((10 10), (10 10))", 70, "POINT (10 10)");
	}

	@Test
	public void testLengthSimple() {
		checkHullByLength(WKT_SIMPLE, 8, "POLYGON ((8 10, 5 5, 3 13, 8 14, 14 18, 18 14, 16 8, 15 2, 15 6, 8 10))");
	}

	@Test
	public void testLengthTriangle() {
		checkHullByLength("MULTIPOINT ((10 10), (90 10), (30 70))", 70, "POLYGON ((10 10, 30 70, 90 10, 10 10))");
	}

	@Test
	public void testLengthZero() {
		checkHullByLength("MULTIPOINT ((10 10), (90 10), (70 70), (50 60), (50 90), (40 70), (30 30))", 0,
				"POLYGON ((10 10, 40 70, 50 90, 70 70, 90 10, 50 60, 30 30, 10 10))");
	}
	...
	public void testRobust_GEOS946() {
		checkHullByLengthRatio(
				...
				0.75,
				"POLYGON ((113.56571548761124 22.80081531771092, 113.565723279387 22.800815316487014, 113.56577197798602 22.80081530883069, 113.56577197817877 22.8008153088047, 113.56571548780202 22.800815317674463, 113.56571548761124 22.80081531771092))");
	}
	...
	public void testRobust_GEOS946_2() {
		checkHullByLengthRatio(
				...
				0.75,
				"POLYGON ((584227.74314188 7549592.83423486, 584239.72795377 7549593.43742855, 584242.72446125 7549593.58214511, 584245.72096874 7549593.72686167, 584251.71398371 7549594.01629478, 584230.73978847 7549592.9760418, 584227.74314188 7549592.83423486))");
	}
}
