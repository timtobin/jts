...
public class ConcaveHullTest extends GeometryTestCase {
  ...
  public void testLengthTriangle() {
    checkHullByLength(
        "MULTIPOINT ((10 10), (90 10), (30 70))", 70, "POLYGON ((10 10, 30 70, 90 10, 10 10))");
  }

  @Test
  public void testLengthChevron() {
    checkHullByLength(
        "MULTIPOINT ((10 10), (90 10), (30 70), (70 70), (50 60))",
        70,
  ...
  public void testLengthZero() {
    checkHullByLength(
        "MULTIPOINT ((10 10), (90 10), (70 70), (50 60), (50 90), (40 70), (30 30))",
        0,
  ...
  public void testLenRatioOne() {
    checkHullByLengthRatio(
        "MULTIPOINT ((10 90), (10 10), (90 10), (90 90), (40 40), (60 30), (30 70), (40 60), (60 50), (60 72), (47 66), (90 60))",
        1,
        "POLYGON ((10 10, 10 90, 90 90, 90 60, 90 10, 10 10))");
  }

  @Test
  public void testLenRatioXYZChevronP5() {
    checkHullByLengthRatioXYZ(
        "MULTIPOINT Z ((10 10 1), (90 10 2), (30 70 3), (70 70 4), (50 60 5))",
        0.5,
  ...
  private static final String WKT_SIMPLE =
      "MULTIPOINT ((14 18), (18 14), (15 6), (15 2), (5 5), (3 13), (8 14), (8 10), (16 8))";
  private static final String WKT_CIRCLE =
  ...
  public void testLengthSimple() {
    checkHullByLength(
        WKT_SIMPLE, 8, "POLYGON ((8 10, 5 5, 3 13, 8 14, 14 18, 18 14, 16 8, 15 2, 15 6, 8 10))");
  }

  @Test
  public void testAlphaSimple() {
    checkAlphaShape(
        WKT_SIMPLE, 4, "POLYGON ((5 5, 3 13, 8 14, 14 18, 18 14, 16 8, 8 10, 15 6, 15 2, 5 5))");
  }
  ...
  private void checkAlphaShape(
      String wkt, double alpha, boolean isHolesAllowed, String wktExpected) {
    Geometry geom = read(wkt);
