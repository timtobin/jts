...
public class CoveragePolygonValidatorTest extends GeometryTestCase {
	...
	private void checkInvalidGap(String wktTarget, String wktAdj, double gapWidth, String wktExpected) {
		Geometry target = read(wktTarget);
		Geometry adj = read(wktAdj);
		Geometry[] adjPolygons = extractPolygons(adj);
	...
	public void testAdjVertexTouchesSegment() {
		checkInvalid("POLYGON ((1 1, 5 5, 9 1, 1 1))", "POLYGON ((1 9, 9 9, 9 5, 1 5, 1 9))",
	...
	public void testAdjacentHoleOverlap() {
		checkInvalid("POLYGON ((3 3, 3 7, 6 8, 7 3, 3 3))",
				"POLYGON ((1 9, 9 9, 9 1, 1 1, 1 9), (3 7, 7 7, 7 3, 3 3, 3 7))", "LINESTRING (3 7, 6 8, 7 3)");
	}
	...
	public void testCollinearUnmatchedEdge() {
		checkInvalid("POLYGON ((100 200, 200 200, 200 100, 100 100, 100 200))",
				"POLYGON ((100 300, 180 300, 180 200, 100 200, 100 300))", "LINESTRING (100 200, 200 200)");
	}
	...
	public void testCrossingAndInteriorSegments() {
		checkInvalid("POLYGON ((1 1, 3 4, 7 4, 9 1, 1 1))", "POLYGON ((1 9, 9 9, 9 3, 1 3, 1 9))",
				"LINESTRING (1 1, 3 4, 7 4, 9 1)");
	}

	@Test
	public void testCrossingSegment() {
		checkInvalid("POLYGON ((1 9, 9 9, 9 3, 1 3, 1 9))", "POLYGON ((1 1, 5 6, 9 1, 1 1))", "LINESTRING (1 3, 9 3)");
	}
	...
	public void testFullyContained() {
		checkInvalid("POLYGON ((3 7, 7 7, 7 3, 3 3, 3 7))", "POLYGON ((1 9, 9 9, 9 1, 1 1, 1 9))",
	...
	@Test
	public void testGap() {
		checkInvalidGap("POLYGON ((1 5, 9 5, 9 1, 1 1, 1 5))", "POLYGON ((1 9, 5 9, 5 5.1, 1 5, 1 9))", 0.5,
				"LINESTRING (1 5, 9 5)");
	}

	@Test
	public void testInteriorSegmentTouchingEdge() {
		checkInvalid("POLYGON ((4 3, 4 7, 8 9, 8 1, 4 3))", "POLYGON ((1 7, 6 7, 6 3, 1 3, 1 7))",
				"LINESTRING (8 1, 4 3, 4 7, 8 9)");
	}

	@Test
	public void testInteriorSegmentTouchingNodes() {
		checkInvalid("POLYGON ((4 2, 4 8, 8 9, 8 1, 4 2))", "POLYGON ((1 5, 4 8, 7 5, 4 2, 1 5))",
				"LINESTRING (4 2, 4 8)");
	}

	@Test
	public void testInteriorSegmentsTouching() {
		checkInvalid("POLYGON ((1 9, 5 9, 8 7, 5 7, 3 5, 8 2, 1 2, 1 9))", "POLYGON ((5 9, 9 9, 9 1, 5 1, 5 9))",
	...
	/**
	 * Shows need to evaluate both start and end point of intersecting segments in
	 * InvalidSegmentDetector, since matched segments are not tested
	 */
	@Test
	...
	public void testRepeatedCommonVertexInAdjacent() {
		checkValid("POLYGON ((1 1, 1 3, 5 3, 9 1, 1 1))", "POLYGON ((1 9, 9 9, 9 5, 5 3, 5 3, 1 3, 1 9))");
	}

	// -- confirms zero-length segments are skipped in processing
	@Test
	public void testRepeatedCommonVertexInTarget() {
		checkValid("POLYGON ((1 1, 1 3, 5 3, 5 3, 9 1, 1 1))", "POLYGON ((1 9, 9 9, 9 5, 5 3, 1 3, 1 9))");
	}

	@Test
	public void testRingsCCW() {
		checkValid("POLYGON ((1 1, 6 5, 4 9, 1 9, 1 1))", "POLYGON ((1 1, 9 1, 9 4, 6 5, 1 1))");
	}
	...
	public void testTargetHoleOverlap() {
		checkInvalid("POLYGON ((1 1, 1 9, 9 9, 9 1, 1 1), (2 2, 8 2, 8 8, 5 4, 3 5, 2 5, 2 2))",
				"POLYGON ((2 2, 2 5, 3 5, 8 6.7, 8 2, 2 2))", "LINESTRING (8 2, 8 8, 5 4, 3 5)");
	}
	...
	public void testTargetVertexTouchesSegment() {
		checkInvalid("POLYGON ((1 9, 9 9, 9 5, 1 5, 1 9))", "POLYGON ((1 1, 5 5, 9 1, 1 1))", "LINESTRING (9 5, 1 5)");
	}
}
