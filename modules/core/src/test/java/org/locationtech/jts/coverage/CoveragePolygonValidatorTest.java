...
public class CoveragePolygonValidatorTest extends GeometryTestCase {
  ...
  public void testInteriorSegmentsTouching() {
    checkInvalid(
        "POLYGON ((1 9, 5 9, 8 7, 5 7, 3 5, 8 2, 1 2, 1 9))",
  ...
  public void testTargetMultiPolygon() {
    checkInvalid(
        "MULTIPOLYGON (((4 8, 9 9, 9 7, 4 8)), ((3 5, 9 6, 9 4, 3 5)), ((2 2, 9 3, 9 1, 2 2)))",
  ...
  public void testTargetHoleOverlap() {
    checkInvalid(
        "POLYGON ((1 1, 1 9, 9 9, 9 1, 1 1), (2 2, 8 2, 8 8, 5 4, 3 5, 2 5, 2 2))",
  ...
  public void testTargetCoveredAndMatching() {
    checkInvalid(
        "POLYGON ((1 7, 5 7, 9 7, 9 3, 5 3, 1 3, 1 7))",
  ...
  public void testRepeatedCommonVertexInTarget() {
    checkValid(
        "POLYGON ((1 1, 1 3, 5 3, 5 3, 9 1, 1 1))", "POLYGON ((1 9, 9 9, 9 5, 5 3, 1 3, 1 9))");
  }
  ...
  public void testRepeatedCommonVertexInAdjacent() {
    checkValid(
        "POLYGON ((1 1, 1 3, 5 3, 9 1, 1 1))", "POLYGON ((1 9, 9 9, 9 5, 5 3, 5 3, 1 3, 1 9))");
  }
  ...
  private void checkInvalidGap(
      String wktTarget, String wktAdj, double gapWidth, String wktExpected) {
    Geometry target = read(wktTarget);
    Geometry adj = read(wktAdj);
    Geometry[] adjPolygons = extractPolygons(adj);
