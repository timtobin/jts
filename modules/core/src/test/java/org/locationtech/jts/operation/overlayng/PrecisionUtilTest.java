...
public class PrecisionUtilTest extends GeometryTestCase {
	private void checkRobustScale(String wktA, String wktB, double scaleExpected, double safeScaleExpected,
	...
	public void testDecimalsAllLong() {
		checkRobustScale("POINT( 1.123451234512345 1.123451234512345 )",
				"POINT( 10.123451234512345 10.123451234512345 )", 1e12, 1e12, 1e15);
	}
