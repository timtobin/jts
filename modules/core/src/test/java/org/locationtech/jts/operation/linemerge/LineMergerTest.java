...
public class LineMergerTest {
	...
	@Test
	public void test1() {
		doTest(new String[]{"LINESTRING (120 120, 180 140)", "LINESTRING (200 180, 180 140)",
				"LINESTRING (200 180, 240 180)"}, new String[]{"LINESTRING (120 120, 180 140, 200 180, 240 180)"});
	}

	@Test
	public void test2() {
		doTest(new String[]{"LINESTRING (120 300, 80 340)", "LINESTRING (120 300, 140 320, 160 320)",
				...
				new String[]{"LINESTRING (160 320, 180 340, 200 320, 180 300, 160 320)",
	...
	public void testSingleUniquePoint() {
		doTest(new String[]{"LINESTRING (10642 31441, 10642 31441)", "LINESTRING EMPTY"}, new String[]{});
	}
}
