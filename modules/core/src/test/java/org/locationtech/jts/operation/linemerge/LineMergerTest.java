...
public class LineMergerTest {
  ...
  public void testSingleUniquePoint() {
    doTest(
        new String[] {"LINESTRING (10642 31441, 10642 31441)", "LINESTRING EMPTY"},
        new String[] {});
  }
  ...
  public static void doTest(
      String[] inputWKT, String[] expectedOutputWKT, boolean compareDirections) {
  ...
  public static void compare(
      Collection expectedGeometries, Collection actualGeometries, boolean compareDirections) {
    assertEquals(
        expectedGeometries.size(), actualGeometries.size(), "Geometry count, " + actualGeometries);
