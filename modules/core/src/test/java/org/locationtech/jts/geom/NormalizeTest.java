...
public class NormalizeTest {
	...
	public void testNormalizeLineString1() throws Exception {
		...
		l.normalize();
		LineString expectedValue = (LineString) reader.read("LINESTRING (20 20, 160 40, 160 100, 100 120, 60 60)");
		assertEqualsExact(expectedValue, l);
	}
	...
	public void testNormalizeLineString3() throws Exception {
		...
		l.normalize();
		LineString expectedValue = (LineString) reader.read("LINESTRING (80 80, 160 80, 80 160, 140 160, 200 240)");
		assertEqualsExact(expectedValue, l);
	}
	...
	public void testNormalizeLineString5() throws Exception {
		LineString l = (LineString) reader.read("LINESTRING (200 340, 140 240, 140 160, 60 240, 140 240, 200 340)");
		l.normalize();
		LineString expectedValue = (LineString) reader
				.read("LINESTRING (200 340, 140 240, 60 240, 140 160, 140 240, 200 340)");
		assertEqualsExact(expectedValue, l);
	}
