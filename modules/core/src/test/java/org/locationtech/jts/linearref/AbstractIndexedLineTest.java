...
public abstract class AbstractIndexedLineTest {
	...
	/**
	 * Checks that the point computed by <tt>indexOfAfter</tt> is the same as the
	 * input point. (This should be the case for all except pathological cases, such
	 * as the input test point being beyond the end of the line).
	 *
	 * @param input
	 *            geometry
	 * @param testPt
	...
	/**
	 * Following tests check that correct portion of loop is identified. This
	 * requires that the correct vertex for (0,0) is selected.
	 */
	@Test
