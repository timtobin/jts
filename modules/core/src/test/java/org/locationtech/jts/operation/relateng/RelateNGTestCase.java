...
public abstract class RelateNGTestCase extends GeometryTestCase {
	...
	void checkPrepared(String wkta, String wktb) {
		...
		assertEquals(prep_a.evaluate(b, RelatePredicate.equalsTopo()),
				RelateNG.relate(a, b, RelatePredicate.equalsTopo()), "equalsTopo");

		assertEquals(prep_a.evaluate(b, RelatePredicate.intersects()),
				RelateNG.relate(a, b, RelatePredicate.intersects()), "intersects");
		assertEquals(prep_a.evaluate(b, RelatePredicate.disjoint()), RelateNG.relate(a, b, RelatePredicate.disjoint()),
				"disjoint");
		assertEquals(prep_a.evaluate(b, RelatePredicate.covers()), RelateNG.relate(a, b, RelatePredicate.covers()),
				"covers");
		assertEquals(prep_a.evaluate(b, RelatePredicate.coveredBy()),
				RelateNG.relate(a, b, RelatePredicate.coveredBy()), "coveredBy");
		assertEquals(prep_a.evaluate(b, RelatePredicate.within()), RelateNG.relate(a, b, RelatePredicate.within()),
				"within");
		assertEquals(prep_a.evaluate(b, RelatePredicate.contains()), RelateNG.relate(a, b, RelatePredicate.contains()),
				"contains");
		assertEquals(prep_a.evaluate(b, RelatePredicate.crosses()), RelateNG.relate(a, b, RelatePredicate.crosses()),
				"crosses");
		assertEquals(prep_a.evaluate(b, RelatePredicate.touches()), RelateNG.relate(a, b, RelatePredicate.touches()),
				"touches");
	...
	void checkPreparedMatches(String wkta, String wktb, String pattern) {
		...
		assertEquals(prep_a.evaluate(b, RelatePredicate.matches(pattern)),
				RelateNG.relate(a, b, RelatePredicate.matches(pattern)), "matches " + pattern);
	}
