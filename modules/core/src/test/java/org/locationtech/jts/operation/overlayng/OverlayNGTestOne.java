...
public class OverlayNGTestOne extends GeometryTestCase {
	...
	/**
	 * A component of B collapses completely. Labelling marks a single collapsed
	 * edge as B:i. Edge is only connected to two other edges both marked B:e. B:i
	 * edge is included in area result edges, and faild because it does not form a
	 * ring.
	 *
	 * <p>
	 ...
	 *
	 * <p>
	 * FIXED by requiring both endpoints of edge to lie in Interior to be located as
	 * i
	 */
	 ...
	 * for incomplete edges. That edge is then marked as in-result-area, but result
	 * ring can't be formed because ring is incomplete
	 */
	 ...
	 * identical, so merges the 3pt edge into the 2-pt edge
	 */
