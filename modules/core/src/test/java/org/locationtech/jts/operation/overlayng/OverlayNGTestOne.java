...
public class OverlayNGTestOne extends GeometryTestCase {
  ...
  public void testCollapseTriBoxesIntersection() {
    ...
    Geometry expected =
        read("GEOMETRYCOLLECTION (LINESTRING (1 2, 2 2), POLYGON ((9 2, 9 3, 10 3, 10 2, 9 2)))");
    Geometry actual = intersection(a, b, 1);
    checkEqual(expected, actual);
  }
  ...
  public void xtestCollapseBoxCutByTriangleUnion() {
    ...
    Geometry expected =
        read(
            "MULTIPOLYGON (((0 0, 0 10, 0 20, 20 20, 20 10, 20 0, 0 0)), ((20 10, 100 11, 100 10, 20 10)))");
  ...
  public void xtestCollapseBoxTriangleUnion() {
    ...
    Geometry expected =
        read(
            "MULTIPOLYGON (((90 10, 10 10, 10 11, 90 10)), ((90 10, 90 200, 200 200, 200 0, 90 0, 90 10)))");
    checkEqual(expected, OverlayNGTest.union(a, b, 1));
  }
  ...
  public void xtestPolyPolyTouchIntersection() {
    ...
    Geometry expected =
        read(
            "GEOMETRYCOLLECTION (LINESTRING (200 100, 300 100), POLYGON ((200 0, 100 0, 100 100, 200 100, 200 0)))");
    checkEqual(expected, OverlayNGTest.intersection(a, b, 1));
  }
  ...
  public void xtestPolygonPointUnion() {
    ...
    Geometry expected =
        read(
            "GEOMETRYCOLLECTION (POINT (250 150), POLYGON ((100 200, 200 200, 200 100, 100 100, 100 200)))");
  ...
  public void xtestLinePolygonIntersectionAlongCollapse() {
    Geometry a =
        read(
            "POLYGON ((100 300, 300 300, 300 200, 130 200, 300 199.9, 300 100, 100 100, 100 300))");
  ...
  public void xtestMultiHoleBoxUnion() {
    Geometry a =
        read(
            "MULTIPOLYGON (((0 200, 200 200, 200 0, 0 0, 0 200), (50 50, 190 50, 50 200, 50 50), (20 20, 20 50, 50 50, 50 20, 20 20)), ((60 100, 50 50, 100 60, 60 100)))");
  ...
  public void xtestMultiHoleSideTouchingBoxUnion() {
    Geometry a =
        read(
            "MULTIPOLYGON (((0 200, 200 200, 200 0, 0 0, 0 200), (50 50, 190 50, 50 200, 50 50), (20 20, 20 50, 50 50, 50 20, 20 20)))");
  ...
  public void xtestBoxContainingPolygonCollapseManyPtsIntersection() {
    ...
    Geometry expected =
        read("MULTILINESTRING ((150 100, 160 100), (160 100, 170 100), (170 100, 250 100))");
    Geometry actual = intersection(a, b, 1);
    checkEqual(expected, actual);
  }
  ...
  public void xtestPolygonsSpikeCollapseIntersection() {
    Geometry a =
        read(
            "POLYGON ((2.33906 48.78994, 2.33768 48.78857, 2.33768 48.78788, 2.33974 48.78719, 2.34009 48.78616, 2.33974 48.78513, 2.33871 48.78479, 2.33734 48.78479, 2.33631 48.78445, 2.33597 48.78342, 2.33631 48.78239, 2.337 48.7817, 2.33734 48.78067, 2.33734 48.7793, 2.337 48.77827, 2.3178 48.7849, 2.32099 48.79376, 2.33906 48.78994))");
    Geometry b =
        read(
            "POLYGON ((2.33768 48.78857, 2.33768 48.78788, 2.33974 48.78719, 2.34009 48.78616, 2.33974 48.78513, 2.33871 48.78479, 2.33734 48.78479, 2.33631 48.78445, 2.3362 48.7841, 2.33562 48.78582, 2.33425 48.78719, 2.33768 48.78857))");
    Geometry expected =
        read("MULTILINESTRING ((150 100, 160 100), (160 100, 170 100), (170 100, 250 100))");
   ...
   * then marked as in-result-area, but result ring can't be formed because ring is incomplete
   */
  ...
  /**
   * A component of B collapses completely. Labelling marks a single collapsed edge as B:i. Edge is
   * only connected to two other edges both marked B:e. B:i edge is included in area result edges,
   * and faild because it does not form a ring.
   *
   ...
   *
   * <p>FIXED by requiring both endpoints of edge to lie in Interior to be located as i
   */
  ...
  public void xtestLineFigure8Union() {
    ...
    Geometry expected =
        read("MULTILINESTRING ((5 3, 2 2, 5 1, 8 2, 5 3), (5 3, 2 4, 5 5, 8 4, 5 3))");
    Geometry actual = union(a, b, 1);
    checkEqual(expected, actual);
  }
   ...
   * A hole edge, but because labeled E are not included in Intersection result.
   */
