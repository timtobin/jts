...
public class CoverageCleanerTest extends GeometryTestCase {
  ...
  public void testSingleNearMatch() {
    checkCleanSnap(
        readArray("POLYGON ((1 9, 9 9, 9 4.99, 1 5, 1 9))", "POLYGON ((1 1, 1 5, 9 5, 9 1, 1 1))"),
        0.1);
  }
  ...
  public void testPolygonSnappedPreserved() {
    checkCleanSnap(
        readArray("POLYGON ((90 0, 10 0, 89.99 30, 90 100, 90 0))"),
        0.1,
  ...
  public void testPolygonsSnappedPreserved() {
    checkCleanSnap(
        readArray(
            "POLYGON ((0 0, 0 2, 5 2, 5 8, 5.01 0, 0 0))", "POLYGON ((0 8, 5 8, 5 2, 0 2, 0 8))"),
        0.02,
        readArray("POLYGON ((0 0, 0 2, 5 2, 5.01 0, 0 0))", "POLYGON ((0 8, 5 8, 5 2, 0 2, 0 8))"));
  }
  ...
  String covWithOverlap =
      "GEOMETRYCOLLECTION (POLYGON ((1 3, 5 3, 4 1, 1 1, 1 3)), POLYGON ((1 3, 1 9, 4 9, 4 3, 3 1.9, 1 3)))";
