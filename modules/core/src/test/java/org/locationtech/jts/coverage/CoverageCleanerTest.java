...
public class CoverageCleanerTest extends GeometryTestCase {
	...
	public void testManyNearMatches() {
		checkCleanSnap(readArray("POLYGON ((1 9, 9 9, 9 5, 8 5, 7 5, 4 5.5, 3 5, 2 5, 1 5, 1 9))",
				"POLYGON ((1 1, 1 4.99, 2 5.01, 3.01 4.989, 5 3, 6.99 4.99, 7.98 4.98, 9 5, 9 1, 1 1))"), 0.1);
	}
	...
	public void testMergeGapWidth_0() {
		checkCleanGapWidth(covWithGaps, 0,
	...
	public void testMergeGapWidth_1() {
		checkCleanGapWidth(covWithGaps, 1,
	...
	public void testMergeGapWidth_2() {
		checkCleanGapWidth(covWithGaps, 2,
	...
	public void testMergeOverlap2() {
		checkCleanSnap(
				readArray("POLYGON ((5 9, 9 9, 9 1, 5 1, 5 9))", "POLYGON ((1 5, 5 5, 5 2, 1 2, 1 5))",
						"POLYGON ((2 7, 5 7, 5 4, 2 4, 2 7))"),
				0.1, readArray("POLYGON ((5 1, 5 2, 5 4, 5 5, 5 7, 5 9, 9 9, 9 1, 5 1))",
						"POLYGON ((5 2, 1 2, 1 5, 2 5, 5 5, 5 4, 5 2))", "POLYGON ((5 5, 2 5, 2 7, 5 7, 5 5))"));
	}
	...
	public void testMergeOverlapMaxArea() {
		checkCleanOverlapMerge(covWithOverlap, CoverageCleaner.MERGE_MAX_AREA,
	...
	public void testMergeOverlapMinArea() {
		checkCleanOverlapMerge(covWithOverlap, CoverageCleaner.MERGE_MIN_AREA,
				"GEOMETRYCOLLECTION (POLYGON ((5 3, 4 1, 1 1, 1 3, 4 3, 5 3)), POLYGON ((1 9, 4 9, 4 3, 1 3, 1 9)))");
	}

	@Test
	public void testMergeOverlapMinId() {
		checkCleanOverlapMerge(covWithOverlap, CoverageCleaner.MERGE_MIN_INDEX,
				"GEOMETRYCOLLECTION (POLYGON ((5 3, 4 1, 1 1, 1 3, 4 3, 5 3)), POLYGON ((1 9, 4 9, 4 3, 1 3, 1 9)))");
	}

	// Tests that if interior point lies in a spike that is snapped away, polygon is
	// still in result
	@Test
	public void testPolygonSnappedPreserved() {
		checkCleanSnap(readArray("POLYGON ((90 0, 10 0, 89.99 30, 90 100, 90 0))"), 0.1,
				readArray("POLYGON ((90 0, 10 0, 89.99 30, 90 0))"));
	}
	...
	public void testPolygonsSnappedCollapse() {
		checkCleanSnap(
				readArray("POLYGON ((1 1, 1 9, 6 5, 9 1, 1 1))", "POLYGON ((9 1, 6 5.1, 1 9, 9 9, 9 1))",
						"POLYGON ((9 1, 6 5, 1 9, 6 5.1, 9 1))"),
				1, readArray("POLYGON ((6 5, 9 1, 1 1, 1 9, 6 5))", "POLYGON ((9 9, 9 1, 6 5, 1 9, 9 9))",
						"POLYGON EMPTY"));
	}
	...
	public void testPolygonsSnappedPreserved() {
		checkCleanSnap(readArray("POLYGON ((0 0, 0 2, 5 2, 5 8, 5.01 0, 0 0))", "POLYGON ((0 8, 5 8, 5 2, 0 2, 0 8))"),
				0.02, readArray("POLYGON ((0 0, 0 2, 5 2, 5.01 0, 0 0))", "POLYGON ((0 8, 5 8, 5 2, 0 2, 0 8))"));
	}

	@Test
	public void testSingleNearMatch() {
		checkCleanSnap(readArray("POLYGON ((1 9, 9 9, 9 4.99, 1 5, 1 9))", "POLYGON ((1 1, 1 5, 9 5, 9 1, 1 1))"), 0.1);
	}
