...
public class OverlayNGZTest extends GeometryTestCase {
	...
	public void testLineIntersectionPointZValue() {
		checkIntersection("LINESTRING (0 0 0, 10 10 10)", "LINESTRING (10 0 0, 5 5 999, 0 10 10)", "POINT(5 5 999)");
	}
	...
	public void testPointPolygonIntersection() {
		checkIntersection("POINT Z (5 5 99)", "POLYGON Z ((1 9 5, 9 9 9, 9 1 5, 1 1 1, 1 9 5))", "POINT Z(5 5 99)");
	}
	...
	public void testPointXYPolygonIntersection() {
		checkIntersection("POINT (5 5)", "POLYGON Z ((1 9 50, 9 9 90, 9 1 50, 1 1 10, 1 9 50))", "POINT Z(5 5 50)");
	}
