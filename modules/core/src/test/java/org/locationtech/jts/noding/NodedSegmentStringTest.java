...
public class NodedSegmentStringTest extends GeometryTestCase {
  /**
   * Tests a case which involves nodes added when using the SnappingNoder. In this case one of the
   * added nodes is relatively "far" from its segment, and "near" the start vertex of the segment.
   * Computing the noding correctly requires the fix to {@link SegmentNode#compareTo(Object)} added
   * in https://github.com/locationtech/jts/pull/399
   *
   * <p>See https://trac.osgeo.org/geos/ticket/1051
   */
  ...
  private void checkNoding(
      String wktLine, String wktNodes, int[] segmentIndex, String wktExpected) {
