...
public class NodedSegmentStringTest extends GeometryTestCase {
	...
	/**
	 * Tests a case which involves nodes added when using the SnappingNoder. In this
	 * case one of the added nodes is relatively "far" from its segment, and "near"
	 * the start vertex of the segment. Computing the noding correctly requires the
	 * fix to {@link SegmentNode#compareTo(Object)} added in
	 * https://github.com/locationtech/jts/pull/399
	 *
	 * <p>
