...
public class ShewchuksDeterminant {
	...
	private static int fast_expansion_sum_zeroelim(int elen, double[] e, int flen, double[] f,
	 ...
	 * routine returns the orientation index. Otherwise, a value i &gt; 1 is
	 ...
	 * @param pc
	 *            a coordinate
	 * @return the orientation index if it can be computed safely, or i &gt; 1 if
	 *         the orientation index cannot be computed safely
	 */
