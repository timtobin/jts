...
public class BufferParameterTest extends GeometryTestCase {
  ...
  private void checkBuffer(
      String wkt, double dist, int quadSegs, int joinStyle, String wktExpected) {
