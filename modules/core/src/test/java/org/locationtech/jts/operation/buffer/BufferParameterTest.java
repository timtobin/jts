...
public class BufferParameterTest extends GeometryTestCase {
	...
	public void testMitreNarrow0() {
		checkBuffer("LINESTRING (10 20, 20 80, 30 20)", 10.0, bufParamFlatMitre(0),
	...
	public void testMitreNarrow1() {
		checkBuffer("LINESTRING (10 20, 20 80, 30 20)", 10.0, bufParamFlatMitre(1),
	...
	public void testMitreNarrow10() {
		checkBuffer("LINESTRING (10 20, 20 80, 30 20)", 10.0, bufParamFlatMitre(10),
	...
	public void testMitreNarrow5() {
		checkBuffer("LINESTRING (10 20, 20 80, 30 20)", 10.0, bufParamFlatMitre(5),
	...
	public void testMitreObtuse0() {
		checkBuffer("LINESTRING (10 10, 50 20, 90 10)", 1.0, bufParamFlatMitre(0),
	...
	public void testMitreObtuse1() {
		checkBuffer("LINESTRING (10 10, 50 20, 90 10)", 1.0, bufParamFlatMitre(1),
	...
	public void testMitreObtuse2() {
		checkBuffer("LINESTRING (10 10, 50 20, 90 10)", 1.0, bufParamFlatMitre(2),
	...
	public void testMitreSquareCCW1() {
		checkBuffer("POLYGON((0 0, 100 0, 100 100, 0 100, 0 0))", 10.0, bufParamFlatMitre(1),
	...
	public void testQuadSegs0() {
		checkBuffer("LINESTRING (20 20, 80 20, 80 80)", 10.0, 0,
				"POLYGON ((70 30, 70 80, 80 90, 90 80, 90 20, 80 10, 20 10, 10 20, 20 30, 70 30))");
	}

	@Test
	public void testQuadSegs1() {
		checkBuffer("LINESTRING (20 20, 80 20, 80 80)", 10.0, 1,
				"POLYGON ((70 30, 70 80, 80 90, 90 80, 90 20, 80 10, 20 10, 10 20, 20 30, 70 30))");
	}

	@Test
	public void testQuadSegs2() {
		checkBuffer("LINESTRING (20 20, 80 20, 80 80)", 10.0, 2,
	...
	public void testQuadSegs2Bevel() {
		checkBuffer("LINESTRING (20 20, 80 20, 80 80)", 10.0, 2, BufferParameters.JOIN_BEVEL,
	...
	public void testQuadSegsNeg() {
		checkBuffer("LINESTRING (20 20, 80 20, 80 80)", 10.0, -99,
				"POLYGON ((70 30, 70 80, 80 90, 90 80, 90 20, 80 10, 20 10, 10 20, 20 30, 70 30))");
	}
}
