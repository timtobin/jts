...
public class OrientationIndexTest {
	...
	public static Coordinate[] getCoordinates(String wkt) throws ParseException {
		Geometry geom = reader.read(wkt);
		return geom.getCoordinates();
	}

	/**
	 * Tests whether the orientations around a triangle of points are all equal (as
	 * is expected if the orientation predicate is correct)
	 *
	 * @param pts
