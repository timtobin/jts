 ...
 *
 * <p>Successive calls to create may or may not return the same geometry topology.
 *
...
public class PolygonGenerator extends GeometryGenerator {
  ...
  /**
   * As the user increases the number of points, the probability of creating a random valid polygon
   * decreases. Please take not of this when selecting the generation style, and the number of
   * points.
   *
   * <p>May return null if a geometry could not be created.
   *
   * @see #getNumberPoints()
  ...
  private static Polygon createArc(
      double x, double dx, double y, double dy, int nholes, int npoints, GeometryFactory gf) {
  ...
  private static LinearRing createTri(
      double cx, double cy, int startAngle, int endAngle, double radius, GeometryFactory gf) {
  ...
  private static LinearRing createArc(
      double cx, double cy, double radius, int npoints, GeometryFactory gf) {
  ...
  private static Polygon createBox(
      double x, double dx, double y, double dy, int nholes, int npoints, GeometryFactory gf) {
    // make outer ring first
  ...
  private static LinearRing createBox(
      double x, double dx, double y, double dy, int npoints, GeometryFactory gf) {
