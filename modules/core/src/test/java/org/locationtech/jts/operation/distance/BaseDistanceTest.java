...
public abstract class BaseDistanceTest extends GeometryTestCase {
	...
	public void testClosestPoints1() throws Exception {
		checkDistanceNearestPoints("POLYGON ((200 180, 60 140, 60 260, 200 180))", "POINT (140 280)", 57.05597791103589,
				new Coordinate(111.6923076923077, 230.46153846153845), new Coordinate(140, 280));
	}

	@Test
	public void testClosestPoints2() throws Exception {
		checkDistanceNearestPoints("POLYGON ((200 180, 60 140, 60 260, 200 180))", "MULTIPOINT ((140 280), (140 320))",
				57.05597791103589, new Coordinate(111.6923076923077, 230.46153846153845), new Coordinate(140, 280));
	}

	@Test
	public void testClosestPoints3() throws Exception {
		checkDistanceNearestPoints("LINESTRING (100 100, 200 100, 200 200, 100 200, 100 100)", "POINT (10 10)",
				127.27922061357856, new Coordinate(100, 100), new Coordinate(10, 10));
	}

	@Test
	public void testClosestPoints4() throws Exception {
		checkDistanceNearestPoints("LINESTRING (100 100, 200 200)", "LINESTRING (100 200, 200 100)", 0.0,
				new Coordinate(150, 150), new Coordinate(150, 150));
	}

	@Test
	public void testClosestPoints5() throws Exception {
		checkDistanceNearestPoints("LINESTRING (100 100, 200 200)", "LINESTRING (150 121, 200 0)", 20.506096654409877,
				new Coordinate(135.5, 135.5), new Coordinate(150, 121));
	}
	...
	public void testClosestPoints6() throws Exception {
		checkDistanceNearestPoints(
				...
				"LINESTRING (153 204, 185 224, 209 207, 238 222, 254 186)", 13.788860460124573,
				new Coordinate(139.4956500724988, 206.78661188980183), new Coordinate(153, 204));
	}
	...
	public void testClosestPoints7() throws Exception {
		checkDistanceNearestPoints(
				"POLYGON ((76 185, 125 283, 331 276, 324 122, 177 70, 184 155, 69 123, 76 185), (267 237, 148 248, 135 185, 223 189, 251 151, 286 183, 267 237))",
				"LINESTRING (120 215, 185 224, 209 207, 238 222, 254 186)", 0.0, new Coordinate(120, 215),
				new Coordinate(120, 215));
	}
