...
public abstract class BaseDistanceTest extends GeometryTestCase {
  ...
  public void testClosestPoints1() throws Exception {
    checkDistanceNearestPoints(
        ...
        "POINT (140 280)",
        57.05597791103589,
        new Coordinate(111.6923076923077, 230.46153846153845),
        new Coordinate(140, 280));
  }
  ...
  public void testClosestPoints5() throws Exception {
    checkDistanceNearestPoints(
        ...
        20.506096654409877,
        new Coordinate(135.5, 135.5),
        new Coordinate(150, 121));
  }
  ...
  public void testClosestPoints6() throws Exception {
    checkDistanceNearestPoints(
        ...
        13.788860460124573,
        new Coordinate(139.4956500724988, 206.78661188980183),
        new Coordinate(153, 204));
  }
  ...
  private void checkDistanceNearestPoints(
