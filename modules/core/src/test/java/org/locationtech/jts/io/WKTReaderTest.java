...
public class WKTReaderTest extends GeometryTestCase {
	...
	private static CoordinateSequence createSequence(EnumSet<Ordinate> ordinateFlags, double[] xy) {
		...
		CoordinateSequence res = getCSFactory(ordinateFlags).create(size, requiredDimension(ordinateFlags));
	...
	private CoordinateSequence extractCS(Geometry geom) {
		...
		if (geom instanceof LineString string)
			return string.getCoordinateSequence();
		throw new IllegalArgumentException(
				"Can't extract coordinate sequence from geometry of type " + geom.getGeometryType());
	}
	...
	public void testGeometryCollection() throws Exception {
		...
		CoordinateSequence[] css = new CoordinateSequence[]{createSequence(Ordinate.createXY(), coordinates[0]),
		...
		GeometryCollection gc0 = (GeometryCollection) rdr
				.read("GEOMETRYCOLLECTION (POINT (10 10), POINT (30 30), LINESTRING (15 15, 20 20))");
		GeometryCollection gc1 = (GeometryCollection) rdr
				.read("GEOMETRYCOLLECTION (POINT (10 10), LINEARRING EMPTY, LINESTRING (15 15, 20 20))");
		GeometryCollection gc2 = (GeometryCollection) rdr.read(
	...
	public void testLargeNumbers() throws Exception {
		...
		CoordinateSequence point2 = geometryFactory.createPoint(new Coordinate(123456789.01234567890, 10))
	...
	public void testLineString() throws Exception {
		...
		// act
		LineString ls2D = (LineString) readerXY.read("LINESTRING (10 10, 20 20, 30 40)");
		LineString ls2DE = (LineString) readerXY.read("LINESTRING EMPTY");
		LineString ls3D = (LineString) readerXYZ.read("LINESTRING Z(10 10 10, 20 20 10, 30 40 10)");
		LineString ls2DM = (LineString) readerXYM.read("LINESTRING M(10 10 11, 20 20 11, 30 40 11)");
		LineString ls3DM = (LineString) readerXYZM.read("LINESTRING ZM(10 10 10 11, 20 20 10 11, 30 40 10 11)");
	...
	public void testLinearRing() throws Exception {
		...
		// act
		LineString ls2D = (LineString) readerXY.read("LINEARRING (10 10, 20 20, 30 40, 10 10)");
		LineString ls2DE = (LineString) readerXY.read("LINEARRING EMPTY");
		LineString ls3D = (LineString) readerXYZ.read("LINEARRING Z(10 10 10, 20 20 10, 30 40 10, 10 10 10)");
		LineString ls2DM = (LineString) readerXYM.read("LINEARRING M(10 10 11, 20 20 11, 30 40 11, 10 10 11)");
	...
	public void testMultiLineStringXYM() throws Exception {
		MultiLineString mp = (MultiLineString) readerXYM
				.read("MULTILINESTRING M((10 10 11, 20 20 11), (15 15 11, 30 15 11))");
	...
	public void testMultiLineStringXYZ() throws Exception {
		MultiLineString mp = (MultiLineString) readerXYZ
				.read("MULTILINESTRING Z((10 10 10, 20 20 10), (15 15 10, 30 15 10))");
	...
	public void testMultiLineStringYZM() throws Exception {
		MultiLineString mp = (MultiLineString) readerXYZM
				.read("MULTILINESTRING ZM((10 10 10 11, 20 20 10 11), (15 15 10 11, 30 15 10 11))");
	...
	public void testPolygon() throws Exception {
		...
		CoordinateSequence[] csPoly2D = new CoordinateSequence[]{createSequence(Ordinate.createXY(), shell),
				createSequence(Ordinate.createXY(), ring1), createSequence(Ordinate.createXY(), ring2)};
		CoordinateSequence csPoly2DE = createSequence(Ordinate.createXY(), new double[0]);
		CoordinateSequence[] csPoly3D = new CoordinateSequence[]{createSequence(Ordinate.createXYZ(), shell),
				createSequence(Ordinate.createXYZ(), ring1), createSequence(Ordinate.createXYZ(), ring2)};
		CoordinateSequence[] csPoly2DM = new CoordinateSequence[]{createSequence(Ordinate.createXYM(), shell),
				createSequence(Ordinate.createXYM(), ring1), createSequence(Ordinate.createXYM(), ring2)};
		CoordinateSequence[] csPoly3DM = new CoordinateSequence[]{createSequence(Ordinate.createXYZM(), shell),
				createSequence(Ordinate.createXYZM(), ring1), createSequence(Ordinate.createXYZM(), ring2)};

		WKTReader rdr = readerXY;
		Polygon[] poly2D = new Polygon[]{(Polygon) rdr.read("POLYGON ((10 10, 10 20, 20 20, 20 15, 10 10))"),
				(Polygon) rdr
						.read("POLYGON ((10 10, 10 20, 20 20, 20 15, 10 10), (11 11, 12 11, 12 12, 12 11, 11 11))"),
				(Polygon) rdr.read(
