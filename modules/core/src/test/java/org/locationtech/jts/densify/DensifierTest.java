...
public class DensifierTest extends GeometryTestCase {
	...
	/**
	 * Note: it's hard to construct a geometry which would actually be invalid when
	 * densified. This test just checks that the code path executes.
	 *
	 * @param wkt
	...
	@Test
	public void testBox() {
		checkDensify("POLYGON ((10 30, 30 30, 30 10, 10 10, 10 30))", 10,
				"POLYGON ((10 10, 10 20, 10 30, 20 30, 30 30, 30 20, 30 10, 20 10, 10 10))");
	}

	@Test
	public void testBoxNoValidate() {
		checkDensifyNoValidate("POLYGON ((10 30, 30 30, 30 10, 10 10, 10 30))", 10,
				"POLYGON ((10 10, 10 20, 10 30, 20 30, 30 30, 30 20, 30 10, 20 10, 10 10))");
	}
	...
	public void testDimension2d() {
		...
		LineString line = gf.createLineString(new Coordinate[]{new CoordinateXY(1, 2), new CoordinateXY(3, 4)});
	...
	public void testDimension3d() {
		GeometryFactory gf = new GeometryFactory();
		LineString line = gf.createLineString(new Coordinate[]{new Coordinate(1, 2, 3), new Coordinate(3, 4, 5)});
	...
	public void testLine() {
		checkDensify("LINESTRING (0 0, 30 40, 35 35)", 10, "LINESTRING (0 0, 6 8, 12 16, 18 24, 24 32, 30 40, 35 35)");
	}

	@Test
	public void testLineDensify3D() {
		checkDensifyXYZ("POLYGON Z((10 30 10, 30 30 10, 30 10 15, 10 10 10, 10 30 20))", 10,
	...
	public void testLineWithToleranceLengthSeg() {
		checkDensify("LINESTRING (0 0, 12 0, 22 0, 34 0)", 10, "LINESTRING (0 0, 6 0, 12 0, 22 0, 28 0, 34 0)");
	}
