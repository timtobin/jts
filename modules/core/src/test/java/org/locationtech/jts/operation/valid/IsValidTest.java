...
public class IsValidTest extends GeometryTestCase {
  ...
  public void testInvalidSimplePolygonRingSelfIntersection() {
    checkInvalid(
        TopologyValidationError.SELF_INTERSECTION, "POLYGON ((10 90, 90 10, 90 90, 10 10, 10 90))");
  }
   ...
   *
   * <p>See https://github.com/locationtech/jts/issues/843
   */
  ...
  public void testPolygonHoleWithRepeatedShellPointTouchMultiple() {
    checkValid(
        "POLYGON ((90 10, 10 10, 50 90, 50 90, 50 90, 50 90, 90 10), (50 90, 60 30, 40 30, 50 90))");
  }
