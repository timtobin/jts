...
public class IsValidTest extends GeometryTestCase {
	...
	public void testInvalidPolygonSelfCrossing() {
		checkInvalid(TopologyValidationError.SELF_INTERSECTION, "POLYGON ((70 250, 70 500, 80 400, 40 400, 70 250))");
	}

	public void testInvalidSimplePolygonRingSelfIntersection() {
		checkInvalid(TopologyValidationError.SELF_INTERSECTION, "POLYGON ((10 90, 90 10, 90 90, 10 10, 10 90))");
	}
	...
	public void testLinearRingSelfCrossing2() {
		checkInvalid(TopologyValidationError.RING_SELF_INTERSECTION, "LINEARRING (0 0, 100 100, 100 0, 0 100, 0 0)");
	}
