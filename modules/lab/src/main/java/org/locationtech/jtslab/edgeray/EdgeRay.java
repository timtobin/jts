...
class EdgeRay {
	...
	public static double areaTerm(double x0, double y0, double x1, double y1, boolean isNormalToRight) {
		return areaTerm(x0, y0, x0, y0, x1, y1, isNormalToRight);
	}

	public static double areaTerm(double vx, double vy, double x0, double y0, double x1, double y1,
			boolean isNormalToRight) {
