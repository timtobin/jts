 ...
 * {@link Geometry}. This class provides operations which are the methods
 * defined on the Geometry class. Other {@link GeometryOperation} classes can
 * delegate to instances of this class to run standard Geometry methods.
 *
 * @author Martin Davis
 * @version 1.7
 */
