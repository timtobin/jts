...
public class StringUtil {
	...
	/**
	 * Returns the position of the first occurrence of the given character found in
	 * s starting at start. Ignores text within pairs of parentheses. Returns -1 if
	 ...
	 * Set all to true to replace all occurrences, or false to replace the first
	 * occurrence only.
	 */
	...
	/**
	 * Replaces all instances of the String o with the String n in the StringBuffer
	 * orig if all is true, or only the first instance if all is false. Posted by
	...
	/**
	 * Line-wraps a string s by inserting CR-LF instead of the first space after the
	 * nth columns.
	 */
