 ...
 * convenient and noticeable way of flagging the problem when using the
 * TestRunner). All other Geometry methods are executed normally.
 *
 * <p>
 * In order to eliminate the need to specify the precise result of an overlay,
 * this class forces the final return value to be
 * <tt>GEOMETRYCOLLECTION EMPTY</tt>.
 *
 * <p>
...
public class OverlayValidatedGeometryOperation implements GeometryOperation {
	...
	/**
	 * Invokes an overlay op, optionally using snapping, and optionally validating
	 * the result.
	 *
	 * @param opCode
	 * @param g0
