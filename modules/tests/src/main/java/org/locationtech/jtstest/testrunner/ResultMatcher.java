...
/**
 * An interface for classes which can determine whether two {@link Result}s match, within a given
 * <tt>tolerance</tt>. The matching may also take into account the original input parameters to the
 * geometry method.
 *
 * @author mbdavis
 */
public interface ResultMatcher {
  /**
   * Tests whether the actual and expected results match well enough for the test to be considered
   * as passed.
   *
