...
/**
 * Invokes a function from registry or a Geometry method determined by a named
 * operation with a list of arguments, the first of which is a {@link Geometry}.
 * This class allows overriding Geometry methods or augmenting them with
 * functions defined in a {@link GeometryFunctionRegistry}.
 *
 * @author Martin Davis
 * @version 1.7
 */
