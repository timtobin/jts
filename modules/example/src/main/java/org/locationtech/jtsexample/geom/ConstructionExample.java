 ...
 *
 * <p>The Best Practice moral here is: <quote> Use the GeometryFactory to construct Geometries
 * whenever possible. </quote> This has several advantages:
 *
 * <ol>
...
public class ConstructionExample {
  ...
  public static void main(String[] args) throws Exception {
    ...
    MultiPoint mpt =
        fact.createMultiPointFromCoords(
