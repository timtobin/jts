...
public class ExtendedCoordinateSequence implements CoordinateSequence {
	...
	/**
	 * Constructor that makes a copy of an array of Coordinates. Always makes a copy
	 * of the input array, since the actual class of the Coordinates in the input
	 * array may be different from ExtendedCoordinate.
	 */
