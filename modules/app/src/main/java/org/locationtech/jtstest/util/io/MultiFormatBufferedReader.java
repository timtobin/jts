...
public class MultiFormatBufferedReader {
	public static List<Geometry> read(Reader reader, int limit, int offset, GeometryFactory geomFactory)
			throws Exception {
	...
	private List<Geometry> readWKBHex(Reader rdr, GeometryFactory geomFact) throws ParseException, IOException {
