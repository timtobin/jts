...
public class CoverageFunctions {
  ...
  public static Geometry validatePolygonWithGaps(
      Geometry geom, Geometry adjacentPolys, @Metadata(title = "Gap width") double gapWidth) {
  ...
  public static Geometry validateWithGaps(
      Geometry geom, @Metadata(title = "Gap width") double gapWidth) {
    Geometry[] invalid = CoverageValidator.validate(toGeometryArray(geom), gapWidth);
    return FunctionsUtil.buildGeometryCollection(invalid, geom.getFactory().createLineString());
  }

  public static Geometry findGaps(
      Geometry geom, @Metadata(title = "Max Gap Width") double maxGapWidth) {
  ...
  public static Geometry simplifySharp(
      Geometry coverage,
      @Metadata(title = "Distance tol") double tolerance,
  ...
  public static Geometry simplifyRemoveRings(
      Geometry coverage,
      @Metadata(title = "Distance tol") double tolerance,
  ...
  public static Geometry simplifyInOut(
      Geometry coverage,
  ...
  public static Geometry simplifyTolerances(
      Geometry coverage, @Metadata(title = "Tolerances (comma-sep)") String tolerancesCSV) {
    Geometry[] cov = toGeometryArray(coverage);
  ...
  public static Geometry cleanSnap(
      Geometry coverage, @Metadata(title = "Snap Distance") double snapDistance) {
    Geometry[] cov = toGeometryArray(coverage);
    Geometry[] result = CoverageCleaner.clean(cov, snapDistance, 0);
    return coverage.getFactory().createGeometryCollection(result);
  }

  public static Geometry cleanMergeMaxArea(
      Geometry coverage, @Metadata(title = "Max Gap Width") double maxGapWidth) {
    Geometry[] cov = toGeometryArray(coverage);
    Geometry[] result =
        CoverageCleaner.cleanOverlapGap(cov, CoverageCleaner.MERGE_MAX_AREA, maxGapWidth);
    return coverage.getFactory().createGeometryCollection(result);
  }

  public static Geometry cleanMergeMinArea(
      Geometry coverage, @Metadata(title = "Max Gap Width") double maxGapWidth) {
    Geometry[] cov = toGeometryArray(coverage);
    Geometry[] result =
        CoverageCleaner.cleanOverlapGap(cov, CoverageCleaner.MERGE_MIN_AREA, maxGapWidth);
    return coverage.getFactory().createGeometryCollection(result);
  }

  public static Geometry cleanGapWidth(
      Geometry coverage, @Metadata(title = "Max Gap Width") double maxGapWidth) {
    Geometry[] cov = toGeometryArray(coverage);
  ...
  public static Geometry cleanedOverlapsSnap(
      Geometry coverage, @Metadata(title = "Snap Distance") double snapDistance) {
    Geometry[] cov = toGeometryArray(coverage);
    CoverageCleaner cc = new CoverageCleaner(cov);
  ...
  public static Geometry cleanedGaps(
      Geometry coverage, @Metadata(title = "Max Gap Width") double maxGapWidth) {
    Geometry[] cov = toGeometryArray(coverage);
    CoverageCleaner cc = new CoverageCleaner(cov);
  ...
  public static Geometry cleanedGapsSnap(
      Geometry coverage,
      @Metadata(title = "Snap Distance") double snapDistance,
      @Metadata(title = "Max Gap Width") double maxGapWidth) {
    Geometry[] cov = toGeometryArray(coverage);
