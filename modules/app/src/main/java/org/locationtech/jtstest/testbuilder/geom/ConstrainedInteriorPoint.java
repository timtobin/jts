...
public class ConstrainedInteriorPoint {
	...
	/**
	 * Non-robust intersection of a segment with a horizontal line. Inputs are not
	 * expected to have high precision, so this computation should be adequate.
	 *
	 * @param p0
	 * @param p1
	 * @param scanY2
	...
	private Coordinate findBestMidpoint() {
		...
		/*
		 * Entries in crossings list should occur in pairs representing a section of the
		 * scan line interior to the polygon (which may be zero-length)
		 */
		double xBest1 = 0;
		double xBest2 = 0;
		double maxDist = -1;
