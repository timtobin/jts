...
public class SVGWriter {
	 ...
	 *            the output writer to append to
	 */
	private void appendGeometry(Geometry geometry, int level, Writer writer) throws IOException {
		indent(level, writer);
	 ...
	 *            the output writer to append to
	 */
	private void appendGeometryCollection(GeometryCollection geometryCollection, int level, Writer writer)
			throws IOException {
		int level2 = level;
	 ...
	 *            the output writer to append to
	 */
	private void appendMultiLineString(MultiLineString multiLineString, int level, boolean indentFirst, Writer writer)
			throws IOException {
		int level2 = level;
	 ...
	 *            the output writer to append to
	 */
	private void appendMultiPoint(MultiPoint multiPoint, int level, Writer writer) throws IOException {
	 ...
	 *            the output writer to append to
	 */
	private void appendMultiPolygon(MultiPolygon multiPolygon, int level, Writer writer) throws IOException {
		int level2 = level;
	...
	/**
	 * Converts a <code>Coordinate</code> to &lt;Point Text&gt; format, then appends
	 * it to the writer.
	 *
	 * @param coordinate
	 ...
	 *            the output writer to append to
	 * @param precisionModel
	 *            the <code>PrecisionModel</code> to use to convert from a precise
	 *            coordinate to an external coordinate
	 */
	private void appendPoint(Coordinate coordinate, int level, Writer writer, PrecisionModel precisionModel)
			throws IOException {
	 ...
	 *            the output writer to append to
	 */
	private void appendPolygon(Polygon polygon, int level, Writer writer) throws IOException {
	...
	private void appendPolygonPath(Polygon polygon, int level, boolean indentFirst, Writer writer) throws IOException {
		if (indentFirst)
			indent(level, writer);
