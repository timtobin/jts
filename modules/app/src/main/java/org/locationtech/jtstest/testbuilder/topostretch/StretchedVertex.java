...
/**
 * Models a vertex of a Geometry which will be stretched due to being too near
 * other segments and vertices.
 *
 * <p>
 * Currently for simplicity a vertex is assumed to be near only one segment or
 * other vertex. This is sufficient for most cases.
 *
 * @author Martin Davis
 */
public class StretchedVertex {
	// TODO: also provide information about the segments around the facet the vertex
	// is near to, to
	 ...
	 * @param pt
	 * @param cornerBase
	 *            the two vertices defining the
	 * @param corner
	 *            the two vertices defining the arms of the corner, oriented CW
	...
	/**
	 * Displaces a vertex from a corner, with angle limiting used to ensure that the
	 * displacement is not close to the arms of the corner.
	 *
	 * @param nearPt
	 * @param p1
	 * @param p2
	...
	private Coordinate displaceFromCornerOriginal(Coordinate nearPt, Coordinate p1, Coordinate p2, double dist) {
		...
		// TODO: displace from vertex on appropriate side of flat line, with suitable
		// angle
	...
	private Coordinate displaceFromPoint(Coordinate nearPt, double dist) {
		...
		// compute an adjustment which displaces in the direction of the nearPt-vertexPt
		// vector
	...
	/**
	 * Gets the point which this near vertex will be stretched to (by a given
	 * distance)
	 *
	 * @param dist
	 *            the distance to adjust the point by
