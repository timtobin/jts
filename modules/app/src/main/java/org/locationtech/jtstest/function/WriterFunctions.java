...
public class WriterFunctions {
  ...
  public static String writeOra(Geometry g)
    ...
    String sql =
        (String)
            ClassUtil.dynamicCall(
                "com.vividsolutions.jts.io.oracle.OraWriter",
                "writeSQL",
  ...
  public static String writeGeoJSONFixDecimal(
      Geometry g, @Metadata(title = "Num Decimals") int numDecimals) {
    if (g == null) return "";
