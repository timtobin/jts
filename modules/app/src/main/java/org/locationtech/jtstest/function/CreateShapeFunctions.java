...
public class CreateShapeFunctions {
	...
	public static Geometry bezierControl(Geometry geom, @Metadata(title = "Alpha (curveness)") double alpha) {
	...
	public static Geometry bezierControlSkew(Geometry geom, @Metadata(title = "Alpha (curveness)") double alpha,
	...
	public static Geometry bezierCurve(Geometry geom, @Metadata(title = "Alpha (curveness)") double alpha) {
	...
	public static Geometry bezierCurveSkew(Geometry geom, @Metadata(title = "Alpha (curveness)") double alpha,
			@Metadata(title = "Skew factor") double skew) {
	...
	public static Geometry ellipseRotate(Geometry g, int nPts, @Metadata(title = "Angle") double ang) {
		GeometricShapeFactory gsf = new GeometricShapeFactory();
		gsf.setNumPoints(nPts);
		gsf.setRotation(ang);
		if (g != null)
	...
	public static Geometry fontGlyph(Geometry g, String text, @Metadata(title = "Font name") String fontName) {
	...
	public static Geometry fontGlyphSerifPointSize(Geometry g, String text,
			@Metadata(title = "Point size") int pointSize) {
		return fontGlyph(g, text, new Font(FontGlyphReader.FONT_SERIF, Font.PLAIN, pointSize));
	}

	private static Coordinate[] genSpiralCycle(Coordinate centre, double radiusStart, double radiusEnd,
			int quadrantSegs) {
	...
	public static Geometry sineStar(Geometry g, @Metadata(title = "Arm count") int nArms,
	...
	public static Geometry spiral(Geometry geom, @Metadata(title = "Num Cycles") int nCycles,
		...
		for (int i = 1; i <= nCycles; i++) {
			Coordinate[] inCycle = genSpiralCycle(centre, i * pitch - pitch / 2, (i + 1) * pitch - pitch / 2,
					quadrantSegs);
	...
	public static Geometry supercircle(Geometry g, @Metadata(title = "Point count") int nPts,
