...
public class SwingUtil {
	...
	public static void copyToClipboard(Object o, boolean isFormatted) {
		...
		if (o instanceof Geometry geometry) {
			...
			// transfer as string
			Toolkit.getDefaultToolkit().getSystemClipboard().setContents(new StringSelection(o.toString()), null);
		}
	}
	...
	public static void reportException(Component c, Exception e) {
		JOptionPane.showMessageDialog(c, StringUtil.wrap(e.toString(), 80), "Exception", JOptionPane.ERROR_MESSAGE);
