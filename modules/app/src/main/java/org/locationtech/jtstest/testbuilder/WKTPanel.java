...
public class WKTPanel extends JPanel {
	...
	void loadButton_actionPerformed(ActionEvent e) {
		try {
			tbModel.loadGeometryText(getGeometryTextClean(0), getGeometryTextClean(1));
			JTSTestBuilder.controller().zoomToInput();
		} catch (Exception ex) {
	...
	void uiInit() throws Exception {
		...
		panelAB.add(aPanel, new GridBagConstraints(1, 0, 1, 1, 1.0, 1.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
		panelAB.add(bPanel, new GridBagConstraints(1, 1, 1, 1, 1.0, 1.0, GridBagConstraints.CENTER,
				GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0));
		bScrollPane.getViewport().add(bTextArea, null);
		aScrollPane.getViewport().add(aTextArea, null);

		/*
		 * this.setLayout(gridBagLayout1); this.setPreferredSize(new
		 * java.awt.Dimension(394, 176)); this.add( panelAB, new GridBagConstraints(0,
		 * 1, 1, 2, 1.0, 1.0, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new
		 * Insets(0, 0, 0, 0), 0, 0)); this.add( panelButtons, new GridBagConstraints(
		 * 1, 1, 1, 1, 0.0, 0.0, GridBagConstraints.NORTHWEST, GridBagConstraints.NONE,
		...
		aCopyButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				aCopyButton_actionPerformed(e);
			}
		});
		aPasteButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				aPasteButton_actionPerformed(e);
			}
		});
		aCutButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				aCutButton_actionPerformed(e);
			}
		});
		bCopyButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				bCopyButton_actionPerformed(e);
			}
		});
		bPasteButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				bPasteButton_actionPerformed(e);
			}
		});
		bCutButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
