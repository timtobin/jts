...
public class EndianDataInputStream {
	...
	public double readDoubleLE() throws IOException {
		...
		l = ((long) (workSpace[7] & 0xff) << 56) | ((long) (workSpace[6] & 0xff) << 48)
				| ((long) (workSpace[5] & 0xff) << 40) | ((long) (workSpace[4] & 0xff) << 32)
				| ((long) (workSpace[3] & 0xff) << 24) | ((long) (workSpace[2] & 0xff) << 16)
	...
	public int readIntLE() throws IOException {
		...
		return ((workSpace[3] & 0xff) << 24) | ((workSpace[2] & 0xff) << 16) | ((workSpace[1] & 0xff) << 8)
				| (workSpace[0] & 0xff);
	}
	...
	public long readLongLE() throws IOException {
		...
		return ((long) (workSpace[7] & 0xff) << 56) | ((long) (workSpace[6] & 0xff) << 48)
				| ((long) (workSpace[5] & 0xff) << 40) | ((long) (workSpace[4] & 0xff) << 32)
				| ((long) (workSpace[3] & 0xff) << 24) | ((long) (workSpace[2] & 0xff) << 16)
				| ((long) (workSpace[1] & 0xff) << 8) | ((long) (workSpace[0] & 0xff));
	}
	...
	/**
	 * read a byte in BigEndian - the same as LE because its only 1 byte. returns
	 * int as per java.io.DataStream
	 */
	...
	/**
	 * read a byte in LittleEndian - the same as BE because its only 1 byte. returns
	 * int as per java.io.DataStream
	 */
