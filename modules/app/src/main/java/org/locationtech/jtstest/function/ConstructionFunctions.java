...
public class ConstructionFunctions {
	...
	public static Geometry circleByRadiusLine(Geometry radiusLine, @Metadata(title = "Number of vertices") int nPts) {
	...
	public static Geometry concaveHullByLen(Geometry geom, @Metadata(title = "Length") double maxLen) {
		return ConcaveHull.concaveHullByLength(geom, maxLen);
	}

	public static Geometry concaveHullByLenRatio(Geometry geom, @Metadata(title = "Length Ratio") double maxLen) {
	...
	public static Geometry concaveHullWithHolesByLen(Geometry geom, @Metadata(title = "Length") double maxLen) {
	...
	public static Geometry concaveHullWithHolesByLenRatio(Geometry geom,
			@Metadata(title = "Length Ratio") double maxLen) {
		return ConcaveHull.concaveHullByLengthRatio(geom, maxLen, true);
	}

	/**
	 * A concaveness measure defined in terms of the perimeter length relative to
	 ...
	 * </pre>
	 *
	 * Concaveness values are >= 0. A convex polygon has C = 0. A higher concaveness
	 * indicates a more concave polygon.
	 *
	 * <p>
	...
	public static Geometry maxInscribedCircle(Geometry g, @Metadata(title = "Distance tolerance") double tolerance) {
	...
	public static Geometry maxInscribedCircleCenter(Geometry g,
			@Metadata(title = "Distance tolerance") double tolerance) {
