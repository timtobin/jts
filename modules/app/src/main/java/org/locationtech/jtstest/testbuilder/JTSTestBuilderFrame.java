...
public class JTSTestBuilderFrame extends JFrame {
	...
	/**
	 * Tests if the TestBuilder is running. Useful to allow functions to decide
	 * whether to show indicators (if functions are running under JtsOpCmd, they
	 * should not show indicators since that seriously impacts performance).
	 *
	...
	private void reportProblemsParsingXmlTestFile(List parsingProblems) {
		...
		JOptionPane.showMessageDialog(this,
				StringUtil.wrap(parsingProblems.size() + " problems occurred parsing the XML test file."
