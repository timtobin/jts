...
public class VertexLabelStyle implements Style {
	...
	public void paint(Geometry geom, Viewport viewport, Graphics2D g) {
		...
		for (int i = 0; i < len; i++) {
			...
			if (i > 0 && isTooClose(lastDrawnPV, pV))
				continue;
			...
			/*
			 * System.out.println( pt + "   dir= " + dir + "  " + DIR_ALIGN[dir][0] + "  " +
			 * DIR_ALIGN[dir][1] );
			 */
			GraphicsUtil.drawStringAlign(g, label, (int) pV.getX(), (int) pV.getY(), DIR_ALIGN[dir][0],
					DIR_ALIGN[dir][1], LABEL_OFFSET);
		}
	}
