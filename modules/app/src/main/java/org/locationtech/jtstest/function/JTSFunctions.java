...
public class JTSFunctions {
	...
	private static Geometry create_J(Geometry g) {
		...
		Coordinate[] jTop = new Coordinate[]{new Coordinate(0, HEIGHT), new Coordinate(J_WIDTH, HEIGHT),
				new Coordinate(J_WIDTH, J_RADIUS)};
		Coordinate[] jBottom = new Coordinate[]{new Coordinate(J_WIDTH - J_RADIUS, 0), new Coordinate(0, 0)};
	...
	private static Geometry create_S(Geometry g) {
		...
		Coordinate[] top = new Coordinate[]{new Coordinate(WIDTH, HEIGHT), new Coordinate(centreX, HEIGHT)};
		Coordinate[] bottom = new Coordinate[]{new Coordinate(centreX, 0), new Coordinate(WIDTH - 2 * S_RADIUS, 0)};
	...
	private static Geometry create_T(Geometry g) {
		...
		Coordinate[] tTop = new Coordinate[]{new Coordinate(J_WIDTH, HEIGHT),
				new Coordinate(WIDTH - S_RADIUS - 5, HEIGHT)};
		Coordinate[] tBottom = new Coordinate[]{new Coordinate(J_WIDTH + 0.5 * T_WIDTH, HEIGHT),
