...
public class AffineTransformationFunctions {
	...
	public static Geometry rotateAroundPoint(Geometry g, Geometry pt,
			@Metadata(title = "Angle (radians)") double angle) {
		Coordinate loc;
		if (pt == null) {
	...
	public static Geometry rotateByPiMultiple(Geometry g,
			@Metadata(title = "Angle (multiple of Pi)") double multipleOfPi) {
		Coordinate centre = envelopeCentre(g);
	...
	public static Geometry scaleXY(Geometry g, @Metadata(title = "X scaling") double scaleX,
	...
	public static Geometry translate(Geometry g, @Metadata(title = "dX") double dx, @Metadata(title = "dY") double dy) {
