...
public class LayerStylePanel extends JPanel {
	...
	private JPanel stylePanel() {
		...
		btnVertexColor = ColorControl.create(this, "Vertex", AppColors.GEOM_VIEW_BACKGROUND,
		...
		btnLineColor = ColorControl.create(this, "Line", AppColors.GEOM_VIEW_BACKGROUND,
				new ColorControl.ColorListener() {
					public void colorChanged(Color clr) {
		...
		btnFillColor = ColorControl.create(this, "Fill", AppColors.GEOM_VIEW_BACKGROUND,
				new ColorControl.ColorListener() {
					public void colorChanged(Color clr) {
		...
		btnLabelColor = ColorControl.create(this, "Label", AppColors.GEOM_VIEW_BACKGROUND,
				new ColorControl.ColorListener() {
					public void colorChanged(Color clr) {
						if (layer == null)
							return;
