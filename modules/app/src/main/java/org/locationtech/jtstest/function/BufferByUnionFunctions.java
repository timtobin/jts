...
public class BufferByUnionFunctions {
	...
	/**
	 * Buffer polygons by buffering the individual boundary segments and either
	 * unioning or differencing them.
	 *
	 * @param g
	 * @param distance
	...
	public static Geometry componentBuffers(Geometry g, double distance) {
		...
		return FunctionsUtil.getFactoryOrDefault(g).createGeometryCollection(GeometryFactory.toGeometryArray(bufs));
	}
