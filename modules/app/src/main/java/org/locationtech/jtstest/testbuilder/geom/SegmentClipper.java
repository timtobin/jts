...
/**
 * Clips a segment to a rectangle. Modification is done in-place in the input
 * Coordinates, so do not pass in Coordinates from source Geometries.
 *
 * @author mbdavis
 */
public class SegmentClipper {
	...
	private static void clipEndpoint(Coordinate p0, Coordinate p1, double xmin, double ymin, double xmax, double ymax) {
