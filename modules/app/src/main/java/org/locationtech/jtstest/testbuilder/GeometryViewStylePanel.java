...
public class GeometryViewStylePanel extends LabelComponentsPanel {
	...
	private void uiInit() {
		...
		ctlTitleFillClr = ColorControl.create(this, "Title fill color", viewStyle.getTitleFill(),
		...
		ctlBorderClr = ColorControl.create(this, "Border Color", viewStyle.getBorderColor(),
				new ColorControl.ColorListener() {
					public void colorChanged(Color clr) {
						updateView();
					}
