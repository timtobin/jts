...
public class GeometryViewStylePanel extends LabelComponentsPanel {
	...
	private void uiInit() {
		...
		cbTitle.addActionListener(e -> updateView());
		...
		ctlTitleFillClr = ColorControl.create(this, "Title fill color", viewStyle.getTitleFill(), clr -> updateView());
		...
		cbLegend.addActionListener(e -> updateView());
		...
		ctlLegendFillClr = ColorControl.create(this, "Legend fill color", viewStyle.getLegendFill(),
				clr -> updateView());
		...
		cbLegendStats.addActionListener(e -> updateView());
		...
		addRow("Legend", cbLegend, ctlLegendFillClr, "Border", cbLegendBorder, "Stats", cbLegendStats, "Metrics",
				cbLegendMetrics);
		...
		ctlBorderClr = ColorControl.create(this, "Border Color", viewStyle.getBorderColor(), clr -> updateView());
		...
		ctlBackgroundClr = ColorControl.create(this, "Background Color", viewStyle.getBackground(),
				clr -> updateView());
