...
public class LineHandlingFunctions {
	...
	public static Geometry extractSegments(Geometry g) {
		...
		for (Object o : lines) {
			...
			for (int i = 1; i < line.getNumPoints(); i++) {
				LineString seg = g.getFactory()
						.createLineString(new Coordinate[]{line.getCoordinateN(i - 1), line.getCoordinateN(i)});
				segments.add(seg);
			}
		}
	...
	/**
	 * Trims line A to geometry B. Equivalent to the projection of B onto A.
	 *
	 * @param a
	 *            line to trim
	 * @param b
