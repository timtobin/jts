...
public class JTSOpCmdTest {
  ...
  public void testErrorbadMultiArgsNoRParen() {
    runCmdError(
        args("-a", "POINT ( 1 1 )", "Buffer.buffer", "(1,2,3"), JTSOpCmd.ERR_INVALID_ARG_PARAM);
  }
  ...
  */
  ...
  public void testCollectUnion() {
    runCmd(
        args("-a", "stdin", "-collect", "-f", "wkt", "Overlay.unaryUnion"),
  ...
  public void testCollectLimitUnion() {
    runCmd(
        args("-a", "stdin", "-collect", "-limit", "2", "-f", "wkt", "Overlay.unaryUnion"),
        stdin(
  ...
  public void testOpEachA() {
    runCmd(
        args(
            "-a",
            "MULTILINESTRING((0 0, 10 10), (100 100, 110 110))",
            "-eacha",
            "-f",
            "wkt",
            "envelope"),
  ...
  public void testOpEachAA() {
    runCmd(
        args("-ab", "MULTIPOINT((0 0), (0 1))", "-eacha", "-f", "wkt", "Distance.nearestPoints"),
        "LINESTRING (0 0, 0 0)\nLINESTRING (0 0, 0 1)\nLINESTRING (0 1, 0 0)\nLINESTRING (0 1, 0 1)");
  }
  ...
  public void testWhereLength() {
    JTSOpCmd cmd =
        runCmd(
            args("-a", "stdin", "-f", "wkt", "-where", "gt", "1", "Geometry.length"),
            stdin(
                "LINESTRING ( 0 1, 0 1)",
                "LINESTRING ( 0 1, 0 2)",
                "LINESTRING ( 0 1, 0 3)",
  ...
  public void testSRIDPolygonize() throws ParseException {
    JTSOpCmd cmd =
        runCmd(
            args(
                "-a",
                "MULTILINESTRING ((1 1, 9 9), (9 9, 9 1), (9 1, 1 1), (9 1, 16 9), (9 9, 16 9))",
                "-srid",
                "4326",
                "-explode",
                "-f",
  ...
  public void testLiteralEmptyLinestring() {
    JTSOpCmd cmd =
        runCmd(args("-a", "LINESTRING EMPTY", "-f", "wkt", "Construction.boundary"), null, null);
    List<Geometry> results = cmd.getResultGeometry();
  ...
  public void testLiteralEmptyPoint() {
    JTSOpCmd cmd =
        runCmd(args("-a", "POINT EMPTY", "-f", "wkt", "Construction.boundary"), null, null);
    List<Geometry> results = cmd.getResultGeometry();
    assertEquals(results.size(), 1, "Too many results for operation");
    assertTrue(results.getFirst().isEmpty(), "Expected empty result");
  }
  ...
  public void testFormatWKB() {
    runCmd(
        args("-a", "LINESTRING ( 1 1, 2 2)", "-f", "wkb"),
  ...
  public void testFormatGeoJSON() {
    runCmd(
        args("-a", "LINESTRING ( 1 1, 2 2)", "-f", "geojson"),
  ...
  public void testStdInWKT() {
    runCmd(
        args("-a", "stdin", "-f", "wkt", "envelope"), stdin("LINESTRING ( 1 1, 2 2)"), "POLYGON");
  }

  @Test
  public void testStdInWKB() {
    runCmd(
        args("-a", "stdin", "-f", "wkt", "envelope"),
        stdin(
